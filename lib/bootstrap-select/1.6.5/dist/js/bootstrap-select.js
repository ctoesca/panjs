...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    render: function (updateLi) {
      ...
      //toto
      if (this.options.fixedIcon != null){
        var img = $(this.options.fixedIcon);
        this.$newElement.find('.filter-option').prepend(img);    
      }
      ...
      this.$menu.on('click', 'li a', function (e) {
        ...
        if (!that.isDisabled() && !$this.parent().hasClass('disabled')) {
          ...
          if ((prevValue != that.$element.val() && that.multiple) || (prevIndex != that.$element.prop('selectedIndex') && !that.multiple)) {
              ...
              that.$element.trigger("change", {clickedIndex:clickedIndex, itemLabel:  $option.text() , selected: !state});//toto
              //toto
              //that.$element.change();
          }
        }
