...
"some"in Array.prototype||(Array.prototype.some=function(a,b){for(var c=0,d=this.length;c<d;c++)if(c in this&&a.call(b,this[c],c,this))return!0;return!1});function randomBetween(a,b){return Math.floor(Math.random()*b)+a}function exec(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))}
function getDateFromTimestamp(a){var b="";if(null!=a){b=new Date(1E3*parseInt(a));a=b.getFullYear();var c=b.getMonth()+1;10>c&&(c="0"+c);var d=b.getDate();10>d&&(d="0"+d);var e=b.getHours();10>e&&(e="0"+e);var f=b.getMinutes();10>f&&(f="0"+f);b=b.getSeconds();10>b&&(b="0"+b);b=a+"/"+c+"/"+d+" "+e+":"+f+":"+b}return b}
...
$.fn.getElements=function(a){a=$(a,this);var b=$([]);if(1==a.length)b.push(a);else for(var c=0;c<a.length;c++)b.push($(a[c]));return b};function isNumberKey(a){var b=a.which;a=a.shiftKey;return 96<=b&&105>=b||48<=b&&57>=b&&!0==a}function isControlKey(a){var b=a.which;return 8==b||13==b||46==b||37==b||39==b||9==b||a.ctrlKey&&67||a.ctrlKey&&86||a.ctrlKey&&88}
...
panjs.getMessage=function(a){for(var c=1;c<arguments.length;c++){var d=arguments[c];null==d&&(d="null");a=a.replace("%"+c,d)}return a};panjs.getClass=function(a){"undefined"==typeof window[a]&&uses(a);return window[a]};window.less="undefined"!=typeof panjs.less?panjs.less:{env:"production",async:!0,fileAsync:!1,poll:1E3,functions:{},dumpLineNumbers:"comments",relativeUrls:!1,rootpath:":/a.com/"};for(var a=0;a<panjs.namespaces.length;a++)"undefined"!=typeof panjs.namespaces[a]&&(panjs.namespaces[a].path=
panjs.namespaces[a].path.replace("{version}",panjs.version));panjs.createComponent=function(a,c){panjs.stackLevel++;var d=panjs.getClassNameFromClassPath(a),e=null;if("undefined"==typeof window[d]){var f=panjs.loader.usesComponent(a);if(!f.result)return uses("core.display.TerrorElement.html"),e=new TerrorElement(f),panjs.stack.push(f.message),panjs.stackLevel--,0>=panjs.stackLevel&&(panjs.stack=[],panjs.stackLevel=0),e}try{"undefined"==typeof c&&(c={});if("undefined"!=typeof c.elem)for(var g=c.elem,
f=0;f<g.attributes.length;f++){var h=g.attributes.item(f),l=h.nodeName.toLowerCase(),m=h.value;l.startsWith("data-")&&(l=panjs.getFormatedArgName(l));"true"==m?m=!0:"false"==m&&(m=!1);c[l]=m}if("undefined"!=typeof panjs.root.components[a]&&"undefined"!=c.reuse&&!0===c.reuse){var r=panjs.root.components[a];r.reuse(c);return r}e=new window[d](c)}catch(n){g="Error instantiating "+d+": "+n,logger.error(g),uses("core.display.TerrorElement.html"),e=panjs.getAbsoluteUrlFromClassPath(a),h=panjs.loader.getUrlWithVersion(e),
e=new TerrorElement({message:n,path:e,url:h,className:d}),panjs.stack.push(g)}panjs.stackLevel--;0>=panjs.stackLevel&&(panjs.stack=[],panjs.stackLevel=0);e._onInitialized&&e._onInitialized();return panjs.root.components[a]=e};panjs.getFormatedIdName=function(a){if(-1==a.indexOf("-"))return a;var c="";a=a.split("-");for(var d=0;d<a.length;d++)c=0==d?a[d]:c+a[d].capitalizeFirstLetter();return c};panjs.getFormatedArgName=function(a){var c="";a=a.split("-");for(var d=1;d<a.length;d++)c=1==d?a[d]:c+a[d].capitalizeFirstLetter();
return c};panjs.loadScript=function(a,c){$LAB.script(a).wait(function(){"undefined"!=typeof c&&c(a)})};panjs.load=function(a){panjs._load(a)};panjs._load=function(a){0==arguments.length&&(a=$(document.body));var c=[];null!=a.attr("data-compo")?c.push(a):c=a.getElements("[data-compo]");for(var d=0;d<c.length;d++){var e=c[d],f=e.attr("data-compo"),g="false"!==e.attr("autoload"),h=e.attr("id");!0==g?(f=panjs.createComponent(f,{elem:e[0]}),e.replaceWith(f.container),f.container[0].owner=f):(uses("core.display.TproxyDisplayObject"),
f=new TproxyDisplayObject({sourceElement:e[0]}),f.parent=this,e[0].loaded=!1,e.hide(),e[0].setAttribute("id",panjs.root.id+"_"+h),e[0].originalId=h,e[0].owner=panjs.root);panjs.root[h]=f}logger.info("READY");"undefined"!=typeof onReady&&onReady()};panjs.getClassNameFromClassPath=function(a){var c=".";if(a.startsWith("http://")||a.startsWith("https://")||"/"==a[0])c="/";var d=a;a.endsWith(".html")&&(d=a.removeEnd(".html"));a=d.split(c);return d=a[a.length-1]};panjs.getNamespace=function(a){for(var c=
0;c<panjs.namespaces.length;c++){var d=panjs.namespaces[c];if(d.name==a)return d}return null};panjs.getAbsoluteUrlFromClassPath=function(a){var c=a.endsWith(".html"),d="";if(a.startsWith("http://")||"/"==a[0])d=c?a:a+".js";else for(var e=0;e<panjs.namespaces.length;e++){var f=panjs.namespaces[e];if(a.startsWith(f.name+".")){d=a.removeEnd(".html").replace(/\./g,"/");d=d.replace(f.name,f.path);d=c?d+".html":d+".js";break}}if(""==d)throw"Can't resolve "+a+": verify namespaces";return d};panjs.isAbsoluteUrl=
function(a){a=a.toLowerCase();return"/"==a[0]||a.toLowerCase().startsWith("http://")||a.toLowerCase().startsWith("https://")};panjs.transformUrl=function(a,c){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=c+"/"+a);return a}})();
...
Tevent.HIDE="HIDE";Tevent.HIDDEN="HIDDEN";Tevent.WAITING="WAITING";uses("core.events.Tevent");
defineClass("TeventDispatcher","core.Tobject",{_listeners:null,constructor:function(a){this._listeners={}},free:function(){},_getListenerIndex:function(a,b){if(!this.hasEventListener(a))return-1;for(var c=0;c<this._listeners[a].length;c++)if(this._listeners[a][c].listener==b)return c;return-1},dispatchEvent:function(a){if(this.hasEventListener(a.type))for(var b=this._listeners[a.type],c=0;c<b.length;c++)if(null!=b[c]){var d=b[c];a.currentTarget=this;a.data=a.data||d.data;a.bind=d.bind;null==a.bind?
d.listener(a):d.listener.call(a.bind,a);if(a.cancelled)break}},on:function(a,b,c,d){4>arguments.length&&(d=null);3>arguments.length&&(c=null);var e={listener:b,data:d,bind:c};this.hasEventListener(a)||(this._listeners[a]=[]);for(var f=0;f<this._listeners[a].length;f++)if(null==this._listeners[a][f]){this._listeners[a][f]=e;return}this._listeners[a].push(e)},off:function(a,b){var c=this._getListenerIndex(a,b);0<=c&&(this._listeners[a][c]=null)},removeAllListeners:function(){for(type in this._listeners)this._listeners[type].length=
0,this._listeners[type]=null,delete this._listeners[type]},hasEventListener:function(a){return"undefined"!=typeof this._listeners[a]}});
...
getHash:function(a){this.refreshkeys();return this.keys[a.hashKey]||null},setHash:function(a,b){if(this.keys[a.hashKey]!=b){this.keys[a.hashKey]=b||null;var c=this.encode(this.keys);sendEvents=!1;window.location.hash=c;this._dispatchOnhashchange(a.hashKey,b);sendEvents=!0}else logger.debug("setHash "+b+" => inchang\u00e9 sur "+a.id)},_dispatchOnhashchange:function(a,b){"undefined"==typeof b&&(b=null);if(null!=a){var c=this.listeners[a];return c.onhashchange(b)}for(var d in this.listeners)null!=d&&
(c=this.listeners[d],c.onhashchange(b))},decode:function(a){var b={};if(""!=a)try{this.base64encode&&(a=base64decode(a));a=a.split("&");for(var c=0;c<a.length;c++)if(""!=a[c].trim()){var d=a[c].split("=");k=d[0];v=d[1];b[k]=v}}catch(e){logger.error("Echec decodage de "+a+" en objet: "+e)}return b},encode:function(a){var b="";try{for(k in a)""!=a[k].trim()&&(b=b+k+"="+a[k]+"&");this.base64encode&&(b=base64encode(b))}catch(c){logger.error("Echec encodage de "+a+" en string: "+c)}return b},onhashchange:function(a){if(!this.sendEvents)return!1;
this.hash=window.location.hash.droite("#");this.keysTmp=this.decode(this.hash);a=!1;for(k in this.keys)a=!0,logger.debug("keys."+k+" = "+this.keys[k]+", hash."+k+" = "+this.keysTmp[k]),this.keysTmp[k]!=this.keys[k]&&(this.keys[k]=this.keysTmp[k]||null,"undefined"!=typeof this.listeners[k]&&(logger.debug("Le composant "+k+" va \u00eatre notifi\u00e9 que son hash a chang\u00e9: hash="+this.keys[k]),this._dispatchOnhashchange(k,this.keys[k])));if(!1==a)for(k in this.keysTmp)a=!0,"undefined"!=typeof this.listeners[k]&&
this._dispatchOnhashchange(k,this.keysTmp[k]);!1==a&&"undefined"!=typeof this.listeners[k]&&this._dispatchOnhashchange(null,null);a=new Tevent(Trouter.HASH_CHANGE,this.keys);this.dispatchEvent(a);return!1}});Trouter.HASH_CHANGE="HASH_CHANGE";panjs.router=new Trouter;
defineClass("TproxyDisplayObject","core.events.TeventDispatcher",{autoload:!1,loaded:!1,sourceElement:null,parent:null,constructor:function(a){TproxyDisplayObject._super.constructor.call(this,a);this.className="TproxyDisplayObject";this.injectParam("sourceElement",a.sourceElement,!0);this.sourceElement.style.display="none";this.sourceElement.setAttribute("loaded","false")},load:function(a){var b=this.sourceElement;if(null!=b&&!1==this.loaded){var c=b.getAttribute("data-compo"),d=b.originalId;0==arguments.length?
a={elem:b,parent:this.parent}:(a.elem=b,a.parent=this.parent);this.dispatchEvent(new Tevent(Tevent.BEFORE_LOAD,{args:a,dataType:c}));c=panjs.createComponent(c,a);c.parent=this.parent;b.owner[d]=c;$(b).replaceWith(c.container);c.container[0].originalId=d;c.loaded=!0;c.visible&&c.show();b.setAttribute("id",b.owner.id+"_"+d);this.dispatchEvent(new Tevent(Tevent.LOADED,c));return c}},hide:function(){},show:function(){}});
defineClass("TarrayCollection","core.events.TeventDispatcher",{_source:null,length:0,key:null,_byId:null,constructor:function(a){TarrayCollection._super.constructor.call(this,a);var b=[];a&&("undefined"!=typeof a.push?b=a:(a.key&&(this.key=a.key),a.data&&(b=a.data)));this._byId={};this.setSource(b);this.length=this._source.length},sort:function(a){defined(a)&&this._source.sort(a)},getSource:function(){return this._source},setSource:function(a){if(this._source!=a){this._source=a;if(null!=this.key)for(this._byId=
{},a=0;a<this._source.length;a++)this._byId[this._source[a][this.key]]=this._source[a];this.refresh()}},find:function(a){var b=[];if(a.filterFunction)for(var c=0;c<this._source.length;c++)a.filterFunction(this._source[c])&&b.push(this._source[c]);return b},getByProp:function(a,b,c){var d=null;if(null!=this.key&&a==this.key)"undefined"!=typeof this._byId[b]&&(d=this._byId[b]);else{3>arguments.length?c=!1:d=[];for(var e=0;e<this._source.length;e++){var f=this._source[e];if("undefined"!=typeof f[a]&&
f[a]==b)if(!0==c)d.push(f);else{d=f;break}}}return d},replaceItem:function(a,b){if(a!=b){var c=this.getItemIndex(a);-1<c&&(this._source[c]=b,null!=this.key&&(this._byId[a[this.key]]=b,this.dispatchEvent(new Tevent(Tevent.UPDATE,a))),this.length=this._source.length,this.dispatchEvent(new Tevent(Tevent.REPLACE,{item:a,newItem:b})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"REPLACE",item:a,newItem:b})))}},updateItem:function(a){var b=!1,c=a;null!=this.key?(c=this.getByProp(this.key,a[this.key]),
null!=c&&(this._byId[a[this.key]]=a,b=!0)):0<=getItemIndex(a)&&(c=null,b=!0);b&&this.dispatchUpdateEvent(c,a)},dispatchUpdateEvent:function(a,b){this.dispatchEvent(new Tevent(Tevent.UPDATE,b));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"UPDATE",item:a,newItem:b}))},getItemIndex:function(a){for(var b=0;b<this._source.length;b++)if(this._source[b]==a)return b;return-1},getItemAt:function(a){return this._source[a]},addItem:function(a){-1==this.getItemIndex(a)&&(this._source.push(a),this.length=
this._source.length,null!=this.key&&(this._byId[a[this.key]]=a),this.dispatchEvent(new Tevent(Tevent.ADDED,{item:a,index:this.length-1})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:a,index:this.length-1})))},addItems:function(a){for(var b=0;b<a.length;b++)this._source.push(a[b]),null!=this.key&&(this._byId[a[b][this.key]]=a[b]);this.length=this._source.length;this.dispatchEvent(new Tevent(Tevent.REFRESH,this))},addItemAt:function(a,b){this._source.splice(b,0,a);null!=this.key&&
(this._byId[a[this.key]]=a);this.length=this._source.length;this.dispatchEvent(new Tevent(Tevent.ADDED,{item:a,index:b}));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:a,index:b}))},removeItem:function(a){var b=this.getItemIndex(a);0<=b&&this._removeItemAt(b,a);return b},removeItemAt:function(a){var b=this.getItemAt(a);null!=b&&this._removeItemAt(a,b)},removeAll:function(){this._source=[];this._byId={};this.refresh()},refresh:function(){this.length=this._source.length;this.dispatchEvent(new Tevent(Tevent.REFRESH,
this));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"REFRESH"}))},_removeItemAt:function(a,b){this._source.splice(a,1);this.length=this._source.length;null!=this.key&&delete this._byId[b[this.key]];this.dispatchEvent(new Tevent(Tevent.DELETE,b));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"DELETE",item:b}))}});
defineClass("TdisplayObject","core.events.TeventDispatcher",{container:null,id:null,parent:null,_parent:null,visible:!0,autoload:!0,loaded:!1,baseElement:null,_realVisible:!1,load:function(){return this},free:function(){TdisplayObject._super.free.call(this);this.container.remove()},_onInitialized:function(){},constructor:function(a){TdisplayObject._super.constructor.call(this,a);if(null==this.baseElement)throw'La propri\u00e9t\u00e9 "baseElement" n\'est pas d\u00e9fini sur '+this.className;this.container=
$("<"+this.baseElement+"/>");window[this.className].lastId++;defined(a,"id")?this._setId(a.id):this._setId(this.className+window[this.className].lastId);this.container[0].owner=this},addClass:function(a){this.container.addClass(a)},removeClass:function(a){this.container.removeClass(a)},appendTo:function(a){null!=this._parent?this._parent[0]!=a[0]&&(this._parent[0].removeChild(this.container[0]),a[0].appendChild(this.container[0]),this._parent=$(a[0])):(a[0].appendChild(this.container[0]),this._parent=
$(a[0]))},_setId:function(a){this.id=a;this.container.attr("id","ctn"+this.id)},hide:function(a){this.container.hide(a);this._realVisible=this.visible=!1;"undefined"!=typeof this._onHide&&this._onHide()},show:function(a){this._realVisible||(this.container.show(a),this._realVisible=this.visible=!0,"undefined"!=typeof this._onShow&&this._onShow())},toggle:function(a){this.container.toggle("fast");this.visible=!this._visible}});
...
(this[b.elem.originalId].load(),this[b.elem.originalId].show()):$(b.elem).show():$(b.elem).show():this[b.elem.originalId]?this[b.elem.originalId].className?this[b.elem.originalId].hide():$(b.elem).hide():$(b.elem).hide()},setState:function(){var a=this.currentState;this.currentState=[];for(var b=!1,c=0;c<this._statesElements.length;c++){for(var d=this._statesElements[c],e=null,f=null,g=0;g<arguments.length;g++){var h=arguments[g];if(this.stateExists(h)&&(!1==b&&this.currentState.push(h),null!=d.includeIn&&
!0!=e&&(e=0<=d.includeIn.indexOf(h)),null!=d.excludeFrom&&!0!=f&&(f=0<=d.excludeFrom.indexOf(h))))break}b=!0;null==e&&null==f||this._setStateElementVisible((!0==e||null==e)&&(!1==f||null==f),d)}for(g=0;g<this.currentState.length;g++)this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:a,state:this.currentState[g]}))},_populateElements:function(a,b,c){for(var d=0;d<a.childNodes.length;d++){var e=a.childNodes[d];if(1==e.nodeType){var f=e.getAttribute("id"),g=e.getAttribute("data-compo");null==
g?(b&&null!=f&&(defined(this[f])&&logger.error('1-Duplication du id "'+f+'" sur objet '+this.className),this[panjs.getFormatedIdName(f)]=$(e),c.push(f)),this._populateElements(e,b,c)):g==this.classPath?logger.error("R\u00e9f\u00e9rence circulaire dans "+this.classPath):"false"!==e.getAttribute("autoload")?(g=panjs.createComponent(g,{elem:e,parent:this}),g.parent=this,b&&null!=f&&(defined(this[f])&&logger.error('2-Duplication du id "',f,'" sur objet ',this.className),this[f]=g,c.push(f)),!0==g.visible?
($(e).replaceWith(g.container),g.container[0].owner=g):logger.info("PAS DE replaceWith pour ",g.id," visible = ",g.visible," ",typeof g.visible),e.loaded=!0,g.loaded=!0):(e.setAttribute("id",this.id+"_"+f),uses("core.display.TproxyDisplayObject"),g=new TproxyDisplayObject({sourceElement:e}),g.parent=this,e.loaded=!1,$(e).hide(),b&&null!=f&&(this[f]=g));e.originalId=f;e.owner=this;this.processStates(e)}else 8==e.nodeType&&(f="",f=-1==panjs.iever||8<panjs.iever?e.textContent:e.text.droite("\x3c!--").gauche("--\x3e").trim(),
...
a,b,c,d||null,e||null,f)},del:function(a,b,c,d,e,f){this._call("DELETE",a,b,c,d||null,e||null,f)},_call:function(a,b,c,d,e,f,g){var h=this.dataType;8<=arguments.length&&"undefined"!=typeof g.dataType&&(h=g.dataType);"json"!=h||"POST"!=a&&"PUT"!=a||(d=JSON.stringify(d));g.id=this.getNewTokenId();-1==b.lastIndexOf("?")&&(b+="?");b+="&";var l=this.extraUrlParams;if(defined(c))if("object"==typeof c)for(p in c)l+=l+"&"+p+"="+c[p];else l+="&"+c;var m=this.baseUrl+b+l;logger.debug("Appel ",a,": ",m,", dataType="+
h);return $.ajax({url:m,async:!0,data:d,context:this,type:a,xhrFields:{withCredentials:!0},dataType:h,success:function(c,d,h){logger.debug("Requ\u00eate AJAX termin\u00e9e avec succ\u00e8s: ",b);if(null!=this.exitCodeFieldName&&(d=c[this.exitCodeFieldName],defined(d)&&400<=d)){c=this._getErrorEvent(h,a,c[this.errorTextFieldName],m,g);this.dispatchEvent(c);defined(f)&&f(c,g);return}c=this._getSuccessEvent(c,h,g);this.dispatchEvent(c);defined(e)&&e(c,g)},error:function(c,d,e){logger.debug("ECHEC requ\u00eate AJAX "+
e,b);var h="?";0==c.readyState&&(h="request not initialized");1==c.readyState&&(h="server connection established");2==c.readyState&&(h="request received ");3==c.readyState&&(h="processing request");4==c.readyState&&(h="request finished and response is ready");var l=JSON.stringify(c.getAllResponseHeaders());logger.error("responseHeaders="+l+", readyState="+h+", jqXHR.responseText = "+c.responseText+", jqXHR.responseXml = "+c.responseXML+", textStatus="+d+", errorThrown = "+e);c=this._getErrorEvent(c,
a,e,m,g);this.dispatchEvent(c);defined(f)&&f(c,g)}})}});
