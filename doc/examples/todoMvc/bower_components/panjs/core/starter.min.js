...
a[c].capitalizeFirstLetter();return b};panjs.getFormatedArgName=function(a){var b="";a=a.split("-");for(var c=1;c<a.length;c++)b=1==c?a[c]:b+a[c].capitalizeFirstLetter();return b};panjs.loadScript=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};panjs.load=function(a){panjs._load(a)};panjs.exec=function(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))};panjs._load=function(a){0==arguments.length&&(a=$(document.body));var b=[];null!=a.attr("data-compo")?
b.push(a):b=a.getElements("[data-compo]");for(var c=0;c<b.length;c++){var d=b[c],e=d.attr("data-compo"),g="false"!==d.attr("autoload"),k=d.attr("id");!0==g?(e=panjs.createComponent(e,{elem:d[0]}),d.replaceWith(e.container),e.container[0].owner=e):(uses("core.display.TproxyDisplayObject"),e=new TproxyDisplayObject({sourceElement:d[0]}),e.parent=this,d[0].loaded=!1,d.hide(),d[0].setAttribute("id",panjs.root.id+"_"+k),d[0].originalId=k,d[0].owner=panjs.root);panjs.root[k]=e}logger.info("READY");"undefined"!=
...
else if(a.contains("."))for(var d=0;d<panjs.namespaces.length;d++){var e=panjs.namespaces[d];if(a.startsWith(e.name+".")){c=a.removeEnd(".html").replace(/\./g,"/");c=c.replace(e.name,e.path);c=b?c+".html":c+".js";break}}else c=a,c=b?c+".html":c+".js";if(""==c)throw"Can't resolve "+a+": verify namespaces";return c};panjs.isAbsoluteUrl=function(a){a=a.toLowerCase();return"/"==a[0]||a.toLowerCase().startsWith("http://")||a.toLowerCase().startsWith("https://")};panjs.transformUrl=function(a,b){"/"!=a[0]&&
"http://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=b+"/"+a);return a}})();
var Tobject={classHierarchy:"Tobject",extend:function(b,a,f){var c=this.prototype||Tobject,d={};d.classHierarchy={value:c.classHierarchy+" "+a};if(8!=panjs.iever){for(var e in b)if(e.startsWith("$")){a=b[e];e=e.droite("$");logger.debug("BINDABLE => "+e+", defaultValue="+a);d["__"+e]={value:a,writable:!0};a=new Function('var key = "__'+e+'", propName="'+e+'",oldValue=this[key];newValue=arguments[0]; if (this[key] != arguments[0]){this[key] = arguments[0]; this.__OnPropChanged(propName, oldValue, newValue);}');var g=
...
a&&(a="text/css");b=getText(b);this.addStyle(b,a)},processCode:function(b,a){return b.replace(/this._super/g,a+"._super")},addScriptNode:function(b,a,f){if(null==b.getAttribute("src"))a=getText(b),null!=f&&"text/x-class-definition"==b.getAttribute("type")&&(a=this.processCode(a,f)),panjs.exec(a);else if(a=panjs.transformUrl(b.getAttribute("src"),a),this.loadedJs[a.toLowerCase()])logger.debug("Le script "+a+" est d\u00e9j\u00e0 charg\u00e9");else{var c=this.loadFile(this.getUrlWithVersion(a));null!=
f&&"text/x-class-definition"==b.getAttribute("type")&&(c.data=this.processCode(c.data,f));panjs.exec(c.data);this.loadedJs[a.toLowerCase()]=1}return!0}});panjs.loader=new Tloader;
