<html>        
<head>
  <link href="../../../lib/tokenize/2.3.2/jquery.tokenize.css" rel="stylesheet"/>
  <script type="text/javascript" src="../../../lib/tokenize/2.3.2/jquery.tokenize.js"></script>
<style>
...
defineClass("Ttokenfield", "panjs.core.display.Telement", { 
	...
	constructor: function(args){
		...
		this.tokenfieldElem.tokenfield({
...
<body>
<select id="tokenize" multiple="multiple" class="tokenizeElem">
