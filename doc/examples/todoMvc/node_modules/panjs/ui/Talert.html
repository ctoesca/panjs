...
Talert.show = function(message, buttons, closeHandler, data, iconhtml, title, fade)
{
	...
	var p = PopupManager.createPopup(Talert, 
	{
		message:message,
		buttons: buttons,
...
Talert.confirm = function(message,closeHandler, buttons, data )
{
	if (!defined(iconhtml))
	...
	return Talert.show(message, buttons, closeHandler, data, iconhtml, _title, false);	
}
...
Talert.warn = function(message, buttons, closeHandler, data, iconhtml, title, fade)
{
	...
	return Talert.show(message, buttons, closeHandler, data, iconhtml, _title, fade);	
}
...
Talert.success = function(message, buttons, closeHandler, data, iconhtml, title, fade)
{
	if (!defined(iconhtml))
