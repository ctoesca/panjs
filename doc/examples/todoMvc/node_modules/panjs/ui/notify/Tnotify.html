...
defineClass("Tnotify", "panjs.core.display.Telement", { 
	...
	constructor: function(args){ 
		...
		this.audio = new Audio(panjs.namespaces["panjs.core"].path+'/../lib/sound/chat_message_notify.ogg');
...
Tnotify.info = function(message, closehandler, position)
{
	var n = new Tnotify({type:'info', message: message, closehandler: closehandler||null, position: position||TnotifyPosition.TOP_RIGHT});
	n.show();
	return n;
}
