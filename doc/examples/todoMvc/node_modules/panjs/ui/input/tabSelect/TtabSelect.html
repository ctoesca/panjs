...
defineClass("TtabSelect", "panjs.core.display.Telement", { 
	...
	getSelectedElements:function(){
		return this.container.getElements("span.tab.active");
	},
	...
	setSelectedItemByValue:function( value ){
		var item = this.getDataProvider().getByProp("value", value);
	...
	{
		var r = [];
		var selectedEl = this.container.getElements("span.tab.active");
