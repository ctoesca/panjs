...
logger.error("Unable to inherit from "+b+": class is not loaded"),null;try{var n=panjs._classes[b]?panjs._classes[b].Class.extend(c,a,f):window[f].extend(c,a,f);panjs._classes[g]={Class:n,isComponent:e};n.prototype.classPath=g;n.prototype.className=a;window[a]=d?new n:n;for(var q=g.split("."),e=window,f=0;f<q.length;f++){var l=q[f];f==q.length-1?e[l]=window[a]:"undefined"==typeof e[l]&&(e[l]={});e=e[l]}}catch(m){alert(a+" "+m)}__CLASSPATH__=null;panjs._lastDefinedClassName=a}
...
a);logger.groupStart();c.path=panjs.getAbsoluteUrlFromClassPath(a);c.url=this._getUrlWithVersion(c.path);var d=this._loadFileSync(c.url);if(d.result){try{var e=getXmlDocument(d.data)}catch(f){return logger.error("XML error in class "+b+": "+f),c.isXmlError=!0,c.message=f,c}for(var g=e.getElementsByTagName("head")[0],e=e.getElementsByTagName("body")[0],h=[],n=[],q=c.path.substring(0,c.path.lastIndexOf("/")),l=0;l<g.childNodes.length;l++){var m=g.childNodes[l],p=m.nodeName.toLowerCase();if("script"==
p)try{this.addScriptNode(m,q,b,a)}catch(r){return a="Error processing <"+p+"> in "+b+" => "+r,logger.error(c.path+": "+a),c.message=a,c.stack=r.stack,c}else"link"==p?h.push(m):"style"==p&&n.push(m)}if("undefined"==typeof panjs._classes[a])return c.message="Classe "+a+" not loaded",c;b=panjs._classes[a].Class;for(l=0;l<h.length;l++)this.addLinkNode(h[l],q);for(l=0;l<n.length;l++)logger.debug("Load style %1",a),this.addStyleNode(n[l]);if(defined(e))try{var s=getXml(e),t=b.prototype.parentClassName;
defined(window[t].prototype.html)&&window[t].prototype.html.contains("\x3c!--CONTENT--\x3e")&&(s=window[t].prototype.html.replace("\x3c!--CONTENT--\x3e",s));s=s.replace(/<body>/gi,"").replace(/<\/body>/gi,"");b.prototype.html=s;b.prototype.bodyNode=e}catch(u){return c.message=u.message,c}panjs.setSourceInComponents&&(b.prototype.source=d.data);b.prototype.classPathDir=this.getClassPathDir(a);b.prototype.dirPath=q;b.lastId=0;logger.groupEnd();logger.debug("END USESCOMPONENT %1",a);c.result=!0;c.message=
"ok";c.Class=b}else a="Error loading "+a+": "+d.status,logger.warn(a),c.mess=a}else c.result=!0,c.mess="Already loaded",c.Class=panjs._classes[a].Class;return c},uses:function(a){var b=panjs._getClassNameFromClassPath(a),c={result:!1,message:"",className:b,classPath:a,url:null,path:null,Class:null};if("undefined"==typeof panjs._classes[a]){logger.debug("USES %1",a);logger.groupStart();c.path=panjs.getAbsoluteUrlFromClassPath(a);var d=c.path.substring(0,c.path.lastIndexOf("/"));c.url=this._getUrlWithVersion(c.path);
var e=this._loadFileSync(c.url);if(e.result){e.data=this._processCode(e.data,b,d,a,".js");panjs._exec(e.data);if("undefined"==typeof panjs._classes[a])return c.message="Classe "+a+" not loaded",c;e=panjs._classes[a].Class;e.prototype.classPathDir=this.getClassPathDir(a);e.prototype.dirPath=d;e.lastId=0;c.result=!0;c.message="ok";c.Class=e}else throw a+" not loaded: "+e.status;logger.groupEnd();logger.debug("END USES %1",a)}else c.result=!0,c.message="Already loaded",c.Class=e;return c},_transformUrl:function(a,
b){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"file://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=b+"/"+a);return a},addLinkNode:function(a,b){var c=this._transformUrl(a.getAttribute("href"),b),d=a.getAttribute("type")||"text/css",e=a.getAttribute("rel")||"stylesheet";this.loadCssFile(c,d,e)},loadCssFile:function(a,b,c){if(0==arguments.length)throw"loadCssFile(url, type , rel): Missing url";var d=!1;a=this._getUrlWithVersion(a);if(this.loadedCss[a.toLowerCase()])return d;2>arguments.length&&
(b="text/css");3>arguments.length&&(c="stylesheet");var e=document.createElement("link");e.rel=c;e.type=b;e.href=a;"stylesheet/less"==c?this.lessIsLoaded()?(less.sheets.push(e),less.refresh(!0),logger.debug(panjs.messages.LESS_INJECTED),d=!0):logger.warn(panjs.messages.LESS_NOT_LOADED):(document.getElementsByTagName("head")[0].appendChild(e),d=!0);!0==d&&logger.debug("Load <link> ASYNC: %1",a);this.loadedCss[a.toLowerCase()]=!0;return d},addStyle:function(a,b){""!=a.trim()&&(2>arguments.length&&(b=
"text/css"),$('<style type="'+b+'">'+a+"</style>").appendTo("head"),"text/less"==b&&(this.lessIsLoaded()?(less.refresh(),logger.debug(panjs.messages.LESS_INJECTED)):logger.warn(panjs.messages.LESS_NOT_LOADED)))},addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");this.addStyle(a.textContent,b)},_processCode:function(a,b,c,d,e){a=a.replace("defineClass(","var __CLASSPATH__='"+d+"';defineClass(").replace(/this._super/g,'panjs._classes["'+d+'"].Class._super')+"\n"+panjs._sourceUrl+
c+"/"+b+e;return a=a.replace("defineStaticClass(","var __CLASSPATH__='"+d+"';defineStaticClass(")},addScriptNode:function(a,b,c,d){var e=a.getAttribute("data-subtype"),f=a.getAttribute("src");if(null==f)f=a.textContent,null!=c&&"text/x-class-definition"==e&&(f=this._processCode(f,c,b,d,".html")),panjs._exec(f);else if(a=this._transformUrl(f,b),this.loadedJs[a.toLowerCase()])logger.debug(panjs.messages.SCRIPT_ALREADY_LOADED,a);else{var g=this._loadFileSync(this._getUrlWithVersion(a));g.data=null!=
c&&"text/x-class-definition"==e?this._processCode(g.data,c,b,d,".js"):g.data+("\n"+panjs._sourceUrl+f+".js");panjs._exec(g.data);this.loadedJs[a.toLowerCase()]=1}return!0}});panjs.loader=new Tloader;panjs.loader.init();__CLASSPATH__="panjs.core.events.Tevent";
...
d[this.currentState[g]]=1;this.currentState=[];for(var h=0;h<this._statesElements.length;h++){var n=this._statesElements[h],q=!0,l=!0;if(null!=n.includeIn)for(l=null,q=!0,g=0;g<n.includeIn.length;g++){var m=n.includeIn[g],m="undefined"!=typeof c[m];if("OR"==n.includeLogic){if(q=m)break}else q=q&&m}else if(null!=n.excludeFrom)for(l=!1,q=null,g=0;g<n.excludeFrom.length;g++)if(m=n.excludeFrom[g],m="undefined"!=typeof c[m],"OR"==n.excludeLogic){if(l=m)break}else l=l&&m;if(null!=q||null!=l)e=this._setStateElementVisible(!0==
q||!1==l,n,b)||e}this.currentState=[];for(var p in c)this.currentState.push(p),this.container.addClass(p);if(e){logger.isLevelEnabled(Tlogger.TRACE)&&logger.trace(this.id+".currentState = "+JSON.stringify(this.currentState));g=[];for(p in c)"undefined"==typeof d[p]&&g.push(p);h=[];for(p in d)"undefined"==typeof c[p]&&h.push(p);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:f,newStates:this.currentState,removedStates:h,addedStates:g}))}return e},processElement:function(a,b){var c=a[0];
1==arguments.length&&(b={});c=this._processElement(c,a.parent()[0],!0);b&&!0==b.processStates&&this.setState(this.currentState);return c},_processElement:function(a,b,c,d){if(1==a.nodeType){var e=a.getAttribute("id"),f=a.getAttribute("data-compo"),g=$(a),h=null;null==f?(c&&null!=e&&(defined(this[e])&&logger.error('1-Duplication du id "'+e+'" sur objet '+this.className),this[panjs.getCamelCase(e)]=g,panjs._setDOMId(a,e,f)),this.bindEvents(g),this.processStates(a),this._populateElements(a,c)):f==this.classPath?
logger.error("R\u00e9f\u00e9rence circulaire dans "+this.classPath):(4>arguments.length&&(d="false"!==a.getAttribute("data-autoload")),d?(h=this.createComponent(f,{elem:a,parent:this}),h.parent=this,c&&null!=e&&(defined(this[e])&&logger.error('2-Duplication du id "'+e+'" sur objet '+this.className),this[e]=h,panjs._setDOMId(h.container[0],e,f)),this.bindEvents(g,h),g.replaceWith(h.container),h.container.attr("data-loaded","true"),a.setAttribute("data-loaded","true"),h.container[0].loaded=!0,h.container[0].compo=
h,this.setStatesAttributes(a,h.container[0]),this.processStates(h.container[0]),h._triggerOnAdded()):(panjs._setDOMId(a,e,f),g[0].compo=null,g[0].owner=this,this[e]=g,this.processStates(a)))}else 8==a.nodeType&&(e="",e=a.textContent,e=e.toUpperCase(),"CONTENT"==e&&(e=document.createElement("div"),e.setAttribute("data-class","content"),b.replaceChild(e,a),this.content=$(e)));return h},_populateElements:function(a,b){for(var c=0;c<a.childNodes.length;c++)this._processElement(a.childNodes[c],a,b)}});
TdisplayObjectContainer._listeIdElements=[];__CLASSPATH__="panjs.core.display.Telement";
