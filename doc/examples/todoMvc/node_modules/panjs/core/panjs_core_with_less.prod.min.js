...
a.getInstance=function(b,c){return new (a.getClass(b))(c)};a.unload=function(b){"undefined"==typeof a._classes[b]&&(b+=".html");"undefined"!=typeof a._classes[b]&&(a._classes[b]=void 0,delete a._classes[b])};a.createComponent=function(b,c,f){e++;f=a._getClassNameFromClassPath(b);var l=null;if("undefined"==typeof a._classes[b])try{var m=a.loader.usesComponent(b);if(null==m||!m.result)return g(b,f,m)}catch(p){return g(b,f,p)}try{"undefined"==typeof c&&(c={});if("undefined"!=typeof c.elem){var s=c.elem,
m=c;if("undefined"!=typeof s)for(var r=0;r<s.attributes.length;r++){var t=s.attributes.item(r),u=t.nodeName.toLowerCase(),w=t.value;if(u.startsWith("data-"))var x=u,x=x.rightOf("data-"),u=a.getCamelCase(x);"true"==w?w=!0:"false"==w&&(w=!1);m[u]=w}}if("undefined"!=typeof a.root.components[b]&&"undefined"!=c.reuse&&!0===c.reuse){var y=a.root.components[b];y.reuse(c);return y}l=new a._classes[b].Class(c)}catch(z){c="Error instantiating "+f+": "+z,logger.error(c),l=a.getAbsoluteUrlFromClassPath(b),s=
a.loader._getUrlWithVersion(l),l=g(b,f,{message:c,path:l,url:s,className:f}),d.push(c)}e--;0>=e&&(d=[],e=0);l._onInitialized&&l._onInitialized();return a.root.components[b]=l};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?a[c]:b+a[c].capitalizeFirstLetter();return b};a.loadScriptAsync=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};a.loadScriptSync=function(b){var c={result:null,errorMessage:""};if(this.loader.loadedJs[b.toLowerCase()])c.result=
!0,logger.debug(a.messages.SCRIPT_ALREADY_LOADED,b);else{var d=this.loader._loadFileSync(this.loader._getUrlWithVersion(b));c.result=d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.find("[data-compo]");for(var e=0;e<d.length;e++){var f=$(d[e]),g=f.attr("data-compo"),s="false"!==f.attr("data-autoload"),
r=f.attr("id");!0==s?f=f.load():(a._setDOMId(f[0],r,g),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY");2==arguments.length&&c()};a._getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||a.startsWith("file://")||a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};
...
logger.error("Unable to inherit from "+b+": class is not loaded"),null;try{var n=panjs._classes[b]?panjs._classes[b].Class.extend(c,a,f):window[f].extend(c,a,f);panjs._classes[g]={Class:n,isComponent:e,lastId:0};n.prototype.classPath=g;n.prototype.className=a;d?(window[a]=new n,window[a].id=g):window[a]=n;for(var q=g.split("."),e=window,f=0;f<q.length;f++){var l=q[f];f==q.length-1?e[l]=window[a]:"undefined"==typeof e[l]&&(e[l]={});e=e[l]}}catch(m){alert(a+" "+m)}__CLASSPATH__=null;panjs._lastDefinedClassName=
a}function uses(a){return a.endsWith(".html")?panjs.loader.usesComponent(a):panjs.loader.uses(a)}
...
p)try{this.addScriptNode(m,q,b,a)}catch(s){return a="Error processing <"+p+"> in "+b+" => "+s,logger.error(c.path+": "+a),c.message=a,c.stack=s.stack,c}else"link"==p?h.push(m):"style"==p&&n.push(m)}if("undefined"==typeof panjs._classes[a])return c.message="Classe "+a+" not loaded",c;b=panjs._classes[a].Class;for(l=0;l<h.length;l++)this.addLinkNode(h[l],q);for(l=0;l<n.length;l++)logger.debug("Load style %1",a),this.addStyleNode(n[l]);if(defined(e))try{var r=getXml(e),t=b.prototype.parentClassName;
defined(window[t].prototype.html)&&window[t].prototype.html.contains("\x3c!--CONTENT--\x3e")&&(r=window[t].prototype.html.replace("\x3c!--CONTENT--\x3e",r));r=r.replace(/<body>/gi,"").replace(/<\/body>/gi,"");b.prototype.html=r;b.prototype.bodyNode=e}catch(u){return c.message=u.message,c}panjs.setSourceInComponents&&(b.prototype.source=d.data);b.prototype.classPathDir=this.getClassPathDir(a);b.prototype.dirPath=q;b.lastId=0;logger.groupEnd();logger.debug("END USESCOMPONENT %1",a);c.result=!0;c.message=
