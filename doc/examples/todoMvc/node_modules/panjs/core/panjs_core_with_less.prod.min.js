...
function isControlKey(a){var b=a.which;return 8==b||13==b||46==b||35==b||36==b||37==b||39==b||9==b||a.ctrlKey&&67||a.ctrlKey&&86||a.ctrlKey&&88}var defaultSettings={appVersion:"1.0.0",logLevel:"DEBUG",env:"dev",version:"0.9.1",preserveElementsId:!1,setSourceInComponents:!1,stats:{active:!1,url:"http://www.nexilearn.com/apis/portail_panjs/captures"},cache:{useLocalStorage:!1},errorComponentClass:"panjs.core.display.TerrorElement.html"};panjs=array_replace_recursive(defaultSettings,panjs);
(function(a){var b=getIEVersion();9>b&&0<b&&alert("Internet Explorer "+getIEVersion()+" is not supported");if(!a.appName)throw"Config ERROR: panjs.appName is missing";if(!RegExp("^[0-9a-zA-Z-_]*$","g").exec(a.appName))throw"invalid appName. format: "+regAppName;a._sourceUrl="//# sourceURL=";b=getFirefoxVersion();0<b&&17>=b&&(a._sourceUrl="//@ sourceURL=");var c=[],d=0,e={};a.logger=null;a._classes={};a.root={id:"root",components:{}};a.loader=null;a.basePath=location.pathname.removeEnd(location.pathname.rightRightOf("/"));
...
a.namespaces[f].path.replace("{version}",a.version),a.namespaces[f].name=f;window.less="undefined"!=typeof a.less?a.less:{env:"production",async:!0,fileAsync:!1,poll:1E3};var g=function(b,e,f){"string"==typeof f&&(f={message:f,className:e});f.stack=c;uses(a.errorComponentClass);object=new TerrorElement(f);c.push(f.message);d--;0>=d&&(c=[],d=0);return object};a._exec=function(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))};a._setDOMId=function(b,c,d){c&&(d=b.getAttribute("data-preserve-id"),
d=null==d?a.preserveElementsId:"true"==d,d||(d=b.nodeName.toLowerCase(),"undefined"==typeof e[d]?e[d]=1:e[d]++,b.setAttribute("id",d+e[d]),b.setAttribute("data-original-id",c)))};a.getClass=function(b){"undefined"==typeof a._classes[b]&&uses(b);return a._classes[b].Class};a.getInstance=function(b,c){return new (a.getClass(b))(c)};a.unload=function(b){"undefined"==typeof a._classes[b]&&(b+=".html");"undefined"!=typeof a._classes[b]&&(a._classes[b]=void 0,delete a._classes[b])};a.createComponent=function(b,
e,f){d++;f=a._getClassNameFromClassPath(b);var l=null;if("undefined"==typeof a._classes[b])try{var m=a.loader.usesComponent(b);if(null==m||!m.result)return g(b,f,m)}catch(p){return g(b,f,p)}try{"undefined"==typeof e&&(e={});if("undefined"!=typeof e.elem){var s=e.elem,m=e;if("undefined"!=typeof s)for(var r=0;r<s.attributes.length;r++){var t=s.attributes.item(r),u=t.nodeName.toLowerCase(),w=t.value;if(u.startsWith("data-"))var x=u,x=x.rightOf("data-"),u=a.getCamelCase(x);"true"==w?w=!0:"false"==w&&
(w=!1);m[u]=w}}if("undefined"!=typeof a.root.components[b]&&"undefined"!=e.reuse&&!0===e.reuse){var y=a.root.components[b];y.reuse(e);return y}l=new a._classes[b].Class(e)}catch(z){e="Error instantiating "+f+": "+z,logger.error(e),l=a.getAbsoluteUrlFromClassPath(b),s=a.loader._getUrlWithVersion(l),l=g(b,f,{message:e,path:l,url:s,className:f}),c.push(e)}d--;0>=d&&(c=[],d=0);l._onInitialized&&l._onInitialized();return a.root.components[b]=l};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;
var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?a[c]:b+a[c].capitalizeFirstLetter();return b};a.loadScriptAsync=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};a.loadScriptSync=function(b){var c={result:null,errorMessage:""};if(this.loader.loadedJs[b.toLowerCase()])c.result=!0,logger.debug(a.messages.SCRIPT_ALREADY_LOADED,b);else{var d=this.loader._loadFileSync(this.loader._getUrlWithVersion(b));c.result=d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+=
"\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.find("[data-compo]");for(var e=0;e<d.length;e++){var f=$(d[e]),g=f.attr("data-compo"),s="false"!==f.attr("data-autoload"),r=f.attr("id");!0==s?f=f.load():(a._setDOMId(f[0],r,g),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY");2==arguments.length&&c()};a._getClassNameFromClassPath=
function(a){var b=".";if(a.startsWith("http://")||a.startsWith("file://")||a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};a.getAbsoluteUrlFromClassPath=function(b){var c=b.endsWith(".html"),d="";if(b.startsWith("http://")||b.startsWith("file://")||"/"==b[0])d=c?b:b+".js";else if(b.removeEnd(".html").contains(".")){var e=
a.getNSFromClassPath(b);e&&(d=e.path+"/"+b.rightOf(e.name+".").removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js")}else d=a.basePath+"/"+b,c||(d+=".js");""==d&&(d=b.removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js");return d}})(panjs=panjs||{});
