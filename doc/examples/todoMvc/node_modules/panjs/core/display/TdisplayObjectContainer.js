	...
	processStates:function(element)
	{
		...
		if ((includeIn != null) || (excludeFrom != null)){
			...
			var loaded = (element.getAttribute("data-loaded") == "true");
	  		...
	  		var obj = {display: element.style.display, loaded: loaded, isCompo: isCompo, visible: null, elem: element, excludeLogic: excludeLogic, includeLogic: includeLogic, id:element.getAttribute("id"), includeIn: includeIn, excludeFrom: excludeFrom};
