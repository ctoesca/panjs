...
a.namespaces[f].path.replace("{version}",a.version),a.namespaces[f].name=f;window.less="undefined"!=typeof a.less?a.less:{env:"production",async:!0,fileAsync:!1,poll:1E3};a.initCaptures=function(){if(!1!=this.stats.active){var b=a.stats.username,c=a.stats.password;$.ajax({url:a.stats.url+"/init",async:!0,type:"post",async:!1,data:JSON.stringify({appName:a.appName}),username:b,password:c,success:function(a,b,c){logger.debug("initCaptures: success")},error:function(a,b,c){logger.error("initCaptures: failure: "+
a.responseText)}})}};a.capture=function(b,c){if(!1!=this.stats.active){var d=a.stats.url,e=a.stats.username,f=a.stats.password,l={message:b,classPath:c.classPath,componentId:null,fromClassName:null,fromClassPath:null,appName:a.appName,groupId:1,fromId:null,isStatic:null,timestamp:(new Date).getTime()};null!=c.from&&(l.fromClassName=c.from.className,l.fromClassPath=c.from.classPath,null!=c.from.id&&(l.fromId=c.from.id));null!=c.componentId&&(l.componentId=c.componentId);"createStaticObject"==l.message&&
(l.isStatic=!0);"createComponent"==l.message&&(l.isStatic=!1);$.ajax({url:d,async:!0,type:"post",data:JSON.stringify(l),username:e,password:f,success:function(a,b,c){logger.debug("Send stats: success")},error:function(a,b,c){logger.error("Send stats: failure: "+a.responseText)}})}};a._exec=function(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))};a._setDOMId=function(b,c,d){c&&(d=b.getAttribute("data-preserve-id"),d=null==d?a.preserveElementsId:"true"==d,d||(d=
b.nodeName.toLowerCase(),"undefined"==typeof e[d]?e[d]=1:e[d]++,b.setAttribute("id",d+e[d]),b.setAttribute("data-original-id",c)))};a.getClass=function(b){"undefined"==typeof a._classes[b]&&uses(b);return a._classes[b].Class};a.getInstance=function(b,c){return new (a.getClass(b))(c)};a.unload=function(b){"undefined"==typeof a._classes[b]&&(b+=".html");"undefined"!=typeof a._classes[b]&&(a._classes[b]=void 0,delete a._classes[b])};a.createComponent=function(b,e,f){d++;var q=a._getClassNameFromClassPath(b),
m=null;if("undefined"==typeof a._classes[b]&&(m=a.loader.usesComponent(b),null==m||!m.result))return e=m,"string"==typeof e&&(e={message:e,className:q}),e.stack=c,uses(a.errorComponentClass),object=new TerrorElement(e),c.push(e.message),d--,0>=d&&(c=[],d=0),object;"undefined"==typeof e&&(e={});if("undefined"!=typeof e.elem&&(q=e.elem,m=e,"undefined"!=typeof q))for(var l=0;l<q.attributes.length;l++){var n=q.attributes.item(l),r=n.nodeName.toLowerCase(),n=n.value;r.startsWith("data-")&&(r=r.rightOf("data-"),
r=a.getCamelCase(r));"true"==n?n=!0:"false"==n&&(n=!1);m[r]=n}if("undefined"!=typeof a.root.components[b]&&"undefined"!=e.reuse&&!0===e.reuse)return f=a.root.components[b],f.reuse(e),f;m=new a._classes[b].Class(e);d--;0>=d&&(c=[],d=0);m._onInitialized&&m._onInitialized();a.root.components[b]=m;!1!==f&&(e={classPath:b,componentId:m.id,classPath:b,from:null},"object"==typeof f&&"undefined"!=typeof e.from&&(e.from=f.from),a.capture("createComponent",e));return m};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;
...
"\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.find("[data-compo]");for(var e=0;e<d.length;e++){var f=$(d[e]),l=f.attr("data-compo"),n="false"!==f.attr("data-autoload"),r=f.attr("id");!0==n?f=f.load():(a._setDOMId(f[0],r,l),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY");2==arguments.length&&c()};a._getClassNameFromClassPath=
