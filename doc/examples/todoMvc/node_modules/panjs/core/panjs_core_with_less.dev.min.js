...
void 0,delete a._classes[b])};a.createComponent=function(b,c){e++;var f=a._getClassNameFromClassPath(b),m=null;if("undefined"==typeof a._classes[b]&&(m=a.loader.usesComponent(b),!m.result))return"string"==typeof m&&(m={message:m,className:f}),m.stack=d,uses(a.errorComponentClass),object=new TerrorElement(m),d.push(m.message),e--,0>=e&&(d=[],e=0),object;"undefined"==typeof c&&(c={});if("undefined"!=typeof c.elem&&(f=c.elem,m=c,"undefined"!=typeof f))for(var n=0;n<f.attributes.length;n++){var l=f.attributes.item(n),
p=l.nodeName.toLowerCase(),l=l.value;p.startsWith("data-")&&(p=p.rightOf("data-"),p=a.getCamelCase(p));"true"==l?l=!0:"false"==l&&(l=!1);m[p]=l}if("undefined"!=typeof a.root.components[b]&&"undefined"!=c.reuse&&!0===c.reuse)return f=a.root.components[b],f.reuse(c),f;m=new a._classes[b].Class(c);e--;0>=e&&(d=[],e=0);m._onInitialized&&m._onInitialized();return a.root.components[b]=m};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?
