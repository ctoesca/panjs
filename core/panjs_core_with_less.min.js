...
"map"in Array.prototype||(Array.prototype.map=function(a,b){for(var c=Array(this.length),d=0,f=this.length;d<f;d++)d in this&&(c[d]=a.call(b,this[d],d,this));return c});"filter"in Array.prototype||(Array.prototype.filter=function(a,b){for(var c=[],d,f=0,e=this.length;f<e;f++)f in this&&a.call(b,d=this[f],f,this)&&c.push(d);return c});"every"in Array.prototype||(Array.prototype.every=function(a,b){for(var c=0,d=this.length;c<d;c++)if(c in this&&!a.call(b,this[c],c,this))return!1;return!0});
...
typeof panjs.namespaces[a]&&(panjs.namespaces[a].path=panjs.namespaces[a].path.replace("{version}",panjs.version));panjs.createComponent=function(a,c){panjs.stackLevel++;var d=panjs.getClassNameFromClassPath(a),f=null;if("undefined"==typeof window[d])try{var e=panjs.loader.usesComponent(a);if(!e.result)throw e;}catch(g){return"string"==typeof g&&(g={message:g,className:d}),uses("core.display.TerrorElement.html"),f=new TerrorElement(g),panjs.stack.push(g.message),panjs.stackLevel--,0>=panjs.stackLevel&&
(panjs.stack=[],panjs.stackLevel=0),f}try{"undefined"==typeof c&&(c={});"undefined"!=typeof c.elem&&panjs.setElementArgs(c.elem,c);if("undefined"!=typeof panjs.root.components[a]&&"undefined"!=c.reuse&&!0===c.reuse){var h=panjs.root.components[a];h.reuse(c);return h}f=new window[d](c)}catch(l){e="Error instantiating "+d+": "+l,logger.error(e),uses("core.display.TerrorElement.html"),f=panjs.getAbsoluteUrlFromClassPath(a),h=panjs.loader.getUrlWithVersion(f),f=new TerrorElement({message:e,path:f,url:h,
className:d}),panjs.stack.push(e)}panjs.stackLevel--;0>=panjs.stackLevel&&(panjs.stack=[],panjs.stackLevel=0);f._onInitialized&&f._onInitialized();return panjs.root.components[a]=f};panjs.setElementArgs=function(a,c){if("undefined"!=typeof a)for(var d=0;d<a.attributes.length;d++){var f=a.attributes.item(d),e=f.nodeName.toLowerCase(),f=f.value;e.startsWith("data-")&&(e=panjs.getFormatedArgName(e));"true"==f?f=!0:"false"==f&&(f=!1);c[e]=f}};panjs.getFormatedIdName=function(a){if(-1==a.indexOf("-"))return a;
var c="";a=a.split("-");for(var d=0;d<a.length;d++)c=0==d?a[d]:c+a[d].capitalizeFirstLetter();return c};panjs.getFormatedArgName=function(a){var c="";a=a.split("-");for(var d=1;d<a.length;d++)c=1==d?a[d]:c+a[d].capitalizeFirstLetter();return c};panjs.loadScript=function(a,c){$LAB.script(a).wait(function(){"undefined"!=typeof c&&c(a)})};panjs.load=function(a){panjs._load(a)};panjs.exec=function(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))};panjs._load=function(a){0==
arguments.length&&(a=$(document.body));var c=[];null!=a.attr("data-compo")?c.push(a):c=a.getElements("[data-compo]");for(var d=0;d<c.length;d++){var f=c[d],e=f.attr("data-compo"),g="false"!==f.attr("autoload"),h=f.attr("id");!0==g?(e=panjs.createComponent(e,{elem:f[0]}),f.replaceWith(e.container),e.container[0].owner=e):(uses("core.display.TproxyDisplayObject"),e=new TproxyDisplayObject({sourceElement:f[0]}),e.parent=this,f[0].loaded=!1,f.hide(),f[0].setAttribute("id",panjs.root.id+"_"+h),f[0].originalId=
h,f[0].owner=panjs.root);panjs.root[h]=e}logger.info("READY");"undefined"!=typeof onReady&&onReady()};panjs.getClassNameFromClassPath=function(a){var c=".";if(a.startsWith("http://")||a.startsWith("https://")||"/"==a[0])c="/";var d=a;a.endsWith(".html")&&(d=a.removeEnd(".html"));a=d.split(c);return d=a[a.length-1]};panjs.getNamespace=function(a){for(var c=0;c<panjs.namespaces.length;c++){var d=panjs.namespaces[c];if(d.name==a)return d}return null};panjs.getAbsoluteUrlFromClassPath=function(a){var c=
a.endsWith(".html"),d="";if(a.startsWith("http://")||"/"==a[0])d=c?a:a+".js";else if(a.contains("."))for(var f=0;f<panjs.namespaces.length;f++){var e=panjs.namespaces[f];if(a.startsWith(e.name+".")){d=a.removeEnd(".html").replace(/\./g,"/");d=d.replace(e.name,e.path);d=c?d+".html":d+".js";break}}else d=a,d=c?d+".html":d+".js";if(""==d)throw"Can't resolve "+a+": verify namespaces";return d};panjs.isAbsoluteUrl=function(a){a=a.toLowerCase();return"/"==a[0]||a.toLowerCase().startsWith("http://")||a.toLowerCase().startsWith("https://")};
panjs.transformUrl=function(a,c){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=c+"/"+a);return a}})();
...
l=[],n=[],q=d.substring(0,d.lastIndexOf("/")),m=0;m<h.childNodes.length;m++){var s=h.childNodes[m],t=s.nodeName.toLowerCase();if("script"==t)try{this.addScriptNode(s,q,b)}catch(w){return f="Error processing <"+t+"> in "+b+" => "+w,logger.error(d,f),{result:!1,message:f,className:b,classPath:a,url:c,path:d,stack:w.stack}}else"link"==t?l.push(s):"style"==t&&n.push(s)}if("undefined"==typeof window[b])return f=a+" class has not been loaded. ",panjs.lastDefinedClassName!=b&&(f+="\n"+panjs.getMessage(panjs.messages.CLASSNAME_MATCHS_FILENAME,
panjs.lastDefinedClassName,d)),logger.error(f),{result:!1,message:f,className:b,classPath:a,url:c,path:d,stack:null};for(m=0;m<l.length;m++)this.addLinkNode(l[m],q);for(m=0;m<n.length;m++)logger.debug("Load style ",a),this.addStyleNode(n[m]);if(defined(e))try{var r=getXml(e),u=window[b].prototype.parentClassName;defined(window[u].prototype.html)&&window[u].prototype.html.contains("\x3c!--CONTENT--\x3e")&&(r=window[u].prototype.html.replace("\x3c!--CONTENT--\x3e",r));r=r.replace(/<body>/gi,"").replace(/<\/body>/gi,
...
0;b<a.length&&(null==a[b]||(c=a[b],null==e.currentTarget&&(e.currentTarget=this),e.bind=c.bind,e.relatedData=c.data,null==e.bind?c.listener(e):c.listener.call(e.bind,e),!e.cancelled));b++);},on:function(a,b,c,d){4>arguments.length&&(d=null);3>arguments.length&&(c=null);var f={listener:b,data:d,bind:c};this.hasEventListener(a)||(this._listeners[a]=[]);for(var e=0;e<this._listeners[a].length;e++)if(null==this._listeners[a][e]){this._listeners[a][e]=f;return}this._listeners[a].push(f)},off:function(a,
b){var c=this._getListenerIndex(a,b);0<=c&&(this._listeners[a][c]=null)},removeAllListeners:function(){for(type in this._listeners)this._listeners[type].length=0,this._listeners[type]=null,delete this._listeners[type]},hasEventListener:function(a){return"undefined"!=typeof this._listeners[a]}});defineClass("Application","core.events.TeventDispatcher",{constructor:function(a){}});
...
this.listeners[a])for(var c=0;c<this.listeners[a].length;c++)this.listeners[a][c].onhashchange(b)},decode:function(a){var b={};if(""!=a)try{this.base64encode&&(a=base64decode(a));a=a.split("&");for(var c=0;c<a.length;c++)if(""!=a[c].trim()){var d=a[c].split("=");k=d[0];v=d[1];b[k]=v}}catch(f){logger.error("Trouter.decode: Echec decodage de "+a+" en objet: "+f)}return b},encode:function(a){var b="";try{for(k in a)"string"==typeof a[k]&&(b=b+k+"="+a[k]+"&");this.base64encode&&(b=base64encode(b))}catch(c){logger.error("Trouter.encode: Echec encodage de "+
...
this.container.addClass(m);if(d){logger.debug(this.id+".currentState = "+JSON.stringify(this.currentState));e=[];for(m in b)"undefined"==typeof c[m]&&e.push(m);g=[];for(m in c)"undefined"==typeof b[m]&&g.push(m);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:f,newStates:this.currentState,removedStates:g,addedStates:e}))}return d},_populateElements:function(a,b,c){for(var d=0;d<a.childNodes.length;d++){var f=a.childNodes[d];if(1==f.nodeType){var e=f.getAttribute("id"),g=f.getAttribute("data-compo");
null==g?(g=$(f),b&&null!=e&&(defined(this[e])&&logger.error('1-Duplication du id "'+e+'" sur objet '+this.className),this[panjs.getFormatedIdName(e)]=g,c.push(e)),this.bindEvents(g),this._populateElements(f,b,c)):g==this.classPath?logger.error("R\u00e9f\u00e9rence circulaire dans "+this.classPath):"false"!==f.getAttribute("autoload")?(g=this.createComponent(g,{elem:f,parent:this}),g.parent=this,b&&null!=e&&(defined(this[e])&&logger.error('2-Duplication du id "',e,'" sur objet ',this.className),this[e]=
g,c.push(e)),$(f).replaceWith(g.container),g.container[0].owner=g,f.loaded=!0,f.compo=g,g.loaded=!0):(f.setAttribute("id",this.id+"_"+e),uses("core.display.TproxyDisplayObject"),g=new TproxyDisplayObject({sourceElement:f}),g.parent=this,f.loaded=!1,f.compo=g,$(f).hide(),b&&null!=e&&(this[e]=g));f.originalId=e;f.owner=this;this.processStates(f)}else 8==f.nodeType&&(e="",e=-1==panjs.iever||8<panjs.iever?f.textContent:f.text.droite("\x3c!--").gauche("--\x3e").trim(),e=e.toUpperCase(),"CONTENT"==e&&(e=
document.createElement("div"),e.setAttribute("data-class","content"),a.replaceChild(e,f),this.content=$(e)))}return c}});TdisplayObjectContainer._listeIdElements=[];
...
return TrestClient.lastTokenId},_getSuccessEvent:function(a,b,c){logger.debug("X-Time="+b.getResponseHeader("X-Time"));a=new Tevent(Tevent.SUCCESS,a);a.xTime=b.getResponseHeader("X-Time");a.req=b;return a},_getErrorEvent:function(a,b,c,d,f){b={req:a,method:b,responseText:"",statusText:"Erreur inconnue",status:0,url:"url=?"};defined(a,"statusText")?b.statusText=a.statusText:b.statusText="";defined(c)&&(b.statusText=c);defined(d)&&(b.url=d);defined(a,"responseText")&&(b.responseText=a.responseText);
""==b.responseText&&(b.responseText="Empty response. status="+b.statusText);defined(a,"status")&&(b.status=a.status);0==b.status&&(b.status=1);b.token=f;try{b.data=JSON.parse(b.responseText)}catch(e){b.data=b.responseText}return new Tevent(Tevent.ERROR,b)},post:function(a,b,c,d,f,e){this._call("POST",a,b,c,d||null,f||null,e||null)},get:function(a,b,c,d,f,e){this._call("GET",a,b,c,d||null,f||null,e||null)},getText:function(a,b,c,d,f,e){this._call("GET",a,b,c,d||null,f||null,e||null,"text")},put:function(a,
b,c,d,f,e){this._call("PUT",a,b,c,d||null,f||null,e||null)},del:function(a,b,c,d,f,e){this._call("DELETE",a,b,c,d||null,f||null,e||null)},_call:function(a,b,c,d,f,e,g,h){8>arguments.length&&(h=this.dataType);"json"!=h||"POST"!=a&&"PUT"!=a||(d=JSON.stringify(d));null==g&&(g={});g.id=this.getNewTokenId();g.requestId||(g.requestId=g.id);-1==b.lastIndexOf("?")&&(b+="?");b+="&";var l=this.extraUrlParams;if(defined(c))if("object"==typeof c)for(p in c)l+=l+"&"+p+"="+c[p];else l+="&"+c;var l=l.replace(/#/g,
"%23"),n=this.baseUrl+b+l;logger.debug("TrestClient.CALL ",a,": ",n,", dataType="+h);return $.ajax({url:n,async:!0,data:d,context:this,type:a,xhrFields:{withCredentials:!0},dataType:h,success:function(c,d,h){if(g.aborted)logger.debug("Requ\u00eate AJAX "+g.requestId+" ANNULEE sur ",b);else{logger.debug("Requ\u00eate AJAX "+g.requestId+" termin\u00e9e avec succ\u00e8s sur ",b);if(null!=this.exitCodeFieldName&&(d=c[this.exitCodeFieldName],defined(d)&&400<=d)){c=this._getErrorEvent(h,a,c[this.errorTextFieldName],
n,g);this.dispatchEvent(c);defined(e)&&e(c,g);return}c=this._getSuccessEvent(c,h,g);this.dispatchEvent(c);defined(f)&&f(c,g)}},error:function(c,d,f){logger.debug("ECHEC Requ\u00eate AJAX "+g.requestId+" "+f+" sur ",b);if(g.aborted)logger.debug("Requ\u00eate "+g.requestId+" ANNULEE sur ",b);else{var h="?";0==c.readyState&&(h="request not initialized");1==c.readyState&&(h="server connection established");2==c.readyState&&(h="request received ");3==c.readyState&&(h="processing request");4==c.readyState&&
(h="request finished and response is ready");var l=JSON.stringify(c.getAllResponseHeaders());logger.error("responseHeaders="+l+", readyState="+h+", jqXHR.responseText = "+c.responseText+", jqXHR.responseXml = "+c.responseXML+", textStatus="+d+", errorThrown = "+f);c=this._getErrorEvent(c,a,f,n,g);this.dispatchEvent(c);defined(e)&&e(c,g)}}})}});TrestClient.lastTokenId=0;
