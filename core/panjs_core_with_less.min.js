...
panjs.namespaces[a].path.replace("{version}",panjs.version);panjs.createComponent=function(a,c){panjs.stackLevel++;var d=panjs.getClassNameFromClassPath(a),e=null;if("undefined"==typeof window[d])try{var f=panjs.loader.usesComponent(a);if(!f.result)throw f;}catch(g){return"string"==typeof g&&(g={message:g,className:d}),uses("core.display.TerrorElement.html"),e=new TerrorElement(g),panjs.stack.push(g.message),panjs.stackLevel--,0>=panjs.stackLevel&&(panjs.stack=[],panjs.stackLevel=0),e}try{"undefined"==
typeof c&&(c={});"undefined"!=typeof c.elem&&panjs.setElementArgs(c.elem,c);if("undefined"!=typeof panjs.root.components[a]&&"undefined"!=c.reuse&&!0===c.reuse){var h=panjs.root.components[a];h.reuse(c);return h}e=new window[d](c)}catch(l){f="Error instantiating "+d+": "+l,logger.error(f),uses("core.display.TerrorElement.html"),e=panjs.getAbsoluteUrlFromClassPath(a),h=panjs.loader.getUrlWithVersion(e),e=new TerrorElement({message:f,path:e,url:h,className:d}),panjs.stack.push(f)}panjs.stackLevel--;
0>=panjs.stackLevel&&(panjs.stack=[],panjs.stackLevel=0);e._onInitialized&&e._onInitialized();return panjs.root.components[a]=e};panjs.setElementArgs=function(a,c){if("undefined"!=typeof a)for(var d=0;d<a.attributes.length;d++){var e=a.attributes.item(d),f=e.nodeName.toLowerCase(),e=e.value;f.startsWith("data-")&&(f=panjs.getFormatedArgName(f));"true"==e?e=!0:"false"==e&&(e=!1);c[f]=e}};panjs.getFormatedIdName=function(a){if(-1==a.indexOf("-"))return a;var c="";a=a.split("-");for(var d=0;d<a.length;d++)c=
...
"OR",d=a.getAttribute("excludeFrom");null!=d&&(d=d.split(" "));var e=a.getAttribute("excludeLogic")||"OR";if(null!=d&&null!=b)throw"'excludeFrom' and 'includeIn' attributes are exclusive";if(null!=b||null!=d)a={visible:null,excludeLogic:e,includeLogic:c,elem:a,id:a.getAttribute("id"),includeIn:b,excludeFrom:d},this._statesElements.push(a)},stateExists:function(a){var b=!1;if(null==a||""==a)return!1;for(var c=0;c<this._statesElements.length;c++){var d=this._statesElements[c];if(null!=d.includeIn&&
...
this._statesElements[g],l=!0,n=!0;if(null!=h.includeIn)for(n=null,l=!0,f=0;f<h.includeIn.length;f++){var q=h.includeIn[f],q="undefined"!=typeof b[q];if("OR"==h.includeLogic){if(l=q)break}else l=l&&q}else if(null!=h.excludeFrom)for(n=!1,l=null,f=0;f<h.excludeFrom.length;f++)if(q=h.excludeFrom[f],q="undefined"!=typeof b[q],"OR"==h.excludeLogic){if(n=q)break}else n=n&&q;if(null!=l||null!=n)d=this._setStateElementVisible(!0==l||!1==n,h)||d}this.currentState=[];for(var m in b)this.currentState.push(m),
...
e.getAttribute("id"),g=e.getAttribute("data-compo");null==g?(g=$(e),b&&null!=f&&(defined(this[f])&&logger.error('1-Duplication du id "'+f+'" sur objet '+this.className),this[panjs.getFormatedIdName(f)]=g,c.push(f)),this.bindEvents(g),this._populateElements(e,b,c)):g==this.classPath?logger.error("R\u00e9f\u00e9rence circulaire dans "+this.classPath):"false"!==e.getAttribute("autoload")?(g=this.createComponent(g,{elem:e,parent:this}),g.parent=this,b&&null!=f&&(defined(this[f])&&logger.error('2-Duplication du id "',
f,'" sur objet ',this.className),this[f]=g,c.push(f)),$(e).replaceWith(g.container),g.container[0].owner=g,e.loaded=!0,e.compo=g,g.loaded=!0):(e.setAttribute("id",this.id+"_"+f),uses("core.display.TproxyDisplayObject"),g=new TproxyDisplayObject({sourceElement:e}),g.parent=this,e.loaded=!1,e.compo=g,$(e).hide(),b&&null!=f&&(this[f]=g));e.originalId=f;e.owner=this;this.processStates(e)}else 8==e.nodeType&&(f="",f=e.textContent,f=f.toUpperCase(),"CONTENT"==f&&(f=document.createElement("div"),f.setAttribute("data-class",
"content"),a.replaceChild(f,e),this.content=$(f)))}return c}});TdisplayObjectContainer._listeIdElements=[];
...
_getSuccessEvent:function(a,b,c){logger.debug("X-Time="+b.getResponseHeader("X-Time"));a=new Tevent(Tevent.SUCCESS,a);a.xTime=b.getResponseHeader("X-Time");a.req=b;return a},_getErrorEvent:function(a,b,c,d,e){b={req:a,method:b,responseText:"",statusText:"Erreur inconnue",status:0,url:"url=?"};defined(a,"statusText")?b.statusText=a.statusText:b.statusText="";defined(c)&&(b.statusText=c);defined(d)&&(b.url=d);defined(a,"responseText")&&(b.responseText=a.responseText);""==b.responseText&&(b.responseText=
"Empty response. status="+b.statusText);defined(a,"status")&&(b.status=a.status);0==b.status&&(b.status=1);b.token=e;try{b.data=JSON.parse(b.responseText)}catch(f){b.data=b.responseText}return new Tevent(Tevent.ERROR,b)},post:function(a,b,c,d,e,f){this._call("POST",a,b,c,d||null,e||null,f||null)},get:function(a,b,c,d,e,f){this._call("GET",a,b,c,d||null,e||null,f||null)},getText:function(a,b,c,d,e,f){this._call("GET",a,b,c,d||null,e||null,f||null,"text")},put:function(a,b,c,d,e,f){this._call("PUT",
a,b,c,d||null,e||null,f||null)},del:function(a,b,c,d,e,f){this._call("DELETE",a,b,c,d||null,e||null,f||null)},_call:function(a,b,c,d,e,f,g,h){8>arguments.length&&(h=this.dataType);"json"!=h||"POST"!=a&&"PUT"!=a||(d=JSON.stringify(d));null==g&&(g={});g.id=this.getNewTokenId();g.requestId||(g.requestId=g.id);-1==b.lastIndexOf("?")&&(b+="?");b+="&";var l=this.extraUrlParams;if(defined(c))if("object"==typeof c)for(p in c)l+=l+"&"+p+"="+c[p];else l+="&"+c;var l=l.replace(/#/g,"%23"),n=this.baseUrl+b+l;
...
(d=c[this.exitCodeFieldName],defined(d)&&400<=d)){c=this._getErrorEvent(h,a,c[this.errorTextFieldName],n,g);this.dispatchEvent(c);defined(f)&&f(c,g);return}c=this._getSuccessEvent(c,h,g);this.dispatchEvent(c);defined(e)&&e(c,g)}},error:function(c,d,e){if(g.aborted)logger.debug("Requ\u00eate "+g.requestId+" ANNULEE sur ",b);else{logger.error("TrestClient._call.error: Echec requ\u00eate "+g.requestId+": "+e+" sur ",b);var h="?";0==c.readyState&&(h="request not initialized");1==c.readyState&&(h="server connection established");
...
s);logger.debug("textStatus="+d);logger.debug("errorThrown = "+e);c=this._getErrorEvent(c,a,e,n,g);this.dispatchEvent(c);defined(f)&&f(c,g)}}})}});TrestClient.lastTokenId=0;
