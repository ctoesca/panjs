...
var Tobject={classHierarchy:"Tobject",extend:function(a,b,c){var d=this.prototype||Tobject,e={};e.classHierarchy={value:d.classHierarchy+" "+b};if(8!=panjs.iever){for(var f in a)if(f.startsWith("$")){b=a[f];f=f.droite("$");logger.debug("BINDABLE => "+f+", defaultValue="+b);e["__"+f]={value:b,writable:!0,enumerable:!0};b=new Function('var key = "__'+f+'", propName="'+f+'",oldValue=this[key];newValue=arguments[0]; if (this[key] != arguments[0]){this[key] = arguments[0]; this.__OnPropChanged(propName, oldValue, newValue, this);}');var g=
...
b){var c=panjs.transformUrl(a.getAttribute("href"),b),d=a.getAttribute("type")||"text/css",e=a.getAttribute("rel")||"stylesheet";this.loadCssFile(c,d,e)},loadCssFile:function(a,b,c){var d=!1;a=this.getUrlWithVersion(a);if(this.loadedCss[a.toLowerCase()])return d;if(0==arguments.length)throw"loadCssFile(url, type , rel): Missing url";"undefined"==typeof b&&(b="text/css");"undefined"==typeof c&&(c="stylesheet");if(document.createStyleSheet&&8==panjs.iever)document.createStyleSheet(a),d=!0;else{var e=
document.createElement("link");e.rel=c;e.type=b;e.href=a;"stylesheet/less"==c?0<panjs.iever&&8>=panjs.iever?logger.warn(panjs.getMessage(panjs.messages.LESS_IE8,panjs.iever)):this.lessIsLoaded()?(less.sheets.push(e),less.refresh(!0),logger.debug("INJECTION LESS OK"),d=!0):logger.warn(panjs.getMessage(panjs.messages.LESS_NOT_LOADED)):(document.getElementsByTagName("head")[0].appendChild(e),d=!0)}!0==d&&logger.debug("Load <link> ASYNC: "+a);this.loadedCss[a.toLowerCase()]=!0;return d},addStyle:function(a,
