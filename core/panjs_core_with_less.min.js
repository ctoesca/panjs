...
function exec(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))}function getDateFromTimestamp(a,b){var c="";if(null!=a){2>arguments.length&&(b="/");var c=new Date(1E3*parseInt(a)),d=c.getFullYear(),e=c.getMonth()+1;10>e&&(e="0"+e);var f=c.getDate();10>f&&(f="0"+f);var g=c.getHours();10>g&&(g="0"+g);var h=c.getMinutes();10>h&&(h="0"+h);c=c.getSeconds();10>c&&(c="0"+c);c=d+b+e+b+f+" "+g+":"+h+":"+c}return c}
...
g="false"!==e.attr("autoload"),h=e.attr("id");!0==g?(f=panjs.createComponent(f,{elem:e[0]}),e.replaceWith(f.container),f.container[0].owner=f):(uses("core.display.TproxyDisplayObject"),f=new TproxyDisplayObject({sourceElement:e[0]}),f.parent=this,e[0].loaded=!1,e.hide(),e[0].setAttribute("id",panjs.root.id+"_"+h),e[0].originalId=h,e[0].owner=panjs.root);panjs.root[h]=f}logger.info("READY");"undefined"!=typeof onReady&&onReady()};panjs.getClassNameFromClassPath=function(a){var c=".";if(a.startsWith("http://")||
a.startsWith("https://")||"/"==a[0])c="/";var d=a;a.endsWith(".html")&&(d=a.removeEnd(".html"));a=d.split(c);return d=a[a.length-1]};panjs.getNamespace=function(a){for(var c=0;c<panjs.namespaces.length;c++){var d=panjs.namespaces[c];if(d.name==a)return d}return null};panjs.getAbsoluteUrlFromClassPath=function(a){var c=a.endsWith(".html"),d="";if(a.startsWith("http://")||"/"==a[0])d=c?a:a+".js";else if(a.contains("."))for(var e=0;e<panjs.namespaces.length;e++){var f=panjs.namespaces[e];if(a.startsWith(f.name+
".")){d=a.removeEnd(".html").replace(/\./g,"/");d=d.replace(f.name,f.path);d=c?d+".html":d+".js";break}}else d=a,d=c?d+".html":d+".js";if(""==d)throw"Can't resolve "+a+": verify namespaces";return d};panjs.isAbsoluteUrl=function(a){a=a.toLowerCase();return"/"==a[0]||a.toLowerCase().startsWith("http://")||a.toLowerCase().startsWith("https://")};panjs.transformUrl=function(a,c){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=c+"/"+a);return a}})();
var Tobject={classHierarchy:"Tobject",extend:function(a,b,c){var d=this.prototype||Tobject,e={};e.classHierarchy={value:d.classHierarchy+" "+b};if(8!=panjs.iever){for(var f in a)if(f.startsWith("$")){b=a[f];f=f.droite("$");logger.debug("BINDABLE => "+f+", defaultValue="+b);e["__"+f]={value:b,writable:!0};b=new Function('var key = "__'+f+'", propName="'+f+'",oldValue=this[key];newValue=arguments[0]; if (this[key] != arguments[0]){this[key] = arguments[0]; this.__OnPropChanged(propName, oldValue, newValue);}');
var g=new Function('var key = "__'+f+'"; return this[key]');e[f]={get:g,set:b}}else e[f]={value:a[f],writable:!0,configurable:!0,enumerable:!0};a=Object.create(d,e);f=a.constructor;if(!(f instanceof Function))throw Error("You must define a method 'constructor'");f.prototype=a;f.prototype.parentClassName=c;f._super=d;f.extend=this.extend}else{e=a.constructor;for(f in d)"constructor"!=f&&"_super"!=f&&(e.prototype[f]=d[f]);for(f in a)"constructor"!=f&&"_super"!=f&&(e.prototype[f]=a[f]);e.extend=this.extend;
...
a){this._source=a;(new Date).getTime();this._items=null!=this.filterFunction?this._source.filter(this.filterFunction):this._source;(new Date).getTime();if(null!=this.key)for(this._byId={},a=0;a<this._items.length;a++)this._byId[this._items[a][this.key]]=this._items[a];this.length=this._items.length;this.refresh()}},find:function(a){var b=[];if(a.filterFunction)for(var c=0;c<this._source.length;c++)a.filterFunction(this._source[c])&&b.push(this._source[c]);return b},getByKey:function(a){return this._byId[a]},
...
a&&(this.filterFunction=a)},dispatchUpdateEvent:function(a,b){this.dispatchEvent(new Tevent(Tevent.UPDATE,b));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"UPDATE",item:a,newItem:b}))},refresh:function(){this._items=null!=this.filterFunction?this._source.filter(this.filterFunction):this._source;this.length=this._items.length;this.dispatchEvent(new Tevent(Tevent.REFRESH,this));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"REFRESH"}))},itemUpdated:function(a,b,c,d){this.dispatchEvent(new Tevent(Tevent.UPDATE,
a))},_getItemIndex:function(a,b){for(var c=0;c<b.length;c++)if(b[c]==a)return c;return-1},getItemIndex:function(a){return this._getItemIndex(a,this._items)},getItemAt:function(a){return this._items[a]},contains:function(a){return 0<=this.getItemIndex(a)},replaceItem:function(a,b){if(a!=b){var c=this.getItemIndex(a);-1<c&&(this._source[this._getItemIndex(a,this._source)]=b,null==this.filterFunction||this.filterFunction(b)?(this._items[c]=b,null!=this.key&&(this._byId[a[this.key]]=b,this.dispatchEvent(new Tevent(Tevent.UPDATE,
a))),this.length=this._items.length,this.dispatchEvent(new Tevent(Tevent.REPLACE,{item:a,newItem:b})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"REPLACE",item:a,newItem:b}))):this.filterFunction&&!this.filterFunction(b)&&this._removeItemAt(c,b))}},addItem:function(a){this._source.push(a);if(null==this.filterFunction||this.filterFunction(a))this.getItemIndex(a),this._items.push(a),this.length=this._items.length,null!=this.key&&(this._byId[a[this.key]]=a),this.dispatchEvent(new Tevent(Tevent.ADDED,
{item:a,index:this.length-1})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:a,index:this.length-1}))},addItemsAt:function(a,b){for(var c=b,d=0;d<a.length;d++)if(this._source.push(a[d]),null==this.filterFunction||this.filterFunction(a[d]))this._items.splice(c,0,a),c++,null!=this.key&&(this._byId[a[d][this.key]]=a[d]),this.length=this._items.length,this.dispatchEvent(new Tevent(Tevent.ADDED,{item:a[d],index:c})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:a[d],
index:c}));this.dispatchEvent(new Tevent(Tevent.REFRESH,this))},addItems:function(a){this.addItemsAt(a,this.length)},addItemAt:function(a,b){this._source.push(a);if(null==this.filterFunction||this.filterFunction(a))this._items.splice(b,0,a),null!=this.key&&(this._byId[a[this.key]]=a),this.length=this._items.length,this.dispatchEvent(new Tevent(Tevent.ADDED,{item:a,index:b})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:a,index:b}))},removeItem:function(a){var b=this.getItemIndex(a);
0<=b&&this._removeItemAt(b,a);return b},removeItemAt:function(a){var b=this.getItemAt(a);null!=b&&this._removeItemAt(a,b)},removeAll:function(){this._source=[];this._items=[];this._byId={};this.refresh()},_removeItemAt:function(a,b){this._items.splice(a,1);var c=this._getItemIndex(b,this._source);0<=c&&this._source.splice(c,1);this.length=this._items.length;null!=this.key&&delete this._byId[b[this.key]];this.dispatchEvent(new Tevent(Tevent.DELETE,b));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"DELETE",
item:b}))}});
defineClass("TdisplayObject","core.events.TeventDispatcher",{container:null,id:null,parent:null,_parent:null,visible:!0,autoload:!0,loaded:!1,baseElement:null,_realVisible:!1,args:null,load:function(){return this},free:function(){TdisplayObject._super.free.call(this);this.container.remove()},_onInitialized:function(){},constructor:function(a){TdisplayObject._super.constructor.call(this,a);this.args=a;if(null==this.baseElement)throw'La propri\u00e9t\u00e9 "baseElement" n\'est pas d\u00e9fini sur '+this.className;
this.container=$("<"+this.baseElement+"/>");window[this.className].lastId++;this._setId(this.className+window[this.className].lastId);this.container[0].owner=this},addClass:function(a){this.container.addClass(a)},removeClass:function(a){this.container.removeClass(a)},appendTo:function(a){null!=this._parent?this._parent[0]!=a[0]&&(this._parent[0].removeChild(this.container[0]),a[0].appendChild(this.container[0]),this._parent=$(a[0])):(a[0].appendChild(this.container[0]),this._parent=$(a[0]))},_setId:function(a){this.id=
a;this.container.attr("id","ctn"+this.id)},hide:function(a){this.container.hide(a);this._realVisible=this.visible=!1;"undefined"!=typeof this._onHide&&this._onHide()},show:function(a){this._realVisible||(this.container.show(a),this._realVisible=this.visible=!0,"undefined"!=typeof this._onShow&&this._onShow())},toggle:function(a){this.container.toggle("fast");this.visible=!this._visible}});
...
b);c&&(c.startsWith("{{")?(c=c.droite("{{").gauche("}}"),c=(new Function(c)).bind(this),a.on(b,c)):(new Function('arguments[0].on("'+b+'", '+c+".bind(this))")).bind(this)(a,b))},bindEvents:function(a){for(var b="click change blur blur keyup dblclick".split(" "),c=0;c<b.length;c++)this.bindEvent(a,b[c]);this.bind(a)},bind:function(a){var b=a.html();b.match(/\{\{.*\}\}/)&&(a.tempFn=doT.template(b).bind(this),this.__bindings.html.push({template:b,element:a,tempFn:a.tempFn}))},renderBindings:function(){for(var a=
0;a<this.__bindings.html.length;a++){var b=this.__bindings.html[a];logger.debug("RENDER "+b.template);try{b.element.html(b.tempFn(this))}catch(c){logger.error(c)}}},free:function(){TdisplayObjectContainer._super.free.call(this)},__OnPropChanged:function(a,b,c){logger.debug("__OnPropChanged : propName = "+a+", oldValue = "+b+", newValue = "+c);this.renderBindings()},processStates:function(a){var b=a.getAttribute("includeIn");null!=b&&(b=0<=b.indexOf(",")?b.split(","):[b]);var c=a.getAttribute("excludeFrom");
...
g?(g=$(e),b&&null!=f&&(defined(this[f])&&logger.error('1-Duplication du id "'+f+'" sur objet '+this.className),this[panjs.getFormatedIdName(f)]=g,c.push(f)),this.bindEvents(g),this._populateElements(e,b,c)):g==this.classPath?logger.error("R\u00e9f\u00e9rence circulaire dans "+this.classPath):"false"!==e.getAttribute("autoload")?(g=panjs.createComponent(g,{elem:e,parent:this}),g.parent=this,b&&null!=f&&(defined(this[f])&&logger.error('2-Duplication du id "',f,'" sur objet ',this.className),this[f]=
g,c.push(f)),!0==g.visible?($(e).replaceWith(g.container),g.container[0].owner=g):logger.info("PAS DE replaceWith pour ",g.id," visible = ",g.visible," ",typeof g.visible),e.loaded=!0,g.loaded=!0):(e.setAttribute("id",this.id+"_"+f),uses("core.display.TproxyDisplayObject"),g=new TproxyDisplayObject({sourceElement:e}),g.parent=this,e.loaded=!1,$(e).hide(),b&&null!=f&&(this[f]=g));e.originalId=f;e.owner=this;this.processStates(e)}else 8==e.nodeType&&(f="",f=-1==panjs.iever||8<panjs.iever?e.textContent:
e.text.droite("\x3c!--").gauche("--\x3e").trim(),f=f.toUpperCase(),"CONTENT"==f&&(f=document.createElement("div"),f.setAttribute("data-class","content"),a.replaceChild(f,e),this.content=$(f)))}return c}});TdisplayObjectContainer._listeIdElements=[];
