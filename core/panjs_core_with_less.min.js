...
e.childNodes[n],r=q.nodeName.toLowerCase();if("script"==r)try{this.addScriptNode(q,s,b)}catch(t){var l="Error processing <"+r+"> => "+t;logger.error(d,l);return{result:!1,message:l,className:b,classPath:a,url:c,path:d,stack:t.stack}}else"link"==r?h.push(q):"style"==r&&m.push(q)}if("undefined"==typeof window[b])return l=a+" class has not been loaded. ",panjs.lastDefinedClassName!=b&&(l+="\n"+panjs.getMessage(panjs.messages.CLASSNAME_MATCHS_FILENAME,panjs.lastDefinedClassName,d)),logger.error(l),{result:!1,
