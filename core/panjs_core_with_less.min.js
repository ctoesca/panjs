...
createComponent:function(a,b){var c=TdisplayObjectContainer._super.createComponent(a,b);null==this._children&&(this._children=[]);this._children.push(c);return c},free:function(){if(null!=this._children){TdisplayObjectContainer._super.free.call(this);for(var a=0;a<this._children.length;a++)this._children[a].free();this._children=null}},__OnPropChanged:function(a,b,c,d){logger.debug("__OnPropChanged : propName = "+a+", oldValue = "+b+", newValue = "+c);this.renderBindings()},processStates:function(a){var b=
a.getAttribute("includeIn");null!=b&&(b=b.split(" "));var c=a.getAttribute("includeLogic")||"OR",d=a.getAttribute("excludeFrom");null!=d&&(d=d.split(" "));var f=a.getAttribute("excludeLogic")||"OR";if(null!=d&&null!=b)throw"'excludeFrom' and 'includeIn' attributes are exclusive";if(null!=b||null!=d)a={visible:null,excludeLogic:f,includeLogic:c,elem:a,id:a.getAttribute("id"),includeIn:b,excludeFrom:d},this._statesElements.push(a)},stateExists:function(a){var b=!1;if(null==a||""==a)return!1;for(var c=
0;c<this._statesElements.length;c++){var d=this._statesElements[c];if(null!=d.includeIn&&0<=d.includeIn.indexOf(a)){b=!0;break}else if(null!=d.excludeFrom&&0<=d.excludeFrom.indexOf(a)){b=!0;break}}return b},_setStateElementVisible:function(a,b){var c=null!=b.elem.getAttribute("data-compo"),d=!1;b.visible!=a&&(d=!0,a?c?(b.elem.compo.load(),b.elem.compo.show()):$(b.elem).show():c?b.elem.compo.hide():$(b.elem).hide(),b.visible=a);return d},hasState:function(a){for(var b=!1,c=0;c<this.currentState.length;c++)if(this.currentState[c]==
a){b=!0;break}return b},addState:function(a){for(var b=[],c=!1,d=!1,f=0;f<this.currentState.length;f++)this.currentState[f]==a?c=!0:b.push(this.currentState[f]);c||(d=!0,b.push(a),this.setState(b));return d},removeState:function(a){for(var b=[],c=!1,d=0;d<this.currentState.length;d++)this.currentState[d]!=a?b.push(this.currentState[d]):c=!0;c&&this.setState(b);return c},setState:function(a){var b={},c={},d=!1;if("object"!=typeof a)for(var f=[],e=0;e<arguments.length;e++)f.push(arguments[e]),b[arguments[e]]=
1;else for(f=a,e=0;e<f.length;e++)b[f[e]]=1;f=this.currentState;for(e=0;e<this.currentState.length;e++)this.container.removeClass(this.currentState[e]),c[this.currentState[e]]=1;this.currentState=[];for(var g=0;g<this._statesElements.length;g++){var h=this._statesElements[g],l=!0,n=!0;if(null!=h.includeIn)for(n=null,l=!0,e=0;e<h.includeIn.length;e++){var q=h.includeIn[e],q="undefined"!=typeof b[q];if("OR"==h.includeLogic){if(l=q)break}else l=l&&q}else if(null!=h.excludeFrom)for(n=!1,l=null,e=0;e<
h.excludeFrom.length;e++)if(q=h.excludeFrom[e],q="undefined"!=typeof b[q],"OR"==h.excludeLogic){if(n=q)break}else n=n&&q;if(null!=l||null!=n)d=this._setStateElementVisible(!0==l||!1==n,h)||d}this.currentState=[];for(var m in b)this.currentState.push(m),this.container.addClass(m);if(d){logger.debug(this.id+".currentState = "+JSON.stringify(this.currentState));e=[];for(m in b)"undefined"==typeof c[m]&&e.push(m);g=[];for(m in c)"undefined"==typeof b[m]&&g.push(m);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,
{oldStates:f,newStates:this.currentState,removedStates:g,addedStates:e}))}return d},_populateElements:function(a,b,c){for(var d=0;d<a.childNodes.length;d++){var f=a.childNodes[d];if(1==f.nodeType){var e=f.getAttribute("id"),g=f.getAttribute("data-compo");null==g?(g=$(f),b&&null!=e&&(defined(this[e])&&logger.error('1-Duplication du id "'+e+'" sur objet '+this.className),this[panjs.getFormatedIdName(e)]=g,c.push(e)),this.bindEvents(g),this._populateElements(f,b,c)):g==this.classPath?logger.error("R\u00e9f\u00e9rence circulaire dans "+
this.classPath):"false"!==f.getAttribute("autoload")?(g=this.createComponent(g,{elem:f,parent:this}),g.parent=this,b&&null!=e&&(defined(this[e])&&logger.error('2-Duplication du id "',e,'" sur objet ',this.className),this[e]=g,c.push(e)),$(f).replaceWith(g.container),g.container[0].owner=g,f.loaded=!0,f.compo=g,g.loaded=!0):(f.setAttribute("id",this.id+"_"+e),uses("core.display.TproxyDisplayObject"),g=new TproxyDisplayObject({sourceElement:f}),g.parent=this,f.loaded=!1,f.compo=g,$(f).hide(),b&&null!=
e&&(this[e]=g));f.originalId=e;f.owner=this;this.processStates(f)}else 8==f.nodeType&&(e="",e=-1==panjs.iever||8<panjs.iever?f.textContent:f.text.droite("\x3c!--").gauche("--\x3e").trim(),e=e.toUpperCase(),"CONTENT"==e&&(e=document.createElement("div"),e.setAttribute("data-class","content"),a.replaceChild(e,f),this.content=$(e)))}return c}});TdisplayObjectContainer._listeIdElements=[];
