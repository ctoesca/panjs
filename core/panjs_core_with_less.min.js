...
f=0;f<g.attributes.length;f++){var h=g.attributes.item(f),l=h.nodeName.toLowerCase(),m=h.value;"id"!=l&&"data-compo"!=l&&(l.startsWith("data-")&&(l=panjs.getFormatedArgName(l)),"true"==m&&(m=!0),"false"==m&&(m=!1),c[l]=m)}if("undefined"!=typeof panjs.root.components[a]&&"undefined"!=c.reuse&&!0===c.reuse){var r=panjs.root.components[a];r.reuse(c);return r}e=new window[d](c)}catch(n){g="Error instantiating "+d+": "+n,logger.error(g),uses("core.display.TerrorElement.html"),e=panjs.getAbsoluteUrlFromClassPath(a),
h=panjs.loader.getUrlWithVersion(e),e=new TerrorElement({message:n,path:e,url:h,className:d}),panjs.stack.push(g)}panjs.stackLevel--;0>=panjs.stackLevel&&(panjs.stack=[],panjs.stackLevel=0);e._onInitialized&&e._onInitialized();return panjs.root.components[a]=e};panjs.getFormatedIdName=function(a){if(-1==a.indexOf("-"))return a;var c="";a=a.split("-");for(var d=0;d<a.length;d++)c=0==d?a[d]:c+a[d].capitalizeFirstLetter();return c};panjs.getFormatedArgName=function(a){var c="";a=a.split("-");for(var d=
1;d<a.length;d++)c=1==d?a[d]:c+a[d].capitalizeFirstLetter();return c};panjs.loadScript=function(a,c){$LAB.script(a).wait(function(){"undefined"!=typeof c&&c(a)})};panjs.load=function(a){panjs._load(a)};panjs._load=function(a){0==arguments.length&&(a=$(document.body));var c=[];null!=a.attr("data-compo")?c.push(a):c=a.getElements("[data-compo]");for(var d=0;d<c.length;d++){var e=c[d],f=e.attr("data-compo"),g="false"!==e.attr("autoload"),h=e.attr("id");!0==g?(f=panjs.createComponent(f,{elem:e[0]}),e.replaceWith(f.container),
f.container[0].owner=f):(uses("core.display.TproxyDisplayObject"),f=new TproxyDisplayObject({sourceElement:e[0]}),f.parent=this,e[0].loaded=!1,e.hide(),e[0].setAttribute("id",panjs.root.id+"_"+h),e[0].originalId=h,e[0].owner=panjs.root);panjs.root[h]=f}logger.info("READY");"undefined"!=typeof onReady&&onReady()};panjs.getClassNameFromClassPath=function(a){var c=".";if(a.startsWith("http://")||a.startsWith("https://")||"/"==a[0])c="/";var d=a;a.endsWith(".html")&&(d=a.removeEnd(".html"));a=d.split(c);
return d=a[a.length-1]};panjs.getNamespace=function(a){for(var c=0;c<panjs.namespaces.length;c++){var d=panjs.namespaces[c];if(d.name==a)return d}return null};panjs.getAbsoluteUrlFromClassPath=function(a){var c=a.endsWith(".html"),d="";if(a.startsWith("http://")||"/"==a[0])d=c?a:a+".js";else for(var e=0;e<panjs.namespaces.length;e++){var f=panjs.namespaces[e];if(a.startsWith(f.name+".")){d=a.removeEnd(".html").replace(/\./g,"/");d=d.replace(f.name,f.path);d=c?d+".html":d+".js";break}}if(""==d)throw"Can't resolve "+
a+": verify namespaces";return d};panjs.isAbsoluteUrl=function(a){a=a.toLowerCase();return"/"==a[0]||a.toLowerCase().startsWith("http://")||a.toLowerCase().startsWith("https://")};panjs.transformUrl=function(a,c){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=c+"/"+a);return a}})();
...
panjs.getClassNameFromClassPath(a),c=null,c=null;if("undefined"==typeof window[a]){logger.groupStart();0==this._count&&logger.info(" ------------ "," USES ",a," ------------ ");var c=panjs.getAbsoluteUrlFromClassPath(a),d=c.substring(0,c.lastIndexOf("/"));if(this.loadedJs[c.toLowerCase()])return!0;this._count++;logger.groupStart();c=this.getUrlWithVersion(c);c=this.loadFile(c);c.result&&(c.data=this.processCode(c.data,b),exec(c.data),window[b].prototype.classPath=a,window[b].prototype.className=b,
window[b].prototype.classPathDir=this.getClassPathDir(a),window[b].prototype.dirPath=d,window[b].lastId=0,window[a]=window[b]);this._count--;logger.groupEnd();0==this._count&&logger.debug(" ------------ "," END USES ",a," ------------ ");logger.groupEnd();return!0}},addLinkNode:function(a,b){var c=panjs.transformUrl(a.getAttribute("href"),b),d=a.getAttribute("type")||"text/css",e=a.getAttribute("rel")||"stylesheet";this.loadCssFile(c,d,e)},loadCssFile:function(a,b,c){var d=!1;a=this.getUrlWithVersion(a);
if(this.loadedCss[a.toLowerCase()])return d;if(0==arguments.length)throw"loadCssFile(url, type , rel): Missing url";"undefined"==typeof b&&(b="text/css");"undefined"==typeof c&&(c="stylesheet");if(document.createStyleSheet&&8==panjs.iever)document.createStyleSheet(a),d=!0;else{var e=document.createElement("link");e.rel=c;e.type=b;e.href=a;"stylesheet/less"==c?0<panjs.iever&&8>=panjs.iever?logger.warn(panjs.getMessage(panjs.messages.LESS_IE8,panjs.iever)):this.lessIsLoaded()?(less.sheets.push(e),less.refresh(!0),
logger.debug("INJECTION LESS OK"),d=!0):logger.warn(panjs.getMessage(panjs.messages.LESS_NOT_LOADED)):(document.getElementsByTagName("head")[0].appendChild(e),d=!0)}!0==d&&logger.debug("Load <link> ASYNC: "+a);this.loadedCss[a.toLowerCase()]=!0;return d},addStyle:function(a,b){"undefined"==typeof b&&(b="text/css");$('<style type="'+b+'">'+a+"</style>").appendTo("head");"text/less"==b&&(0<panjs.iever&&8>=panjs.iever?logger.warn(panjs.getMessage(panjs.messages.LESS_IE8,panjs.iever)):this.lessIsLoaded()?
(less.refresh(),logger.debug("INJECTION LESS OK")):logger.warn(panjs.getMessage(panjs.messages.LESS_NOT_LOADED)));8==panjs.iever&&"undefined"!=typeof respond&&respond.update()},addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");a=getText(a);this.addStyle(a,b)},processCode:function(a,b){return a.replace(/this._super/g,b+"._super")},addScriptNode:function(a,b,c){if(null==a.getAttribute("src"))b=getText(a),null!=c&&"text/x-class-definition"==a.getAttribute("type")&&(b=this.processCode(b,
...
a);if(a.cancelled)break}},on:function(a,b,c,d){4>arguments.length&&(d=null);3>arguments.length&&(c=null);var e={listener:b,data:d,bind:c};this.hasEventListener(a)||(this._listeners[a]=[]);for(var f=0;f<this._listeners[a].length;f++)if(null==this._listeners[a][f]){this._listeners[a][f]=e;return}this._listeners[a].push(e)},off:function(a,b){var c=this._getListenerIndex(a,b);0<=c&&(this._listeners[a][c]=null)},removeAllListeners:function(){for(type in this._listeners)this._listeners[type].length=0,this._listeners[type]=
...
getHash:function(a){this.refreshkeys();return this.keys[a.hashKey]||null},setHash:function(a,b){if(this.keys[a.hashKey]!=b){this.keys[a.hashKey]=b||null;var c=this.encode(this.keys);sendEvents=!1;window.location.hash=c;this._dispatchOnhashchange(a.hashKey,b);sendEvents=!0}else logger.debug("setHash "+b+" => inchang\u00e9 sur "+a.id)},_dispatchOnhashchange:function(a,b){"undefined"==typeof b&&(b=null);return this.listeners[a].onhashchange(b)},decode:function(a){var b={};if(""!=a)try{this.base64encode&&
(a=base64decode(a));a=a.split("&");for(var c=0;c<a.length;c++)if(""!=a[c].trim()){var d=a[c].split("=");k=d[0];v=d[1];b[k]=v}}catch(e){logger.error("Echec decodage de "+a+" en objet: "+e)}return b},encode:function(a){var b="";try{for(k in a)""!=a[k].trim()&&(b=b+k+"="+a[k]+"&");this.base64encode&&(b=base64encode(b))}catch(c){logger.error("Echec encodage de "+a+" en string: "+c)}return b},onhashchange:function(a){if(!this.sendEvents)return!1;this.hash=window.location.hash.droite("#");this.keysTmp=
this.decode(this.hash);for(k in this.keys)logger.debug("keys."+k+" = "+this.keys[k]+", hash."+k+" = "+this.keysTmp[k]),this.keysTmp[k]!=this.keys[k]&&(this.keys[k]=this.keysTmp[k]||null,"undefined"!=typeof this.listeners[k]&&(logger.debug("Le composant "+k+" va \u00eatre notifi\u00e9 que son hash a chang\u00e9: hash="+this.keys[k]),this._dispatchOnhashchange(k,this.keys[k])));a=new Tevent(Trouter.HASH_CHANGE,this.keys);this.dispatchEvent(a);return!1}});Trouter.HASH_CHANGE="HASH_CHANGE";
...
this._source[f];if("undefined"!=typeof g[a]&&g[a]==b)if(!0==e)d.push(g);else{d=g;break}}return d},replaceItem:function(a,b){if(a!=b){var c=this.getItemIndex(a);-1<c&&(this._source[c]=b,this.length=this._source.length,this.dispatchEvent(new Tevent(Tevent.REPLACE,{item:a,newItem:b})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"REPLACE",item:a,newItem:b})))}},updateItem:function(a){this.dispatchEvent(new Tevent(Tevent.UPDATE,a))},getItemIndex:function(a){for(var b=0;b<this._source.length;b++)if(this._source[b]==
a)return b;return-1},getItemAt:function(a){return this._source[a]},addItem:function(a){-1==this.getItemIndex(a)&&(this._source.push(a),this.length=this._source.length,this.dispatchEvent(new Tevent(Tevent.ADDED,{item:a,index:this.length-1})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:a,index:this.length-1})))},addItems:function(a){for(var b=0;b<a.length;b++)this._source.push(a[b]);this.length=this._source.length;this.dispatchEvent(new Tevent(Tevent.REFRESH,this))},addItemAt:function(a,
b){this._source.splice(b,0,a);this.length=this._source.length;this.dispatchEvent(new Tevent(Tevent.ADDED,{item:a,index:b}));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:a,index:b}))},removeItem:function(a){var b=this.getItemIndex(a);0<=b&&this._removeItemAt(b,a);return b},removeItemAt:function(a){var b=this.getItemAt(a);null!=b&&this._removeItemAt(a,b)},removeAll:function(){this._source=[];this.refresh()},refresh:function(){this.length=this._source.length;this.dispatchEvent(new Tevent(Tevent.REFRESH,
this));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"REFRESH"}))},_removeItemAt:function(a,b){this._source.splice(a,1);this.length=this._source.length;this.dispatchEvent(new Tevent(Tevent.DELETE,b));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"DELETE",item:b}))}});
...
"id")?this._setId(a.id):this._setId(this.className+window[this.className].lastId);this.container[0].owner=this},addClass:function(a){this.container.addClass(a)},removeClass:function(a){this.container.removeClass(a)},appendTo:function(a){null!=this._parent?this._parent[0]!=a[0]&&(this._parent[0].removeChild(this.container[0]),a[0].appendChild(this.container[0]),this._parent=$(a[0])):(a[0].appendChild(this.container[0]),this._parent=$(a[0]))},_setId:function(a){this.id=a;this.container.attr("id","ctn"+
