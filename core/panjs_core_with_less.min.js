...
this.dispatchEvent(new Tevent(Tevent.ADDED,{item:b,index:a}));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:b,index:a}))},addItem:function(a){this._source.push(a);(null==this.filterFunction||this.filterFunction(a))&&-1==this.getItemIndex(a)&&this._addItemAt(this.length,a)},addItemsAt:function(a,b){if(b>this.length)this.addItems(a);else for(var c=b,d=0;d<a.length;d++)if(this._source.push(a[d]),null==this.filterFunction||this.filterFunction(a[d]))b=this.getItemIndex(a[d]),-1<b&&(c++,
this._addItemAt(c,a[d]))},addItems:function(a){this.addItemsAt(a,this.length)},addItemAt:function(a,b){b>this.length?this.addItem(a):(this._source.push(a),(null==this.filterFunction||this.filterFunction(a))&&this._addItemAt(b,a))},removeItem:function(a){var b=this.getItemIndex(a);0<=b&&this._removeItemAt(b,a);return b},removeItemAt:function(a){var b=this.getItemAt(a);null!=b&&this._removeItemAt(a,b)},removeAll:function(){this._source=[];this._items=[];this._byId={};this.refresh()},_removeItemAt:function(a,
b){this._items.splice(a,1);var c=this._getItemIndex(b,this._source);0<=c&&this._source.splice(c,1);this.length=this._items.length;null!=this.key&&delete this._byId[b[this.key]];this.dispatchEvent(new Tevent(Tevent.DELETE,b));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"DELETE",item:b}))}});
