...
this._resizeFunction);this.container.remove();panjs.capture("free",{classPath:this.classPath,componentId:this.id})},_onInitialized:function(){},constructor:function(a){TdisplayObject._super.constructor.call(this,a);this.args=a;if(null==this.baseElement)throw'La propri\u00e9t\u00e9 "baseElement" n\'est pas d\u00e9fini sur '+this.className;this.container=$("<"+this.baseElement+"/>");panjs._classes[this.classPath].lastId++;this.id=this.classPath+"_"+panjs._classes[this.classPath].lastId;this.container[0].owner=
this;this.container[0].compo=this},addClass:function(a){this.container.addClass(a)},removeClass:function(a){this.container.removeClass(a)},createComponent:function(a,b,c){return panjs.createComponent(a,b,!1)},_triggerOnAdded:function(){this._onAdded&&($.contains(document.body,this.container[0])?this._onAdded():setTimeout(function(){$.contains(document.body,this.container[0])&&this._onAdded()}.bind(this),50))},append:function(a){var b=a,c=this.container;a.isCompo()&&(b=a.container,null!=this.content&&
(c=this.content));c.append(b);a._onAdded&&a._onAdded()},appendTo:function(a){a.append(this.container);a.isCompo()&&a[0].owner._children.push(this);this._triggerOnAdded()},prependTo:function(a){this.container.prependTo(a);a.isCompo()&&this._children.push(a[0].owner)},hide:function(a){defined(a,"hideFn")?a.hideFn(this.container):this.container.hide(a);this._realVisible=this.visible=!1;"undefined"!=typeof this._onHide&&this._onHide()},show:function(a){this._realVisible||(defined(a,"showFn")?a.showFn(this.container):
this.container.show(a),this._realVisible=this.visible=!0,"undefined"!=typeof this._onShow&&this._onShow())},toggle:function(a){this.container.toggle(a);this.visible=!this._visible}});__CLASSPATH__="panjs.core.display.TdisplayObjectContainer";
