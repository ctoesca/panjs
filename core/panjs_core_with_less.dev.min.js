...
void 0,delete a._classes[b])};a.createComponent=function(b,c){e++;var f=a._getClassNameFromClassPath(b),n=null;if("undefined"==typeof a._classes[b]&&(n=a.loader.usesComponent(b),!n.result))return"string"==typeof n&&(n={message:n,className:f}),n.stack=d,uses(a.errorComponentClass),object=new TerrorElement(n),d.push(n.message),e--,0>=e&&(d=[],e=0),object;"undefined"==typeof c&&(c={});if("undefined"!=typeof c.elem&&(f=c.elem,n=c,"undefined"!=typeof f))for(var p=0;p<f.attributes.length;p++){var l=f.attributes.item(p),
q=l.nodeName.toLowerCase(),l=l.value;q.startsWith("data-")&&(q=q.rightOf("data-"),q=a.getCamelCase(q));"true"==l?l=!0:"false"==l&&(l=!1);n[q]=l}if("undefined"!=typeof a.root.components[b]&&"undefined"!=c.reuse&&!0===c.reuse)return f=a.root.components[b],f.reuse(c),f;n=new a._classes[b].Class(c);e--;0>=e&&(d=[],e=0);n._onInitialized&&n._onInitialized();return a.root.components[b]=n};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?
a[c]:b+a[c].capitalizeFirstLetter();return b};a.loadScriptAsync=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};a.loadScriptSync=function(b){var c={result:null,errorMessage:""};if(this.loader.loadedJs[b.toLowerCase()])c.result=!0,logger.debug(a.messages.SCRIPT_ALREADY_LOADED,b);else{var d=this.loader._loadFileSync(this.loader._getUrlWithVersion(b));c.result=d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=
1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.getElements("[data-compo]");for(var e=0;e<d.length;e++){var f=d[e],l=f.attr("data-compo"),q="false"!==f.attr("data-autoload"),r=f.attr("id");!0==q?f=f.load():(a._setDOMId(f[0],r,l),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY");2==arguments.length&&c()};a._getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||a.startsWith("file://")||
a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};a.getAbsoluteUrlFromClassPath=function(b){var c=b.endsWith(".html"),d="";if(b.startsWith("http://")||b.startsWith("file://")||"/"==b[0])d=c?b:b+".js";else if(b.removeEnd(".html").contains(".")){var e=a.getNSFromClassPath(b);e&&(d=e.path+"/"+b.rightOf(e.name+
".").removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js")}else d=a.basePath+"/"+b,c||(d+=".js");""==d&&(d=b.removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js");return d}})(panjs=panjs||{});
...
a);logger.groupStart();c.path=panjs.getAbsoluteUrlFromClassPath(a);c.url=this._getUrlWithVersion(c.path);var d=this._loadFileSync(c.url);if(d.result){try{var e=getXmlDocument(d.data)}catch(f){return logger.error("XML error in class "+b+": "+f),c.isXmlError=!0,c.message=f,c}for(var g=e.getElementsByTagName("head")[0],e=e.getElementsByTagName("body")[0],h=[],m=[],n=c.path.substring(0,c.path.lastIndexOf("/")),p=0;p<g.childNodes.length;p++){var l=g.childNodes[p],q=l.nodeName.toLowerCase();"script"==q?
this.addScriptNode(l,n,b,a):"link"==q?h.push(l):"style"==q&&m.push(l)}b=panjs._classes[a].Class;for(p=0;p<h.length;p++)this.addLinkNode(h[p],n);for(p=0;p<m.length;p++)logger.debug("Load style %1",a),this.addStyleNode(m[p]);defined(e)&&(g=getXml(e),h=b.prototype.parentClassName,defined(window[h].prototype.html)&&window[h].prototype.html.contains("\x3c!--CONTENT--\x3e")&&(g=window[h].prototype.html.replace("\x3c!--CONTENT--\x3e",g)),g=g.replace(/<body>/gi,"").replace(/<\/body>/gi,""),b.prototype.html=
g,b.prototype.bodyNode=e);panjs.setSourceInComponents&&(b.prototype.source=d.data);b.prototype.classPathDir=this.getClassPathDir(a);b.prototype.dirPath=n;b.lastId=0;logger.groupEnd();logger.debug("END USESCOMPONENT %1",a);c.result=!0;c.message="ok";c.Class=b}else a="Error loading "+a+": "+d.status,logger.warn(a),c.mess=a}else c.result=!0,c.mess="Already loaded",c.Class=panjs._classes[a].Class;return c},uses:function(a){var b=panjs._getClassNameFromClassPath(a),c={result:!1,message:"",className:b,
classPath:a,url:null,path:null,Class:null};if("undefined"==typeof panjs._classes[a]){logger.debug("USES %1",a);logger.groupStart();c.path=panjs.getAbsoluteUrlFromClassPath(a);var d=c.path.substring(0,c.path.lastIndexOf("/"));c.url=this._getUrlWithVersion(c.path);var e=this._loadFileSync(c.url);if(e.result)e.data=this._processCode(e.data,b,d,a,".js"),panjs._exec(e.data),e=panjs._classes[a].Class,e.prototype.classPathDir=this.getClassPathDir(a),e.prototype.dirPath=d,e.lastId=0,c.result=!0,c.message=
"ok",c.Class=e;else throw a+" not loaded: "+e.status;logger.groupEnd();logger.debug("END USES %1",a)}else c.result=!0,c.message="Already loaded",c.Class=e;return c},_transformUrl:function(a,b){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"file://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=b+"/"+a);return a},addLinkNode:function(a,b){var c=this._transformUrl(a.getAttribute("href"),b),d=a.getAttribute("type")||"text/css",e=a.getAttribute("rel")||"stylesheet";this.loadCssFile(c,d,e)},loadCssFile:function(a,
b,c){if(0==arguments.length)throw"loadCssFile(url, type , rel): Missing url";var d=!1;a=this._getUrlWithVersion(a);if(this.loadedCss[a.toLowerCase()])return d;2>arguments.length&&(b="text/css");3>arguments.length&&(c="stylesheet");var e=document.createElement("link");e.rel=c;e.type=b;e.href=a;"stylesheet/less"==c?this.lessIsLoaded()?(less.sheets.push(e),less.refresh(!0),logger.debug(panjs.messages.LESS_INJECTED),d=!0):logger.warn(panjs.messages.LESS_NOT_LOADED):(document.getElementsByTagName("head")[0].appendChild(e),
d=!0);!0==d&&logger.debug("Load <link> ASYNC: %1",a);this.loadedCss[a.toLowerCase()]=!0;return d},addStyle:function(a,b){""!=a.trim()&&(2>arguments.length&&(b="text/css"),$('<style type="'+b+'">'+a+"</style>").appendTo("head"),"text/less"==b&&(this.lessIsLoaded()?(less.refresh(),logger.debug(panjs.messages.LESS_INJECTED)):logger.warn(panjs.messages.LESS_NOT_LOADED)))},addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");this.addStyle(a.textContent,b)},_processCode:function(a,
b,c,d,e){a=a.replace("defineClass(","var __CLASSPATH__='"+d+"';defineClass(").replace(/this._super/g,'panjs._classes["'+d+'"].Class._super')+"\n"+panjs._sourceUrl+c+"/"+b+e;return a=a.replace("defineStaticClass(","var __CLASSPATH__='"+d+"';defineStaticClass(")},addScriptNode:function(a,b,c,d){var e=a.getAttribute("data-subtype"),f=a.getAttribute("src");if(null==f)f=a.textContent,null!=c&&"text/x-class-definition"==e&&(f=this._processCode(f,c,b,d,".html")),panjs._exec(f);else if(a=this._transformUrl(f,
b),this.loadedJs[a.toLowerCase()])logger.debug(panjs.messages.SCRIPT_ALREADY_LOADED,a);else{var g=this._loadFileSync(this._getUrlWithVersion(a));g.data=null!=c&&"text/x-class-definition"==e?this._processCode(g.data,c,b,d,".js"):g.data+("\n"+panjs._sourceUrl+f+".js");panjs._exec(g.data);this.loadedJs[a.toLowerCase()]=1}return!0}});panjs.loader=new Tloader;panjs.loader.init();__CLASSPATH__="panjs.core.events.Tevent";
...
d[this.currentState[g]]=1;this.currentState=[];for(var h=0;h<this._statesElements.length;h++){var m=this._statesElements[h],n=!0,p=!0;if(null!=m.includeIn)for(p=null,n=!0,g=0;g<m.includeIn.length;g++){var l=m.includeIn[g],l="undefined"!=typeof c[l];if("OR"==m.includeLogic){if(n=l)break}else n=n&&l}else if(null!=m.excludeFrom)for(p=!1,n=null,g=0;g<m.excludeFrom.length;g++)if(l=m.excludeFrom[g],l="undefined"!=typeof c[l],"OR"==m.excludeLogic){if(p=l)break}else p=p&&l;if(null!=n||null!=p)e=this._setStateElementVisible(!0==
n||!1==p,m,b)||e}this.currentState=[];for(var q in c)this.currentState.push(q),this.container.addClass(q);if(e){logger.isLevelEnabled(Tlogger.TRACE)&&logger.trace(this.id+".currentState = "+JSON.stringify(this.currentState));g=[];for(q in c)"undefined"==typeof d[q]&&g.push(q);h=[];for(q in d)"undefined"==typeof c[q]&&h.push(q);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:f,newStates:this.currentState,removedStates:h,addedStates:g}))}return e},_populateElements:function(a,b,c){for(var d=
