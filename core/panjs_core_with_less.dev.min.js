...
$.fn.load=function(a){var b=$(this),c=null,d=b.attr("data-compo");null==d?logger.warn("This element is not a panjs component"):"true"!=b.attr("data-loaded")?(c=b.attr("data-original-id"),b.attr("id"),0==arguments.length&&(a=b.data("args")),"undefined"==typeof a&&(a={}),a.elem=b[0],d=panjs.createComponent(d,a,!1),d.container[0].compo=d,d.container[0].loaded=!0,d.container.attr("data-loaded","true"),d.container.attr("data-original-id",c),b[0].owner?b[0].owner._onSubComponentLoaded(d,b,a):panjs.capture("$.fn.load: createComponent without owner",
{componentId:d.id,classPath:d.classPath,from:null}),b.trigger(Tevent.LOADED,[d,a]),b.replaceWith(d.container),d._triggerOnAdded(),b.remove(),c=d):c=b[0].compo;return c};$.fn.isLoaded=function(){return"true"==$(this).attr("data-loaded")};$.fn.isCompo=function(){return null!=$(this).attr("data-compo")};$.fn.getCompo=function(){var a=null;$(this)[0].compo&&(a=$(this)[0].compo);return a};$.fn.getElement=function(a){a=$(this).find(a);return 0==a.length?null:$(a[0])};
$.fn.getElements=function(a){logger.warn("PANJS: $.fn.getElements is deprecated");a=$(a,this);var b=$([]);if(1==a.length)b.push(a);else for(var c=0;c<a.length;c++)b.push($(a[c]));return b};$.fn.swapWith=function(a){return this.each(function(){var b=$(a).clone(!0),c=$(this).clone(!0);$(a).replaceWith(c);$(this).replaceWith(b)})};function isNumberKey(a){var b=a.which;a=a.shiftKey;return 96<=b&&105>=b||48<=b&&57>=b&&!0==a}
...
(function(a){var b=getIEVersion();9>b&&0<b&&alert("Internet Explorer "+getIEVersion()+" is not supported");var b={appVersion:"1.0.0",logLevel:"DEBUG",env:"dev",version:"0.9.1",preserveElementsId:!1,setSourceInComponents:!1,stats:{active:!1},cache:{useLocalStorage:!1},errorComponentClass:"panjs.core.display.TerrorElement.html"},c;for(c in b)a[c]||(a[c]=b[c]);if(!a.appName)throw"Config ERROR: panjs.appName is missing";if(!RegExp("^[0-9a-zA-Z-_]*$","g").exec(a.appName))throw"invalid appName. format: "+
regAppName;a._sourceUrl="//# sourceURL=";b=getFirefoxVersion();0<b&&17>=b&&(a._sourceUrl="//@ sourceURL=");var d=[],e=0,f={};a.logger=null;a._classes={};a.root={id:"root",components:{}};a.loader=null;a.basePath=location.pathname.removeEnd(location.pathname.rightRightOf("/"));a.basePath=a.basePath.removeEnd("/");a.fullBasePath=location.protocol+"//"+location.host+location.pathname;a.messages={CLASSNAME_MATCHS_FILENAME:"The name of the class (%1) must match the file name (%2) (case sensitive)",LESS_IE8:"less is not fully compatible with IE%1 : transform less code in css",
LESS_NOT_LOADED:"LESS not loaded. Use panjs_core_with_less.min.js or load LESS (before panJs)",SCRIPT_ALREADY_LOADED:"loadScriptSync %1 : already loaded",LESS_INJECTED:"LESS: injection OK"};for(c in a.namespaces)a.namespaces[c].path=a.namespaces[c].path.replace("{version}",a.version),a.namespaces[c].name=c;window.less="undefined"!=typeof a.less?a.less:{env:"production",async:!0,fileAsync:!1,poll:1E3};a.initCaptures=function(){var b=a.stats.username,c=a.stats.password;$.ajax({url:a.stats.url+"/init",
async:!0,type:"post",async:!1,data:JSON.stringify({appName:a.appName}),username:b,password:c,success:function(a,b,c){logger.debug("initCaptures: success")},error:function(a,b,c){logger.error("initCaptures: failure: "+a.responseText)}})};a.capture=function(b,c){if(!1!=this.stats.active){var d=a.stats.url,e=a.stats.username,f=a.stats.password,l={message:b,classPath:c.classPath,componentId:null,fromClassName:null,fromClassPath:null,appName:a.appName,groupId:1,fromId:null,isStatic:null,timestamp:(new Date).getTime()};
null!=c.from&&(l.fromClassName=c.from.className,l.fromClassPath=c.from.classPath,null!=c.from.id&&(l.fromId=c.from.id));null!=c.componentId&&(l.componentId=c.componentId);"createStaticObject"==l.message&&(l.isStatic=!0);"createComponent"==l.message&&(l.isStatic=!1);$.ajax({url:d,async:!0,type:"post",data:JSON.stringify(l),username:e,password:f,success:function(a,b,c){logger.debug("Send stats: success")},error:function(a,b,c){logger.error("Send stats: failure: "+a.responseText)}})}};a._exec=function(a){""!=
a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))};a._setDOMId=function(b,c,d){c&&(d=b.getAttribute("data-preserve-id"),d=null==d?a.preserveElementsId:"true"==d,d||(d=b.nodeName.toLowerCase(),"undefined"==typeof f[d]?f[d]=1:f[d]++,b.setAttribute("id",d+f[d]),b.setAttribute("data-original-id",c)))};a.getClass=function(b){"undefined"==typeof a._classes[b]&&uses(b);return a._classes[b].Class};a.getInstance=function(b,c){return new (a.getClass(b))(c)};a.unload=function(b){"undefined"==
typeof a._classes[b]&&(b+=".html");"undefined"!=typeof a._classes[b]&&(a._classes[b]=void 0,delete a._classes[b])};a.createComponent=function(b,c,f){e++;var q=a._getClassNameFromClassPath(b),m=null;if("undefined"==typeof a._classes[b]&&(m=a.loader.usesComponent(b),null==m||!m.result))return c=m,"string"==typeof c&&(c={message:c,className:q}),c.stack=d,uses(a.errorComponentClass),object=new TerrorElement(c),d.push(c.message),e--,0>=e&&(d=[],e=0),object;"undefined"==typeof c&&(c={});if("undefined"!=
typeof c.elem&&(q=c.elem,m=c,"undefined"!=typeof q))for(var l=0;l<q.attributes.length;l++){var n=q.attributes.item(l),r=n.nodeName.toLowerCase(),n=n.value;r.startsWith("data-")&&(r=r.rightOf("data-"),r=a.getCamelCase(r));"true"==n?n=!0:"false"==n&&(n=!1);m[r]=n}if("undefined"!=typeof a.root.components[b]&&"undefined"!=c.reuse&&!0===c.reuse)return f=a.root.components[b],f.reuse(c),f;m=new a._classes[b].Class(c);e--;0>=e&&(d=[],e=0);m._onInitialized&&m._onInitialized();a.root.components[b]=m;!1!==f&&
(c={classPath:b,componentId:m.id,classPath:b,from:null},"object"==typeof f&&"undefined"!=typeof c.from&&(c.from=f.from),a.capture("createComponent",c));return m};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?a[c]:b+a[c].capitalizeFirstLetter();return b};a.loadScriptAsync=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};a.loadScriptSync=function(b){var c={result:null,errorMessage:""};if(this.loader.loadedJs[b.toLowerCase()])c.result=
!0,logger.debug(a.messages.SCRIPT_ALREADY_LOADED,b);else{var d=this.loader._loadFileSync(this.loader._getUrlWithVersion(b));c.result=d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.find("[data-compo]");for(var e=0;e<d.length;e++){var f=$(d[e]),l=f.attr("data-compo"),n="false"!==f.attr("data-autoload"),
r=f.attr("id");!0==n?f=f.load():(a._setDOMId(f[0],r,l),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY");2==arguments.length&&c()};a._getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||a.startsWith("file://")||a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};
...
logger.error("Unable to inherit from "+b+": class is not loaded"),null;f=panjs._classes[b]?panjs._classes[b].Class.extend(c,a,f):window[f].extend(c,a,f);panjs._classes[g]={Class:f,isComponent:e,lastId:0};f.prototype.classPath=g;f.prototype.className=a;d?(window[a]=new f,window[a].id=g):window[a]=f;e=g.split(".");f=window;for(h=0;h<e.length;h++){var p=e[h];h==e.length-1?f[p]=window[a]:"undefined"==typeof f[p]&&(f[p]={});f=f[p]}__CLASSPATH__=null;panjs._lastDefinedClassName=a;d&&(g={classPath:g,componentId:window[a].id,
...
a);logger.groupStart();c.path=panjs.getAbsoluteUrlFromClassPath(a);c.url=this._getUrlWithVersion(c.path);var d=this._loadFileSync(c.url);if(d.result){try{var e=getXmlDocument(d.data)}catch(f){return logger.error("XML error in class "+b+": "+f),c.isXmlError=!0,c.message=f,c}for(var g=e.getElementsByTagName("head")[0],e=e.getElementsByTagName("body")[0],h=[],p=[],q=c.path.substring(0,c.path.lastIndexOf("/")),m=0;m<g.childNodes.length;m++){var l=g.childNodes[m],n=l.nodeName.toLowerCase();"script"==n?
this.addScriptNode(l,q,b,a):"link"==n?h.push(l):"style"==n&&p.push(l)}if("undefined"==typeof panjs._classes[a])return c.message="Classe "+a+" not loaded",c;b=panjs._classes[a].Class;for(m=0;m<h.length;m++)this.addLinkNode(h[m],q);for(m=0;m<p.length;m++)logger.debug("Load style %1",a),this.addStyleNode(p[m]);defined(e)&&(g=getXml(e),h=b.prototype.parentClassName,defined(window[h].prototype.html)&&window[h].prototype.html.contains("\x3c!--CONTENT--\x3e")&&(g=window[h].prototype.html.replace("\x3c!--CONTENT--\x3e",
g)),g=g.replace(/<body>/gi,"").replace(/<\/body>/gi,""),b.prototype.html=g,b.prototype.bodyNode=e);panjs.setSourceInComponents&&(b.prototype.source=d.data);b.prototype.classPathDir=this.getClassPathDir(a);b.prototype.dirPath=q;b.lastId=0;logger.groupEnd();logger.debug("END USESCOMPONENT %1",a);c.result=!0;c.message="ok";c.Class=b}else a="Error loading "+a+": "+d.status,logger.warn(a),c.mess=a}else c.result=!0,c.mess="Already loaded",c.Class=panjs._classes[a].Class;return c},uses:function(a){var b=
...
panjs.loader=new Tloader;panjs.loader.init();panjs.stats.active&&panjs.initCaptures();__CLASSPATH__="panjs.core.events.Tevent";defineClass("Tevent","panjs.core.Tobject",{type:null,data:null,relatedData:null,bubbles:!1,cancelable:!1,currentTarget:null,cancelled:!1,defaultPrevented:!1,constructor:function(a,b,c,d){this.injectParam("type",a,!0);this.injectParam("data",b);this.injectParam("bubbles",c);this.injectParam("cancelable",d)},preventDefault:function(){this.defaultPrevented=!0}});
...
Tevent.SHOW="show";Tevent.SHOWN="shown";Tevent.HIDE="hide";Tevent.HIDDEN="hidden";Tevent.WAITING="waiting";uses("panjs.core.events.Tevent");__CLASSPATH__="panjs.core.events.TeventDispatcher";
...
($.contains(document.body,this.container[0])?this._onAdded():setTimeout(function(){$.contains(document.body,this.container[0])&&this._onAdded()}.bind(this),50))},append:function(a){var b=a,c=this.container;a.isCompo()&&(b=a.container,null!=this.content&&(c=this.content));c.append(b);a._onAdded&&a._onAdded()},appendTo:function(a){a.append(this.container);a.isCompo()&&a[0].owner._children.push(this);this._triggerOnAdded()},prependTo:function(a){this.container.prependTo(a);a.isCompo()&&this._children.push(a[0].owner)},
hide:function(a){defined(a,"hideFn")?a.hideFn(this.container):this.container.hide(a);this._realVisible=this.visible=!1;"undefined"!=typeof this._onHide&&this._onHide()},show:function(a){this._realVisible||(defined(a,"showFn")?a.showFn(this.container):this.container.show(a),this._realVisible=this.visible=!0,"undefined"!=typeof this._onShow&&this._onShow())},toggle:function(a){this.container.toggle(a);this.visible=!this._visible}});__CLASSPATH__="panjs.core.display.TdisplayObjectContainer";
...
0<=d.excludeFrom.indexOf(a)){b=!0;break}}return b},_onSubComponentLoaded:function(a,b,c){this._children.push(a);c=a.container.attr("data-original-id");panjs._setDOMId(a.container[0],c,a.classPath);this.bindEvents(b,a);c&&(this[c]=a);for(c=0;c<this._statesElements.length;c++){var d=this._statesElements[c];if(d.elem==b[0]){d.loaded=!0;d.elem=a.container[0];this.setStatesAttributes(b[0],d.elem);break}}panjs.capture("createComponent",{classPath:a.classPath,componentId:a.id,from:{id:this.id,className:this.className,
classPath:this.classPath}})},getChildren:function(){return this._children},findComponents:function(a){var b=$([]);this.container.find(0==arguments.length?"[data-compo]":'[data-compo*="'+a+'"]').each(function(a,d){d.isCompo()&&b.push(d.owner)});return b},setStatesAttributes:function(a,b){a.getAttribute("data-include-in")&&b.setAttribute("data-include-in",a.getAttribute("data-include-in"));a.getAttribute("data-include-logic")&&b.setAttribute("data-include-logic",a.getAttribute("data-include-logic"));
a.getAttribute("data-exclude-from")&&b.setAttribute("data-exclude-from",a.getAttribute("data-exclude-from"));a.getAttribute("data-exclude-logic")&&b.setAttribute("data-exclude-logic",a.getAttribute("data-exclude-logic"))},_setStateElementVisible:function(a,b,c){var d=!1;if(b.visible!=a){var d=!0,e=$(b.elem);a?b.isCompo?b.loaded?b.elem.compo.show(c):e.load().show(c):defined(c,"showFn")?c.showFn(e,b):(e.show(c),"none"!=b.display&&e.css("display",b.display)):b.isCompo?b.loaded?b.elem.compo.hide(c):defined(c,
"hideFn")?c.hideFn(e,b):e.hide(c):defined(c,"hideFn")?c.hideFn(e,b):e.hide(c);b.visible=a}return d},hasState:function(a){var b=!1;if("string"==typeof a)for(var c=0;c<this.currentState.length;c++){if(this.currentState[c]==a){b=!0;break}}else logger.error("hasState error: state is undefined");return b},toggleState:function(a,b,c){var d=!1;1==arguments.length?b=!this.hasState(a):2==arguments.length&&"boolean"!=typeof b&&(c=b,b=!this.hasState(a));return d=!1==b?this.removeState(a,c):this.addState(a,c)},
addState:function(a,b){var c=!1;if("string"==typeof a){for(var d=[],e=!1,f=0;f<this.currentState.length;f++)this.currentState[f]==a?e=!0:d.push(this.currentState[f]);e||(c=!0,d.push(a),this.setState(d,b))}else logger.error("addState error: state is undefined");return c},removeState:function(a,b){var c=!1;if("string"==typeof a){for(var d=[],e=0;e<this.currentState.length;e++)this.currentState[e]!=a?d.push(this.currentState[e]):c=!0;c&&this.setState(d,b)}else logger.error("removeState error: state is undefined");
return c},setState:function(a,b){var c={},d={},e=!1;if("string"==typeof a){var f=[a];c[a]=1}else for(var f=a,g=0;g<f.length;g++)void 0!=f[g]?c[f[g]]=1:logger.error("setState error: state is undefined");f=this.currentState;for(g=0;g<this.currentState.length;g++)this.container.removeClass(this.currentState[g]),d[this.currentState[g]]=1;this.currentState=[];for(var h=0;h<this._statesElements.length;h++){var p=this._statesElements[h],q=!0,m=!0;if(null!=p.includeIn)for(m=null,q=!0,g=0;g<p.includeIn.length;g++){var l=
p.includeIn[g],l="undefined"!=typeof c[l];if("OR"==p.includeLogic){if(q=l)break}else q=q&&l}else if(null!=p.excludeFrom)for(m=!1,q=null,g=0;g<p.excludeFrom.length;g++)if(l=p.excludeFrom[g],l="undefined"!=typeof c[l],"OR"==p.excludeLogic){if(m=l)break}else m=m&&l;if(null!=q||null!=m)e=this._setStateElementVisible(!0==q||!1==m,p,b)||e}this.currentState=[];for(var n in c)this.currentState.push(n),this.container.addClass(n);if(e){logger.isLevelEnabled(Tlogger.TRACE)&&logger.trace(this.id+".currentState = "+
JSON.stringify(this.currentState));g=[];for(n in c)"undefined"==typeof d[n]&&g.push(n);h=[];for(n in d)"undefined"==typeof c[n]&&h.push(n);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:f,newStates:this.currentState,removedStates:h,addedStates:g}))}return e},processElement:function(a,b){var c=a[0];1==arguments.length&&(b={});c=this._processElement(c,a.parent()[0],!0);b&&!0==b.processStates&&this.setState(this.currentState);return c},_processElement:function(a,b,c,d){if(1==a.nodeType){var e=
a.getAttribute("id"),f=a.getAttribute("data-compo"),g=$(a),h=null;null==f?(c&&null!=e&&(defined(this[e])&&logger.error('1-Duplication du id "'+e+'" sur objet '+this.className),this[panjs.getCamelCase(e)]=g,panjs._setDOMId(a,e,f)),this.bindEvents(g),this.processStates(a),this._populateElements(a,c)):f==this.classPath?logger.error("R\u00e9f\u00e9rence circulaire dans "+this.classPath):(4>arguments.length&&(d="false"!==a.getAttribute("data-autoload")),d?(h=this.createComponent(f,{elem:a,parent:this}),
h.parent=this,c&&null!=e&&(defined(this[e])&&logger.error('2-Duplication du id "'+e+'" sur objet '+this.className),this[e]=h,panjs._setDOMId(h.container[0],e,f)),this.bindEvents(g,h),g.replaceWith(h.container),h.container.attr("data-loaded","true"),a.setAttribute("data-loaded","true"),h.container[0].loaded=!0,h.container[0].compo=h,this.setStatesAttributes(a,h.container[0]),this.processStates(h.container[0]),h._triggerOnAdded()):(panjs._setDOMId(a,e,f),g[0].compo=null,g[0].owner=this,this[e]=g,this.processStates(a)))}else 8==
