...
d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.find("[data-compo]");for(var e=0;e<d.length;e++){var f=$(d[e]),l=f.attr("data-compo"),n="false"!==f.attr("data-autoload"),r=f.attr("id");!0==n?f=f.load():(a._setDOMId(f[0],r,l),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY. Panjs version: "+
a.version);2==arguments.length&&c()};a._getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||a.startsWith("file://")||a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};a.getAbsoluteUrlFromClassPath=function(b){var c=b.endsWith(".html"),d="";if(b.startsWith("http://")||
b.startsWith("file://")||"/"==b[0])d=c?b:b+".js";else if(b.removeEnd(".html").contains(".")){var e=a.getNSFromClassPath(b);e&&(d=e.path+"/"+b.rightOf(e.name+".").removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js")}else d=a.basePath+"/"+b,c||(d+=".js");""==d&&(d=b.removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js");return d}})(panjs=panjs||{});
...
Tevent.SHOW="show";Tevent.SHOWN="shown";Tevent.HIDE="hide";Tevent.HIDDEN="hidden";Tevent.WAITING="waiting";Tevent.BEFORE_DESTROY="BEFORE_DESTROY";Tevent.DESTROY="DESTROY";uses("panjs.core.events.Tevent");__CLASSPATH__="panjs.core.events.TeventDispatcher";
...
b){var c={},d={},e=!1;if("string"==typeof a){var f=[a];c[a]=1}else for(var f=a,g=0;g<f.length;g++)void 0!=f[g]?c[f[g]]=1:logger.error("setState error: state is undefined");f=this.currentState;for(g=0;g<this.currentState.length;g++)this.container.removeClass(this.currentState[g]),d[this.currentState[g]]=1;this.currentState=[];for(var h=0;h<this._statesElements.length;h++){var p=this._statesElements[h],q=!0,m=!0;if(null!=p.includeIn)for(m=null,q=!0,g=0;g<p.includeIn.length;g++){var l=p.includeIn[g],
