...
!0;d.visible&&d.show();b.setAttribute("id",b.owner.id+"_"+c);b=new Tevent(Tevent.LOADED,d);this.dispatchEvent(b);return d}},hide:function(){},show:function(){this.load(this.args)}});
