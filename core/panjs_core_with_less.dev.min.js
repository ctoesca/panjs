...
LESS_NOT_LOADED:"LESS not loaded. Use panjs_core_with_less.min.js or load LESS (before panJs)",SCRIPT_ALREADY_LOADED:"loadScriptSync %1 : already loaded",LESS_INJECTED:"LESS: injection OK"};for(c in a.namespaces)a.namespaces[c].path=a.namespaces[c].path.replace("{version}",a.version),a.namespaces[c].name=c;window.less="undefined"!=typeof a.less?a.less:{env:"production",async:!0,fileAsync:!1,poll:1E3};a._exec=function(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))};
a._setDOMId=function(b,c,d){d=c;var e=b.getAttribute("data-preserve-id"),e=null==e?a.preserveElementsId:"true"==e;e||("undefined"==typeof f[c]?f[c]=0:(f[c]++,d=c+f[c]));b.setAttribute("id",d);b.setAttribute("data-original-id",c)};a.getClass=function(b){"undefined"==typeof a._classes[b]&&uses(b);return a._classes[b].Class};a.getInstance=function(b,c){return new (a.getClass(b))(c)};a.unload=function(b){"undefined"==typeof a._classes[b]&&(b+=".html");"undefined"!=typeof a._classes[b]&&(a._classes[b]=
void 0,delete a._classes[b])};a.createComponent=function(b,c){e++;var f=a._getClassNameFromClassPath(b),m=null;if("undefined"==typeof a._classes[b]&&(m=a.loader.usesComponent(b),null==m||!m.result))return"string"==typeof m&&(m={message:m,className:f}),m.stack=d,uses(a.errorComponentClass),object=new TerrorElement(m),d.push(m.message),e--,0>=e&&(d=[],e=0),object;"undefined"==typeof c&&(c={});if("undefined"!=typeof c.elem&&(f=c.elem,m=c,"undefined"!=typeof f))for(var n=0;n<f.attributes.length;n++){var l=
f.attributes.item(n),p=l.nodeName.toLowerCase(),l=l.value;p.startsWith("data-")&&(p=p.rightOf("data-"),p=a.getCamelCase(p));"true"==l?l=!0:"false"==l&&(l=!1);m[p]=l}if("undefined"!=typeof a.root.components[b]&&"undefined"!=c.reuse&&!0===c.reuse)return f=a.root.components[b],f.reuse(c),f;m=new a._classes[b].Class(c);e--;0>=e&&(d=[],e=0);m._onInitialized&&m._onInitialized();return a.root.components[b]=m};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<
a.length;c++)b=0==c?a[c]:b+a[c].capitalizeFirstLetter();return b};a.loadScriptAsync=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};a.loadScriptSync=function(b){var c={result:null,errorMessage:""};if(this.loader.loadedJs[b.toLowerCase()])c.result=!0,logger.debug(a.messages.SCRIPT_ALREADY_LOADED,b);else{var d=this.loader._loadFileSync(this.loader._getUrlWithVersion(b));c.result=d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),
this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.getElements("[data-compo]");for(var e=0;e<d.length;e++){var f=d[e],l=f.attr("data-compo"),p="false"!==f.attr("data-autoload"),r=f.attr("id");!0==p?f=f.load():(a._setDOMId(f[0],r,l),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY");2==arguments.length&&c()};a._getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||
a.startsWith("file://")||a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};a.getAbsoluteUrlFromClassPath=function(b){var c=b.endsWith(".html"),d="";if(b.startsWith("http://")||b.startsWith("file://")||"/"==b[0])d=c?b:b+".js";else if(b.removeEnd(".html").contains(".")){var e=a.getNSFromClassPath(b);
e&&(d=e.path+"/"+b.rightOf(e.name+".").removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js")}else d=a.basePath+"/"+b,c||(d+=".js");""==d&&(d=b.removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js");return d}})(panjs=panjs||{});
...
logger.error("Unable to inherit from "+b+": class is not loaded"),null;f=panjs._classes[b]?panjs._classes[b].Class.extend(c,a,f):window[f].extend(c,a,f);panjs._classes[g]={Class:f,isComponent:e};f.prototype.classPath=g;f.prototype.className=a;window[a]=d?new f:f;e=g.split(".");g=window;for(f=0;f<e.length;f++)h=e[f],f==e.length-1?g[h]=window[a]:"undefined"==typeof g[h]&&(g[h]={}),g=g[h];__CLASSPATH__=null;panjs._lastDefinedClassName=a}
...
{result:!1,exception:"",status:"erreur inconnue"};logger.debug("Loadfile SYNC %1",a);jQuery.support.cors=!0;var g=jQuery.ajax({url:a,method:"GET",cache:!0,async:!1,dataType:"html",processData:!1,context:this,beforeSend:function(a){},success:function(e,g,h){f={result:!0,data:e};if(b){for(var l in localStorage)l.startsWith(c)&&!l.startsWith(c+"."+panjs.appVersion)&&(logger.debug("Removing old version from locaStorage: %1",l),localStorage.removeItem(l));try{localStorage.setItem(d,e)}catch(p){logger.debug(p+
...
a);logger.groupStart();c.path=panjs.getAbsoluteUrlFromClassPath(a);c.url=this._getUrlWithVersion(c.path);var d=this._loadFileSync(c.url);if(d.result){try{var e=getXmlDocument(d.data)}catch(f){return logger.error("XML error in class "+b+": "+f),c.isXmlError=!0,c.message=f,c}for(var g=e.getElementsByTagName("head")[0],e=e.getElementsByTagName("body")[0],h=[],q=[],m=c.path.substring(0,c.path.lastIndexOf("/")),n=0;n<g.childNodes.length;n++){var l=g.childNodes[n],p=l.nodeName.toLowerCase();"script"==p?
this.addScriptNode(l,m,b,a):"link"==p?h.push(l):"style"==p&&q.push(l)}if("undefined"==typeof panjs._classes[a])return c.message="Classe "+a+" not loaded",c;b=panjs._classes[a].Class;for(n=0;n<h.length;n++)this.addLinkNode(h[n],m);for(n=0;n<q.length;n++)logger.debug("Load style %1",a),this.addStyleNode(q[n]);defined(e)&&(g=getXml(e),h=b.prototype.parentClassName,defined(window[h].prototype.html)&&window[h].prototype.html.contains("\x3c!--CONTENT--\x3e")&&(g=window[h].prototype.html.replace("\x3c!--CONTENT--\x3e",
g)),g=g.replace(/<body>/gi,"").replace(/<\/body>/gi,""),b.prototype.html=g,b.prototype.bodyNode=e);panjs.setSourceInComponents&&(b.prototype.source=d.data);b.prototype.classPathDir=this.getClassPathDir(a);b.prototype.dirPath=m;b.lastId=0;logger.groupEnd();logger.debug("END USESCOMPONENT %1",a);c.result=!0;c.message="ok";c.Class=b}else a="Error loading "+a+": "+d.status,logger.warn(a),c.mess=a}else c.result=!0,c.mess="Already loaded",c.Class=panjs._classes[a].Class;return c},uses:function(a){var b=
panjs._getClassNameFromClassPath(a),c={result:!1,message:"",className:b,classPath:a,url:null,path:null,Class:null};if("undefined"==typeof panjs._classes[a]){logger.debug("USES %1",a);logger.groupStart();c.path=panjs.getAbsoluteUrlFromClassPath(a);var d=c.path.substring(0,c.path.lastIndexOf("/"));c.url=this._getUrlWithVersion(c.path);var e=this._loadFileSync(c.url);if(e.result){e.data=this._processCode(e.data,b,d,a,".js");panjs._exec(e.data);if("undefined"==typeof panjs._classes[a])return c.message=
"Classe "+a+" not loaded",c;e=panjs._classes[a].Class;e.prototype.classPathDir=this.getClassPathDir(a);e.prototype.dirPath=d;e.lastId=0;c.result=!0;c.message="ok";c.Class=e}else throw a+" not loaded: "+e.status;logger.groupEnd();logger.debug("END USES %1",a)}else c.result=!0,c.message="Already loaded",c.Class=e;return c},_transformUrl:function(a,b){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"file://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=b+"/"+a);return a},addLinkNode:function(a,b){var c=
...
d[this.currentState[g]]=1;this.currentState=[];for(var h=0;h<this._statesElements.length;h++){var q=this._statesElements[h],m=!0,n=!0;if(null!=q.includeIn)for(n=null,m=!0,g=0;g<q.includeIn.length;g++){var l=q.includeIn[g],l="undefined"!=typeof c[l];if("OR"==q.includeLogic){if(m=l)break}else m=m&&l}else if(null!=q.excludeFrom)for(n=!1,m=null,g=0;g<q.excludeFrom.length;g++)if(l=q.excludeFrom[g],l="undefined"!=typeof c[l],"OR"==q.excludeLogic){if(n=l)break}else n=n&&l;if(null!=m||null!=n)e=this._setStateElementVisible(!0==
m||!1==n,q,b)||e}this.currentState=[];for(var p in c)this.currentState.push(p),this.container.addClass(p);if(e){logger.isLevelEnabled(Tlogger.TRACE)&&logger.trace(this.id+".currentState = "+JSON.stringify(this.currentState));g=[];for(p in c)"undefined"==typeof d[p]&&g.push(p);h=[];for(p in d)"undefined"==typeof c[p]&&h.push(p);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:f,newStates:this.currentState,removedStates:h,addedStates:g}))}return e},processElement:function(a,b){var c=a[0];
