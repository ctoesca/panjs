...
this.addScriptNode(l,q,b,a):"link"==n?h.push(l):"style"==n&&p.push(l)}if("undefined"==typeof panjs._classes[a])return c.message="Classe "+a+" not loaded",c;b=panjs._classes[a].Class;for(m=0;m<h.length;m++)this.addLinkNode(h[m],q);for(m=0;m<p.length;m++)logger.debug("Load style %1",a),this.addStyleNode(p[m]);g=b.prototype.parentClassName;defined(e)?(h=getXml(e),defined(window[g].prototype.html)&&window[g].prototype.html.contains("\x3c!--CONTENT--\x3e")&&(h=window[g].prototype.html.replace("\x3c!--CONTENT--\x3e",
h)),h=h.replace(/<body>/gi,"").replace(/<\/body>/gi,""),b.prototype.html=h,b.prototype.bodyNode=e):defined(window[g].prototype.html)&&(h=window[g].prototype.html,b.prototype.html=h,b.prototype.bodyNode=e);panjs.setSourceInComponents&&(b.prototype.source=d.data);b.prototype.classPathDir=this.getClassPathDir(a);b.prototype.dirPath=q;b.lastId=0;logger.groupEnd();logger.debug("END USESCOMPONENT %1",a);c.result=!0;c.message="ok";c.Class=b}else a="Error loading "+a+": "+d.status,logger.warn(a),c.mess=a}else c.result=
...
c,b,d,".js"):g.data+("\n"+panjs._sourceUrl+f+".js");panjs._exec(g.data);this.loadedJs[a.toLowerCase()]=1}return!0}});panjs.loader=new Tloader;panjs.loader.init();panjs.stats.active&&panjs.initCaptures();logger.info("READY. Panjs version: "+panjs.version);__CLASSPATH__="panjs.core.events.Tevent";
...
g=[];for(n in c)"undefined"==typeof d[n]&&g.push(n);h=[];for(n in d)"undefined"==typeof c[n]&&h.push(n);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:f,newStates:this.currentState,removedStates:h,addedStates:g}))}return e},processElement:function(a,b){var c=a[0];1==arguments.length&&(b={});c=this._processElement(c,a.parent()[0],!0);b&&!0==b.processStates&&this.setState(this.currentState);null==c&&(c=a);return c},_processElement:function(a,b,c,d){if(!a.owner){if(1==a.nodeType){var e=
