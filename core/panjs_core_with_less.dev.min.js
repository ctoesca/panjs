...
f=f.getElementsByTagName("body")[0],l=[],p=[],n=d.substring(0,d.lastIndexOf("/")),m=0;m<h.childNodes.length;m++){var q=h.childNodes[m],r=q.nodeName.toLowerCase();"script"==r?this.addScriptNode(q,n,b):"link"==r?l.push(q):"style"==r&&p.push(q)}if("undefined"==typeof window[b])return e=a+" class has not been loaded. ",panjs.lastDefinedClassName!=b&&(e+="\n"+panjs.getMessage(panjs.messages.CLASSNAME_MATCHS_FILENAME,panjs.lastDefinedClassName,d)),logger.error(e),{result:!1,message:e,className:b,classPath:a,
...
a.trim()&&("undefined"==typeof b&&(b="text/css"),$('<style type="'+b+'">'+a+"</style>").appendTo("head"),"text/less"==b&&(this.lessIsLoaded()?(less.refresh(),logger.debug("INJECTION LESS OK")):logger.warn(panjs.getMessage(panjs.messages.LESS_NOT_LOADED))))},addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");a=getText(a);this.addStyle(a,b)},processCode:function(a,b){return a.replace(/this._super/g,b+"._super")},addScriptNode:function(a,b,c){var d=a.getAttribute("subtype"),
e=a.getAttribute("src");null==e?(a=getText(a),null!=c&&"text/x-class-definition"==d&&(a=this.processCode(a,c)),panjs.exec(a)):(a=panjs.transformUrl(e,b),this.loadedJs[a.toLowerCase()]?logger.debug("Le script "+a+" est d\u00e9j\u00e0 charg\u00e9"):(b=this.loadFile(this.getUrlWithVersion(a)),null!=c&&"text/x-class-definition"==d&&(b.data=this.processCode(b.data,c)),panjs.exec(b.data),this.loadedJs[a.toLowerCase()]=1));return!0}});panjs.loader=new Tloader;
