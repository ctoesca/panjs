...
b.nodeName.toLowerCase(),"undefined"==typeof e[d]?e[d]=1:e[d]++,b.setAttribute("id",d+e[d]),b.setAttribute("data-original-id",c)),a.addIdClass&&(b.className+=" "+c))};a.getClass=function(b){"undefined"==typeof a._classes[b]&&uses(b);return a._classes[b].Class};a.getInstance=function(b,c){return new (a.getClass(b))(c)};a.unload=function(b){"undefined"==typeof a._classes[b]&&(b+=".html");"undefined"!=typeof a._classes[b]&&(a._classes[b]=void 0,delete a._classes[b])};a.createComponent=function(b,e,f){d++;
var q=a._getClassNameFromClassPath(b),m=null;if("undefined"==typeof a._classes[b]&&(m=a.loader.usesComponent(b),null==m||!m.result))return e=m,"string"==typeof e&&(e={message:e,className:q}),e.stack=c,uses(a.errorComponentClass),object=new TerrorElement(e),c.push(e.message),d--,0>=d&&(c=[],d=0),object;"undefined"==typeof e&&(e={});if("undefined"!=typeof e.elem&&(q=e.elem,m=e,"undefined"!=typeof q))for(var l=0;l<q.attributes.length;l++){var n=q.attributes.item(l),r=n.nodeName.toLowerCase(),n=n.value;
r.startsWith("data-")&&(r=r.rightOf("data-"),r=a.getCamelCase(r));"true"==n?n=!0:"false"==n&&(n=!1);m[r]=n}if("undefined"!=typeof a.root.components[b]&&"undefined"!=e.reuse&&!0===e.reuse)return f=a.root.components[b],f.reuse(e),f;m=new a._classes[b].Class(e);d--;0>=d&&(c=[],d=0);m._onInitialized&&m._onInitialized();a.root.components[b]=m;!1!==f&&(e={classPath:b,componentId:m.id,classPath:b,from:null},"object"==typeof f&&"undefined"!=typeof e.from&&(e.from=f.from),a.capture("createComponent",e));return m};
a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?a[c]:b+a[c].capitalizeFirstLetter();return b};a.loadScriptAsync=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};a.loadScriptSync=function(b){var c={result:null,errorMessage:""};if(this.loader.loadedJs[b.toLowerCase()])c.result=!0,logger.debug(a.messages.SCRIPT_ALREADY_LOADED,b);else{var d=this.loader._loadFileSync(this.loader._getUrlWithVersion(b));c.result=
d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.find("[data-compo]");for(var e=0;e<d.length;e++){var f=$(d[e]),l=f.attr("data-compo"),n="false"!==f.attr("data-autoload"),r=f.attr("id");!0==n?f=f.load():(a._setDOMId(f[0],r,l),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY");
2==arguments.length&&c()};a._getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||a.startsWith("file://")||a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};a.getAbsoluteUrlFromClassPath=function(b){var c=b.endsWith(".html"),d="";if(b.startsWith("http://")||b.startsWith("file://")||
"/"==b[0])d=c?b:b+".js";else if(b.removeEnd(".html").contains(".")){var e=a.getNSFromClassPath(b);e&&(d=e.path+"/"+b.rightOf(e.name+".").removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js")}else d=a.basePath+"/"+b,c||(d+=".js");""==d&&(d=b.removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js");return d}})(panjs=panjs||{});
