...
return c},setState:function(a,b){var c={},d={},e=!1;if("string"==typeof a){var f=[a];c[a]=1}else for(var f=a,g=0;g<f.length;g++)void 0!=f[g]?c[f[g]]=1:logger.error("setState error: state is undefined");f=this.currentState;for(g=0;g<this.currentState.length;g++)this.container.removeClass(this.currentState[g]),d[this.currentState[g]]=1;this.currentState=[];for(var h=0;h<this._statesElements.length;h++){var n=this._statesElements[h],q=!0,l=!0;if(null!=n.includeIn)for(l=null,q=!0,g=0;g<n.includeIn.length;g++){var m=
n.includeIn[g],m="undefined"!=typeof c[m];if("OR"==n.includeLogic){if(q=m)break}else q=q&&m}else if(null!=n.excludeFrom)for(l=!1,q=null,g=0;g<n.excludeFrom.length;g++)if(m=n.excludeFrom[g],m="undefined"!=typeof c[m],"OR"==n.excludeLogic){if(l=m)break}else l=l&&m;if(null!=q||null!=l)e=this._setStateElementVisible(!0==q||!1==l,n,b)||e}this.currentState=[];for(var p in c)this.currentState.push(p),this.container.addClass(p);if(e){logger.isLevelEnabled(Tlogger.TRACE)&&logger.trace(this.id+".currentState = "+
JSON.stringify(this.currentState));g=[];for(p in c)"undefined"==typeof d[p]&&g.push(p);h=[];for(p in d)"undefined"==typeof c[p]&&h.push(p);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:f,newStates:this.currentState,removedStates:h,addedStates:g}))}return e},processElement:function(a,b){var c=a[0];1==arguments.length&&(b={});c=this._processElement(c,a.parent()[0],!0);b&&!0==b.processStates&&this.setState(this.currentState);return c},_processElement:function(a,b,c,d){if(1==a.nodeType){var e=
