...
addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");a=getText(a);this.addStyle(a,b)},processCode:function(a,b){return a.replace(/this._super/g,b+"._super")},addScriptNode:function(a,b,c){var d=a.getAttribute("subtype"),e=a.getAttribute("src");null==e?(a=getText(a),null!=c&&"text/x-class-definition"==d&&(a=this.processCode(a,c)),panjs.exec(a)):(a=panjs.transformUrl(e,b),this.loadedJs[a.toLowerCase()]?logger.debug("Le script "+a+" est d\u00e9j\u00e0 charg\u00e9"):(b=this.loadFile(this.getUrlWithVersion(a)),
null!=c&&"text/x-class-definition"==d&&(b.data=this.processCode(b.data,c)),panjs.exec(b.data),this.loadedJs[a.toLowerCase()]=1));return!0}});panjs.loader=new Tloader;defineClass("Tevent","core.Tobject",{type:null,data:null,bubbles:!1,cancelable:!1,currentTarget:null,cancelled:!1,defaultPrevented:!1,constructor:function(a,b,c,d){this.injectParam("type",a,!0);this.injectParam("data",b);this.injectParam("bubbles",c);this.injectParam("cancelable",d)},preventDefault:function(){this.defaultPrevented=!0}});
