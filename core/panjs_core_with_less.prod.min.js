...
function randomBetween(a,b){return Math.floor(Math.random()*b)+a}function generateUUID(){var a=(new Date).getTime();return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(b){var c=(a+16*Math.random())%16|0;a=Math.floor(a/16);return("x"==b?c:c&7|8).toString(16)})}
...
$.fn.load=function(a){var b=$(this),c=null,d=b.attr("data-compo");if(null==d)logger.warn("This element is not a panjs component");else if("true"!=b.attr("data-loaded")){var c=b.attr("data-original-id"),e=b.attr("id");0==arguments.length&&(a=b.data("args"));"undefined"==typeof a&&(a={});a.elem=b[0];d=panjs.createComponent(d,a);d.container[0].compo=d;d.container[0].loaded=!0;d.container.attr("data-loaded","true");d.container.attr("data-original-id",c);d.id=e;b[0].owner&&b[0].owner._onSubComponentLoaded(d,
b,a);b.trigger(Tevent.LOADED,[d,a]);b.replaceWith(d.container);d._triggerOnAdded();b.remove();c=d}else c=b[0].compo;return c};$.fn.isLoaded=function(){return"true"==$(this).attr("data-loaded")};$.fn.isCompo=function(){return null!=$(this).attr("data-compo")};$.fn.getCompo=function(){var a=null;$(this)[0].compo&&(a=$(this)[0].compo);return a};$.fn.getElement=function(a){a=$(a,this);if(0==a.length)return null;if(1==a.length)return a;if(1<a.length)return $(a[0])};
$.fn.getElements=function(a){a=$(a,this);var b=$([]);if(1==a.length)b.push(a);else for(var c=0;c<a.length;c++)b.push($(a[c]));return b};$.fn.swapWith=function(a){return this.each(function(){var b=$(a).clone(!0),c=$(this).clone(!0);$(a).replaceWith(c);$(this).replaceWith(b)})};function isNumberKey(a){var b=a.which;a=a.shiftKey;return 96<=b&&105>=b||48<=b&&57>=b&&!0==a}
function isControlKey(a){var b=a.which;return 8==b||13==b||46==b||35==b||36==b||37==b||39==b||9==b||a.ctrlKey&&67||a.ctrlKey&&86||a.ctrlKey&&88}
(function(a){var b=getIEVersion();9>b&&0<b&&alert("Internet Explorer "+getIEVersion()+" is not supported");var b={appVersion:"1.0.0",logLevel:"DEBUG",env:"dev",version:"0.8.3",preserveElementsId:!1,setSourceInComponents:!1,cache:{useLocalStorage:!1},errorComponentClass:"panjs.core.display.TerrorElement.html"},c;for(c in b)a[c]||(a[c]=b[c]);if(!a.appName)throw"Config ERROR: panjs.appName is missing";if(!RegExp("^[0-9a-zA-Z-_]*$","g").exec(a.appName))throw"invalid appName. format: "+regAppName;a._sourceUrl=
"//# sourceURL=";b=getFirefoxVersion();0<b&&17>=b&&(a._sourceUrl="//@ sourceURL=");var d=[],e=0,f={};a.logger=null;a._classes={};a.root={id:"root",components:{}};a.loader=null;a.basePath=location.pathname.removeEnd(location.pathname.rightRightOf("/"));a.basePath=a.basePath.removeEnd("/");a.fullBasePath=location.protocol+"//"+location.host+location.pathname;a.messages={CLASSNAME_MATCHS_FILENAME:"The name of the class (%1) must match the file name (%2) (case sensitive)",LESS_IE8:"less is not fully compatible with IE%1 : transform less code in css",
LESS_NOT_LOADED:"LESS not loaded. Use panjs_core_with_less.min.js or load LESS (before panJs)",SCRIPT_ALREADY_LOADED:"loadScriptSync %1 : already loaded",LESS_INJECTED:"LESS: injection OK"};for(c in a.namespaces)a.namespaces[c].path=a.namespaces[c].path.replace("{version}",a.version),a.namespaces[c].name=c;window.less="undefined"!=typeof a.less?a.less:{env:"production",async:!0,fileAsync:!1,poll:1E3};var g=function(b,c,f){"string"==typeof f&&(f={message:f,className:c});f.stack=d;uses(a.errorComponentClass);
object=new TerrorElement(f);d.push(f.message);e--;0>=e&&(d=[],e=0);return object};a._exec=function(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))};a._setDOMId=function(b,c,d){d=c;var e=b.getAttribute("data-preserve-id"),e=null==e?a.preserveElementsId:"true"==e;e||("undefined"==typeof f[c]?f[c]=0:(f[c]++,d=c+f[c]));b.setAttribute("id",d);b.setAttribute("data-original-id",c)};a.getClass=function(b){"undefined"==typeof a._classes[b]&&uses(b);return a._classes[b].Class};
a.getInstance=function(b,c){return new (a.getClass(b))(c)};a.unload=function(b){"undefined"==typeof a._classes[b]&&(b+=".html");"undefined"!=typeof a._classes[b]&&(a._classes[b]=void 0,delete a._classes[b])};a.createComponent=function(b,c){e++;var f=a._getClassNameFromClassPath(b),h=null;if("undefined"==typeof a._classes[b])try{var m=a.loader.usesComponent(b);if(!m.result)return g(b,f,m)}catch(q){return g(b,f,q)}try{"undefined"==typeof c&&(c={});if("undefined"!=typeof c.elem){var r=c.elem,m=c;if("undefined"!=
typeof r)for(var s=0;s<r.attributes.length;s++){var t=r.attributes.item(s),u=t.nodeName.toLowerCase(),w=t.value;if(u.startsWith("data-"))var x=u,x=x.rightOf("data-"),u=a.getCamelCase(x);"true"==w?w=!0:"false"==w&&(w=!1);m[u]=w}}if("undefined"!=typeof a.root.components[b]&&"undefined"!=c.reuse&&!0===c.reuse){var y=a.root.components[b];y.reuse(c);return y}h=new a._classes[b].Class(c)}catch(z){r="Error instantiating "+f+": "+z,logger.error(r),h=a.getAbsoluteUrlFromClassPath(b),t=a.loader._getUrlWithVersion(h),
h=g(b,f,{message:r,path:h,url:t,className:f}),d.push(r)}e--;0>=e&&(d=[],e=0);h._onInitialized&&h._onInitialized();return a.root.components[b]=h};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?a[c]:b+a[c].capitalizeFirstLetter();return b};a.loadScriptAsync=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};a.loadScriptSync=function(b){var c={result:null,errorMessage:""};if(this.loader.loadedJs[b.toLowerCase()])c.result=
!0,logger.debug(a.messages.SCRIPT_ALREADY_LOADED,b);else{var d=this.loader._loadFileSync(this.loader._getUrlWithVersion(b));c.result=d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.getElements("[data-compo]");for(var e=0;e<d.length;e++){var f=d[e],g=f.attr("data-compo"),r="false"!==f.attr("data-autoload"),
s=f.attr("id");!0==r?f=f.load():(a._setDOMId(f[0],s,g),f[0].compo=null,f[0].owner=null);a.root[s]=f}logger.info("READY");2==arguments.length&&c()};a._getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||a.startsWith("file://")||a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};
a.getAbsoluteUrlFromClassPath=function(b){var c=b.endsWith(".html"),d="";if(b.startsWith("http://")||b.startsWith("file://")||"/"==b[0])d=c?b:b+".js";else if(b.removeEnd(".html").contains(".")){var e=a.getNSFromClassPath(b);e&&(d=e.path+"/"+b.rightOf(e.name+".").removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js")}else d=a.basePath+"/"+b,c||(d+=".js");""==d&&(d=b.removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js");return d}})(panjs=panjs||{});
...
l=new Function('var key = "__'+f+'"; return this[key]');e[f]={get:l,set:g}}else e[f]={value:a[f],writable:!0,configurable:!0,enumerable:!0};a=Object.create(d,e);b=a.constructor;if(!(b instanceof Function))throw Error("You must define a method 'constructor'");b.prototype=a;b.prototype.parentClassName=c;b._super=d;b.extend=this.extend;return b},__OnPropChanged:function(a,b,c,d){},injectParam:function(a,b,c,d){if("undefined"==typeof b||null==b){if("undefined"!=typeof d)return this[a]=d,!0;if("undefined"!=
...
function defineClass(a,b,c,d){4>arguments.length&&(d=!1);var e=b.endsWith(".html"),f=panjs._getClassNameFromClassPath(b),g=null,g="undefined"!=typeof __CLASSPATH__&&null!=__CLASSPATH__?__CLASSPATH__:a,l=g.removeEnd(".html");l.contains(".")&&(l=l.rightRightOf("."));if(g!=a&&l!=a)throw logger.parse(panjs.messages.CLASSNAME_MATCHS_FILENAME,a,l);if("undefined"==typeof window[f]&&"undefined"==typeof window[b]&&(e?panjs.loader.usesComponent(b):panjs.loader.uses(b),"undefined"==typeof window[f]))return logger&&
logger.error("Unable to inherit from "+b+": class is not loaded"),null;try{var n=panjs._classes[b]?panjs._classes[b].Class.extend(c,a,f):window[f].extend(c,a,f);panjs._classes[g]={Class:n,isComponent:e};n.prototype.classPath=g;n.prototype.className=a;window[a]=d?new n:n;for(var p=g.split("."),e=window,f=0;f<p.length;f++){var h=p[f];f==p.length-1?e[h]=window[a]:"undefined"==typeof e[h]&&(e[h]={});e=e[h]}}catch(m){alert(a+" "+m)}__CLASSPATH__=null;panjs._lastDefinedClassName=a}
...
_trace:function(){var a=this._getMessage("TRACE",arguments);console.trace?console.trace(a):console.log(a)},_debug:function(){var a=this._getMessage("DEBUG",arguments);console.debug?console.debug(a):console.log(a)},_info:function(){var a=this._getMessage("INFO",arguments);console.info?console.info(a):console.log(a)},_warn:function(){var a=this._getMessage("WARN",arguments);console.warn?console.warn(a):console.log(a)},_error:function(){console.error(this._getMessage("ERROR",arguments))},parse:function(){if("string"==
typeof arguments[0])for(var a=arguments[0],b=1;b<arguments.length;b++){var c=arguments[b];null==c&&(c="null");a=a.replace("%"+b,c)}else for(a="",b=0;b<arguments.length;b++)a+=JSON.stringify(arguments[b])+"\n";return a},_getMessage:function(a,b){var c=this.parse.apply(this,b);return this._getTime()+"ms("+this._currentGroup+") - "+a+"\t"+this._tabulation+c},setLevel:function(){return this._level},setLevel:function(a){this._level=a;this.trace=this._trace;this.debug=this._debug;this.info=this._info;this.warn=
this._warn;this.error=this._error;a>=Tlogger.DEBUG&&(this.trace=function(){});a>=Tlogger.INFO&&(this.debug=function(){});a>=Tlogger.WARN&&(this.info=function(){});a>=Tlogger.ERROR&&(this.warn=function(){})}});Tlogger.TRACE=10;Tlogger.DEBUG=20;Tlogger.INFO=30;Tlogger.WARN=40;Tlogger.ERROR=50;panjs.logger=new Tlogger({level:Tlogger[panjs.logLevel],name:"main"});logger=panjs.logger;Ttracer=function(){};Ttracer.getLogger=function(a){return logger};
defineClass("Tloader","panjs.core.Tobject",{queue:[],loadedJs:null,loadedCss:null,_lessIsLoaded:null,randomId:"",constructor:function(a){this.loadedJs={};this.loadedCss={};this.randomId=Math.random()},init:function(){if(!panjs.cache.useLocalStorage){panjs.cache={};var a="cache_"+panjs.appName,b;for(b in localStorage)b.startsWith(a)&&localStorage.removeItem(b)}},lessIsLoaded:function(){null==this._lessIsLoaded&&(this._lessIsLoaded=defined(window.less,"refresh"));return this._lessIsLoaded},getClassPathDir:function(a){var b=
a;a.endsWith(".js")?b=a.removeEnd(".js"):a.endsWith(".html")&&(b=a.removeEnd(".html"));return b=b.substr(0,b.lastIndexOf("."))},_getUrlWithVersion:function(a){a=!1==a.contains("?")?a+"?":a+"&";a+="v="+panjs.appVersion;"dev"==panjs.env&&(a=a+"&rid="+this.randomId);return a},_loadFileSync:function(a){var b=panjs.cache.useLocalStorage&&"prod"==panjs.env&&panjs.appName;if(b){var c="cache_"+panjs.appName,d=c+"."+panjs.appVersion+"."+a.hashCode(),e=localStorage.getItem(d);if(e)return{result:!0,data:e}}try{var f=
{result:!1,exception:"",status:"erreur inconnue"};logger.debug("Loadfile SYNC %1",a);jQuery.support.cors=!0;var g=jQuery.ajax({url:a,method:"GET",cache:!0,async:!1,dataType:"html",processData:!1,context:this,beforeSend:function(a){},success:function(e,g,h){f={result:!0,data:e};if(b){for(var m in localStorage)m.startsWith(c)&&!m.startsWith(c+"."+panjs.appVersion)&&(logger.debug("Removing old version from locaStorage: %1",m),localStorage.removeItem(m));try{localStorage.setItem(d,e)}catch(l){logger.debug(l+
": data from "+a+" will not be saved")}}},error:function(b,c,d){logger.error("Load error. url=%1, exception=%2",a,d);f={result:!1,jqXHR:g,exception:d};f.status=g&&g.status?g.status:d}})}catch(l){f={result:!1,exception:l,status:l}}return f},getFileSync:function(a){return this._loadFileSync(a)},usesComponent:function(a){var b=panjs._getClassNameFromClassPath(a),c={result:!1,message:"",className:b,classPath:a,url:null,path:null,Class:null};if("undefined"==typeof panjs._classes[a]){logger.debug("USESCOMPONENT %1",
a);logger.groupStart();c.path=panjs.getAbsoluteUrlFromClassPath(a);c.url=this._getUrlWithVersion(c.path);var d=this._loadFileSync(c.url);if(d.result){try{var e=getXmlDocument(d.data)}catch(f){return logger.error("XML error in class "+b+": "+f),c.isXmlError=!0,c.message=f,c}for(var g=e.getElementsByTagName("head")[0],e=e.getElementsByTagName("body")[0],l=[],n=[],p=c.path.substring(0,c.path.lastIndexOf("/")),h=0;h<g.childNodes.length;h++){var m=g.childNodes[h],q=m.nodeName.toLowerCase();if("script"==
q)try{this.addScriptNode(m,p,b,a)}catch(r){return a="Error processing <"+q+"> in "+b+" => "+r,logger.error(c.path+": "+a),c.message=a,c.stack=r.stack,c}else"link"==q?l.push(m):"style"==q&&n.push(m)}b=panjs._classes[a].Class;for(h=0;h<l.length;h++)this.addLinkNode(l[h],p);for(h=0;h<n.length;h++)logger.debug("Load style %1",a),this.addStyleNode(n[h]);if(defined(e))try{var s=getXml(e),t=b.prototype.parentClassName;defined(window[t].prototype.html)&&window[t].prototype.html.contains("\x3c!--CONTENT--\x3e")&&
(s=window[t].prototype.html.replace("\x3c!--CONTENT--\x3e",s));s=s.replace(/<body>/gi,"").replace(/<\/body>/gi,"");b.prototype.html=s;b.prototype.bodyNode=e}catch(u){return c.message=u.message,c}panjs.setSourceInComponents&&(b.prototype.source=d.data);b.prototype.classPathDir=this.getClassPathDir(a);b.prototype.dirPath=p;b.lastId=0;logger.groupEnd();logger.debug("END USESCOMPONENT %1",a);c.result=!0;c.message="ok";c.Class=b}else a="Error loading "+a+": "+d.status,logger.warn(a),c.mess=a}else c.result=
...
b,d,a,".js"),panjs._exec(e.data),e=panjs._classes[a].Class,e.prototype.classPathDir=this.getClassPathDir(a),e.prototype.dirPath=d,e.lastId=0,c.result=!0,c.message="ok",c.Class=e;else throw a+" not loaded: "+e.status;logger.groupEnd();logger.debug("END USES %1",a)}else c.result=!0,c.message="Already loaded",c.Class=e;return c},_transformUrl:function(a,b){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"file://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=b+"/"+a);return a},addLinkNode:function(a,b){var c=
this._transformUrl(a.getAttribute("href"),b),d=a.getAttribute("type")||"text/css",e=a.getAttribute("rel")||"stylesheet";this.loadCssFile(c,d,e)},loadCssFile:function(a,b,c){if(0==arguments.length)throw"loadCssFile(url, type , rel): Missing url";var d=!1;a=this._getUrlWithVersion(a);if(this.loadedCss[a.toLowerCase()])return d;2>arguments.length&&(b="text/css");3>arguments.length&&(c="stylesheet");var e=document.createElement("link");e.rel=c;e.type=b;e.href=a;"stylesheet/less"==c?this.lessIsLoaded()?
(less.sheets.push(e),less.refresh(!0),logger.debug(panjs.messages.LESS_INJECTED),d=!0):logger.warn(panjs.messages.LESS_NOT_LOADED):(document.getElementsByTagName("head")[0].appendChild(e),d=!0);!0==d&&logger.debug("Load <link> ASYNC: %1",a);this.loadedCss[a.toLowerCase()]=!0;return d},addStyle:function(a,b){""!=a.trim()&&(2>arguments.length&&(b="text/css"),$('<style type="'+b+'">'+a+"</style>").appendTo("head"),"text/less"==b&&(this.lessIsLoaded()?(less.refresh(),logger.debug(panjs.messages.LESS_INJECTED)):
logger.warn(panjs.messages.LESS_NOT_LOADED)))},addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");this.addStyle(a.textContent,b)},_processCode:function(a,b,c,d,e){a=a.replace("defineClass(","var __CLASSPATH__='"+d+"';defineClass(").replace(/this._super/g,'panjs._classes["'+d+'"].Class._super')+"\n"+panjs._sourceUrl+c+"/"+b+e;return a=a.replace("defineStaticClass(","var __CLASSPATH__='"+d+"';defineStaticClass(")},addScriptNode:function(a,b,c,d){var e=a.getAttribute("data-subtype"),
f=a.getAttribute("src");if(null==f)f=a.textContent,null!=c&&"text/x-class-definition"==e&&(f=this._processCode(f,c,b,d,".html")),panjs._exec(f);else if(a=this._transformUrl(f,b),this.loadedJs[a.toLowerCase()])logger.debug(panjs.messages.SCRIPT_ALREADY_LOADED,a);else{var g=this._loadFileSync(this._getUrlWithVersion(a));g.data=null!=c&&"text/x-class-definition"==e?this._processCode(g.data,c,b,d,".js"):g.data+("\n"+panjs._sourceUrl+f+".js");panjs._exec(g.data);this.loadedJs[a.toLowerCase()]=1}return!0}});
panjs.loader=new Tloader;panjs.loader.init();__CLASSPATH__="panjs.core.events.Tevent";defineClass("Tevent","panjs.core.Tobject",{type:null,data:null,relatedData:null,bubbles:!1,cancelable:!1,currentTarget:null,cancelled:!1,defaultPrevented:!1,constructor:function(a,b,c,d){this.injectParam("type",a,!0);this.injectParam("data",b);this.injectParam("bubbles",c);this.injectParam("cancelable",d)},preventDefault:function(){this.defaultPrevented=!0}});Tevent.CLICK="click";Tevent.CHANGE="change";
Tevent.SUCCESS="success";Tevent.ERROR="error";Tevent.DELETE="delete";Tevent.UPDATE="update";Tevent.ADDED="added";Tevent.LOADED="loaded";Tevent.BEFORE_LOAD="before_load";Tevent.DATA_LOADED="data-loaded";Tevent.REFRESH="refresh";Tevent.REPLACE="replace";Tevent.ITEM_CLICKED="item-clicked";Tevent.OPEN="open";Tevent.CLOSE="close";Tevent.READY="ready";Tevent.BEFORE_STATE_CHANGE="before_state_change";Tevent.STATE_CHANGED="state_changed";Tevent.KEYDOWN="keydown";Tevent.SHOW="show";Tevent.SHOWN="shown";
Tevent.HIDE="hide";Tevent.HIDDEN="hidden";Tevent.WAITING="waiting";uses("panjs.core.events.Tevent");__CLASSPATH__="panjs.core.events.TeventDispatcher";
defineClass("TeventDispatcher","panjs.core.Tobject",{_listeners:null,constructor:function(a){this._listeners={}},free:function(){this.removeAllListeners()},_getListenerIndex:function(a,b){if(!this.hasEventListener(a))return-1;for(var c=0;c<this._listeners[a].length;c++)if(null!=this._listeners[a][c]&&this._listeners[a][c].listener==b)return c;return-1},dispatchEvent:function(a,b,c,d){var e=null,f=null;"object"==typeof a?(f=a,e=a.type):e=a;if(this.hasEventListener(e))for(null==f&&(f=new Tevent(e,b,
c,d)),a=this._listeners[f.type],b=0;b<a.length&&(null==a[b]||(c=a[b],null==f.currentTarget&&(f.currentTarget=this),f.bind=c.bind,f.relatedData=c.data,null==f.bind?c.listener.call(this,f):c.listener.call(f.bind,f),!f.cancelled));b++);},on:function(a,b,c,d){4>arguments.length&&(d=null);3>arguments.length&&(c=null);var e={listener:b,data:d,bind:c};this.hasEventListener(a)||(this._listeners[a]=[]);for(var f=0;f<this._listeners[a].length;f++)if(null==this._listeners[a][f]){this._listeners[a][f]=e;return}this._listeners[a].push(e)},
offByCtx:function(a){for(type in this._listeners)for(var b=this._listeners[type],c=0;c<b.length;c++)null!=b[c]&&b[c].bind==a&&(b[c]=null)},off:function(a,b){var c=this._getListenerIndex(a,b);0<=c&&(this._listeners[a][c]=null)},removeAllListeners:function(){for(type in this._listeners)this._listeners[type].length=0,this._listeners[type]=null,delete this._listeners[type]},hasEventListener:function(a){return"undefined"!=typeof this._listeners[a]}});__CLASSPATH__="panjs.core.managers.Trouter";
...
setSource:function(a,b){if(this._source!=a){this._source=a;this._items=null!=this.filterFunction?this._source.filter(this.filterFunction):this._source.slice(0);if(null!=this.key){this._byId={};for(var c=0;c<this._items.length;c++)this._byId[this._items[c][this.key]]=this._items[c]}this.length=this._items.length;this.refresh(b)}},find:function(a){var b=[];if(a.filterFunction)for(var c=0;c<this._source.length;c++)a.filterFunction(this._source[c])&&b.push(this._source[c]);return b},swap:function(a,b){var c=
this.getItemIndex(a),d=this.getItemIndex(b);this._items[c]=b;this._items[d]=a},getByKey:function(a){return this._byId[a]},getByProp:function(a,b,c,d){var e=null;if(null!=this.key&&a==this.key)"undefined"!=typeof this._byId[b]&&(e=this._byId[b]);else{"undefined"==typeof d&&(d=!1);d||"string"!=typeof b||(b=b.toLowerCase());3>arguments.length?c=!1:e=[];for(var f=0;f<this._items.length;f++){var g=this._items[f];if("undefined"!=typeof g[a]){var l=g[a];d||"string"!=typeof g[a]||(l=g[a].toLowerCase());if(l==
b)if(!0==c)e.push(g);else{e=g;break}}}}return e},getFilterFunction:function(){return this.filterFunction},setFilterFunction:function(a){this.filterFunction!=a&&(this.filterFunction=a)},dispatchUpdateEvent:function(a){this.dispatchEvent(new Tevent(Tevent.UPDATE,{item:a}));this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"UPDATE",item:a}))},refresh:function(a){null!=this.filterFunction&&(this._items=this._source.filter(this.filterFunction));this.length=this._items.length;a||(this.dispatchEvent(new Tevent(Tevent.REFRESH,
this)),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"REFRESH"})))},getItems:function(){return this._items},_getItemIndex:function(a,b){for(var c=0;c<b.length;c++)if(b[c]==a)return c;return-1},getItemIndex:function(a){return this._getItemIndex(a,this._items)},getItemAt:function(a){return this._items[a]},contains:function(a){return 0<=this.getItemIndex(a)},_replaceItem:function(a,b,c,d){this._items[a]=c;null!=this.key&&(this._byId[b[this.key]]=c,this.dispatchEvent(new Tevent(Tevent.UPDATE,b)));
this.length=this._items.length;d||(this.dispatchEvent(new Tevent(Tevent.REPLACE,{item:b,newItem:c})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"REPLACE",item:b,newItem:c})))},replaceItem:function(a,b,c){if(a!=b){var d=this._getItemIndex(a,this._source);-1<d&&(this._source[d]=b);d=this.getItemIndex(a);-1<d&&(null==this.filterFunction?this._replaceItem(d,a,b,c):this.filterFunction(b)?this._replaceItem(d,a,b,c):this._removeItemAt(d,b,c))}},_addItemAt:function(a,b,c){if(null!=this.key){if("undefined"!=
typeof this._byId[b[this.key]])throw"Key already in collection: "+b[this.key];this._byId[b[this.key]]=b}this._items.splice(a,0,b);this.length=this._items.length;c||(this.dispatchEvent(new Tevent(Tevent.ADDED,{item:b,index:a})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"ADDED",item:b,index:a})))},addItem:function(a,b){this._source.push(a);(null==this.filterFunction||this.filterFunction(a))&&-1==this.getItemIndex(a)&&this._addItemAt(this.length,a,b)},addItemsAt:function(a,b,c){if(b>this.length)this.addItems(a,
c);else for(var d=b,e=0;e<a.length;e++)if(this._source.push(a[e]),null==this.filterFunction||this.filterFunction(a[e]))b=this.getItemIndex(a[e]),-1<b&&(d++,this._addItemAt(d,a[e],c))},addItems:function(a,b){this.addItemsAt(a,this.length,b)},addItemAt:function(a,b,c){b>this.length?this.addItem(a):(this._source.push(a),(null==this.filterFunction||this.filterFunction(a))&&this._addItemAt(b,a,c))},forEach:function(a){this._items.forEach(a)},removeItems:function(a,b){if("function"==typeof a)for(var c=
[],d=0;d<this._items.length;d++)a(this._items[d])&&c.push(this._items[d]);else c=a;for(d=0;d<c.length;d++)this.removeItem(c[d],b);return c},removeItem:function(a,b){if(null!=a){var c=this.getItemIndex(a);0<=c&&this._removeItemAt(c,a,b)}else c=-1;return c},removeItemAt:function(a,b){var c=this.getItemAt(a);null!=c&&this._removeItemAt(a,c,b)},removeAll:function(a){this._source=[];this._items=[];this._byId={};this.refresh(a)},_removeItemAt:function(a,b,c){this._items.splice(a,1);a=this._getItemIndex(b,
this._source);0<=a&&this._source.splice(a,1);this.length=this._items.length;null!=this.key&&delete this._byId[b[this.key]];c||(this.dispatchEvent(new Tevent(Tevent.DELETE,{item:b})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"DELETE",item:b})))}});__CLASSPATH__="panjs.core.display.TdisplayObject";
defineClass("TdisplayObject","panjs.core.events.TeventDispatcher",{container:null,id:null,parent:null,_parent:null,visible:!0,autoload:!0,baseElement:null,_realVisible:!1,args:null,load:function(){return this},isLoaded:function(){return!0},free:function(){TdisplayObject._super.free.call(this);this.container.remove()},_onInitialized:function(){},constructor:function(a){TdisplayObject._super.constructor.call(this,a);this.args=a;if(null==this.baseElement)throw'La propri\u00e9t\u00e9 "baseElement" n\'est pas d\u00e9fini sur '+
this.className;this.container=$("<"+this.baseElement+"/>");window[this.className].lastId++;this.id=window[this.className].lastId;this.container[0].owner=this;this.container[0].compo=this},addClass:function(a){this.container.addClass(a)},removeClass:function(a){this.container.removeClass(a)},createComponent:function(a,b){return panjs.createComponent(a,b)},_triggerOnAdded:function(){this._onAdded&&($.contains(document.body,this.container[0])?this._onAdded():setTimeout(function(){$.contains(document.body,
...
bind:function(a){},renderBindings:function(){for(var a=0;a<this.__bindings.html.length;a++){var b=this.__bindings.html[a];try{b.element.html(b.tempFn(this))}catch(c){logger.error(c)}}},createComponent:function(a,b){var c=TdisplayObjectContainer._super.createComponent(a,b);null==this._children&&(this._children=[]);this._children.push(c);return c},free:function(){if(null!=this._children){TdisplayObjectContainer._super.free.call(this);for(var a=0;a<this._children.length;a++)this._children[a].free();
this._children=null}},__OnPropChanged:function(a,b,c,d){this.renderBindings()},processStates:function(a){var b=a.getAttribute("data-include-in");null!=b&&(b=b.split(" "));var c=a.getAttribute("data-include-logic")||"OR",d=a.getAttribute("data-exclude-from");null!=d&&(d=d.split(" "));var e=a.getAttribute("data-exclude-logic")||"OR";if(null!=d&&null!=b)throw"'excludeFrom' and 'includeIn' attributes are exclusive";if(null!=b||null!=d){var f=null!=a.getAttribute("data-compo"),g="true"==a.getAttribute("data-loaded");
a={display:a.style.display,loaded:g,isCompo:f,visible:null,elem:a,excludeLogic:e,includeLogic:c,id:a.getAttribute("id"),includeIn:b,excludeFrom:d};this._statesElements.push(a)}},stateExists:function(a){var b=!1;if(null==a||""==a)return!1;for(var c=0;c<this._statesElements.length;c++){var d=this._statesElements[c];if(null!=d.includeIn&&0<=d.includeIn.indexOf(a)){b=!0;break}else if(null!=d.excludeFrom&&0<=d.excludeFrom.indexOf(a)){b=!0;break}}return b},_onSubComponentLoaded:function(a,b,c){this._children.push(a);
c=a.container.attr("data-original-id");panjs._setDOMId(a.container[0],c,a.classPath);this.bindEvents(b,a);c&&(this[c]=a);for(c=0;c<this._statesElements.length;c++){var d=this._statesElements[c];if(d.elem==b[0]){d.loaded=!0;d.elem=a.container[0];this.setStatesAttributes(b[0],d.elem);break}}},getChildren:function(){return this._children},findComponents:function(a){var b=$([]);this.container.getElements(0==arguments.length?"[data-compo]":'[data-compo*="'+a+'"]').each(function(a,d){d.isCompo()&&b.push(d[0].owner)});
return b},setStatesAttributes:function(a,b){a.getAttribute("data-include-in")&&b.setAttribute("data-include-in",a.getAttribute("data-include-in"));a.getAttribute("data-include-logic")&&b.setAttribute("data-include-logic",a.getAttribute("data-include-logic"));a.getAttribute("data-exclude-from")&&b.setAttribute("data-exclude-from",a.getAttribute("data-exclude-from"));a.getAttribute("data-exclude-logic")&&b.setAttribute("data-exclude-logic",a.getAttribute("data-exclude-logic"))},_setStateElementVisible:function(a,
b,c){var d=!1;if(b.visible!=a){var d=!0,e=$(b.elem);a?b.isCompo?b.loaded?b.elem.compo.show(c):e.load().show(c):defined(c,"showFn")?c.showFn(e,b):(e.show(c),"none"!=b.display&&e.css("display",b.display)):b.isCompo?b.loaded?b.elem.compo.hide(c):defined(c,"hideFn")?c.hideFn(e,b):e.hide(c):defined(c,"hideFn")?c.hideFn(e,b):e.hide(c);b.visible=a}return d},hasState:function(a){var b=!1;if("string"==typeof a)for(var c=0;c<this.currentState.length;c++){if(this.currentState[c]==a){b=!0;break}}else logger.error("hasState error: state is undefined");
return b},toggleState:function(a,b,c){var d=!1;1==arguments.length?b=!this.hasState(a):2==arguments.length&&"boolean"!=typeof b&&(c=b,b=!this.hasState(a));return d=!1==b?this.removeState(a,c):this.addState(a,c)},addState:function(a,b){var c=!1;if("string"==typeof a){for(var d=[],e=!1,f=0;f<this.currentState.length;f++)this.currentState[f]==a?e=!0:d.push(this.currentState[f]);e||(c=!0,d.push(a),this.setState(d,b))}else logger.error("addState error: state is undefined");return c},removeState:function(a,
b){var c=!1;if("string"==typeof a){for(var d=[],e=0;e<this.currentState.length;e++)this.currentState[e]!=a?d.push(this.currentState[e]):c=!0;c&&this.setState(d,b)}else logger.error("removeState error: state is undefined");return c},setState:function(a,b){var c={},d={},e=!1;if("string"==typeof a){var f=[a];c[a]=1}else for(var f=a,g=0;g<f.length;g++)void 0!=f[g]?c[f[g]]=1:logger.error("setState error: state is undefined");f=this.currentState;for(g=0;g<this.currentState.length;g++)this.container.removeClass(this.currentState[g]),
d[this.currentState[g]]=1;this.currentState=[];for(var l=0;l<this._statesElements.length;l++){var n=this._statesElements[l],p=!0,h=!0;if(null!=n.includeIn)for(h=null,p=!0,g=0;g<n.includeIn.length;g++){var m=n.includeIn[g],m="undefined"!=typeof c[m];if("OR"==n.includeLogic){if(p=m)break}else p=p&&m}else if(null!=n.excludeFrom)for(h=!1,p=null,g=0;g<n.excludeFrom.length;g++)if(m=n.excludeFrom[g],m="undefined"!=typeof c[m],"OR"==n.excludeLogic){if(h=m)break}else h=h&&m;if(null!=p||null!=h)e=this._setStateElementVisible(!0==
p||!1==h,n,b)||e}this.currentState=[];for(var q in c)this.currentState.push(q),this.container.addClass(q);if(e){logger.isLevelEnabled(Tlogger.TRACE)&&logger.trace(this.id+".currentState = "+JSON.stringify(this.currentState));g=[];for(q in c)"undefined"==typeof d[q]&&g.push(q);l=[];for(q in d)"undefined"==typeof c[q]&&l.push(q);this.dispatchEvent(new Tevent(Tevent.STATE_CHANGED,{oldStates:f,newStates:this.currentState,removedStates:l,addedStates:g}))}return e},_processElement:function(a,b,c){if(1==
a.nodeType){b=a.getAttribute("id");var d=a.getAttribute("data-compo"),e=$(a);if(null==d)c&&null!=b&&(defined(this[b])&&logger.error('1-Duplication du id "'+b+'" sur objet '+this.className),this[panjs.getCamelCase(b)]=e,panjs._setDOMId(a,b,d)),this.bindEvents(e),this.processStates(a),this._populateElements(a,c);else if(d==this.classPath)logger.error("R\u00e9f\u00e9rence circulaire dans "+this.classPath);else if("false"!==a.getAttribute("data-autoload")){var f=this.createComponent(d,{elem:a,parent:this});
f.parent=this;c&&null!=b&&(defined(this[b])&&logger.error('2-Duplication du id "'+b+'" sur objet '+this.className),this[b]=f,panjs._setDOMId(f.container[0],b,d));this.bindEvents(e,f);e.replaceWith(f.container);f.container.attr("data-loaded","true");a.setAttribute("data-loaded","true");f.container[0].loaded=!0;f.container[0].compo=f;this.setStatesAttributes(a,f.container[0]);this.processStates(f.container[0]);f._triggerOnAdded()}else panjs._setDOMId(a,b,d),e[0].compo=null,e[0].owner=this,this[b]=e,
this.processStates(a)}else 8==a.nodeType&&(c="",c=a.textContent,c=c.toUpperCase(),"CONTENT"==c&&(c=document.createElement("div"),c.setAttribute("data-class","content"),b.replaceChild(c,a),this.content=$(c)))},_populateElements:function(a,b){for(var c=0;c<a.childNodes.length;c++)this._processElement(a.childNodes[c],a,b)}});TdisplayObjectContainer._listeIdElements=[];__CLASSPATH__="panjs.core.display.Telement";
defineClass("Telement","panjs.core.display.TdisplayObjectContainer",{html:null,content:null,sourceElement:null,inheritsStyle:!0,enableHashManager:!1,hashKey:null,sourceElementStyle:null,constructor:function(a){Telement._super.constructor.call(this,a);!0==this.enableHashManager&&(uses("panjs.core.managers.Trouter"),null==this.hashKey&&(this.hashKey=1<this.id?this.className+this.id:this.className),panjs.router.registerComponent(this,this._onHashChange,this.hashKey));var b;b=this.inheritsStyle?this.classHierarchy.rightOf("Telement"):
this.className;this.container.addClass(b);this.container.attr("data-compo",this.classPath);this.container.attr("data-class-name",this.className);"undefined"!=typeof a&&defined(a,"elem")&&(this.sourceElement=a.elem,null!=this.content&&""!=this.sourceElement.innerHTML.trim()&&(this.content[0].innerHTML=this.sourceElement.innerHTML,"undefined"!=typeof a.parent&&(this.parent=a.parent,a.parent._populateElements(this.content[0],!0))),b=a.elem.getAttribute("class"),null!=b&&this.container.addClass(b));a=
