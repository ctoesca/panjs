...
if(!f.result)return panjs.getErrorComponent(a,d,f)}catch(g){return panjs.getErrorComponent(a,d,g)}try{"undefined"==typeof c&&(c={});"undefined"!=typeof c.elem&&panjs.setElementArgs(c.elem,c);if("undefined"!=typeof panjs.root.components[a]&&"undefined"!=c.reuse&&!0===c.reuse){var h=panjs.root.components[a];h.reuse(c);return h}e=new window[d](c)}catch(m){f="Error instantiating "+d+": "+m,logger.error(f),uses("core.display.TerrorElement.html"),e=panjs.getAbsoluteUrlFromClassPath(a),h=panjs.loader.getUrlWithVersion(e),
