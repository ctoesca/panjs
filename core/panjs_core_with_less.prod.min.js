...
function deepmerge(a,b){var c=Array.isArray(b),d=c&&[]||{};c?(a=a||[],d=d.concat(a),b.forEach(function(b,c){"undefined"===typeof d[c]?d[c]=b:"object"===typeof b?d[c]=deepmerge(a[c],b):-1===a.indexOf(b)&&d.push(b)})):(a&&"object"===typeof a&&Object.keys(a).forEach(function(b){d[b]=a[b]}),Object.keys(b).forEach(function(c){d[c]="object"===typeof b[c]&&b[c]?a[c]?deepmerge(a[c],b[c]):b[c]:b[c]}));return d}function randomBetween(a,b){return Math.floor(Math.random()*b)+a}
...
a.namespaces[f].path.replace("{version}",a.version),a.namespaces[f].name=f;window.less="undefined"!=typeof a.less?a.less:{env:"production",async:!0,fileAsync:!1,poll:1E3};var g=function(b,e,f){"string"==typeof f&&(f={message:f,className:e});f.stack=c;uses(a.errorComponentClass);object=new TerrorElement(f);c.push(f.message);d--;0>=d&&(c=[],d=0);return object};a._exec=function(a){""!=a&&("undefined"!=typeof window.execScript?window.execScript(a):window.eval(a))};a.addNamespace=function(b,c){a.namespaces[b]=
{path:c,name:b}};a._setDOMId=function(b,c,d){c&&(d=b.getAttribute("data-preserve-id"),d=null==d?a.preserveElementsId:"true"==d,d||(d=b.nodeName.toLowerCase(),"undefined"==typeof e[d]?e[d]=1:e[d]++,b.setAttribute("id",d+e[d]),b.setAttribute("data-original-id",c)),a.addIdClass&&(b.className+=" "+c))};a.getClass=function(b){"undefined"==typeof a._classes[b]&&uses(b);return a._classes[b].Class};a.getInstance=function(b,c){return new (a.getClass(b))(c)};a.createObject=a.getInstance;a.unload=function(b){"undefined"==
typeof a._classes[b]&&(b+=".html");"undefined"!=typeof a._classes[b]&&(a._classes[b]=void 0,delete a._classes[b])};a.createComponent=function(b,e,f){d++;f=a._getClassNameFromClassPath(b);var l=null;if("undefined"==typeof a._classes[b])try{var m=a.loader.usesComponent(b);if(null==m||!m.result)return g(b,f,m)}catch(p){return g(b,f,p)}try{"undefined"==typeof e&&(e={});if("undefined"!=typeof e.elem){var s=e.elem,m=e;if("undefined"!=typeof s)for(var r=0;r<s.attributes.length;r++){var u=s.attributes.item(r),
w=u.nodeName.toLowerCase(),t=u.value;if(w.startsWith("data-"))var x=w,x=x.rightOf("data-"),w=a.getCamelCase(x);"true"==t?t=!0:"false"==t&&(t=!1);m[w]=t}}if("undefined"!=typeof a.root.components[b]&&"undefined"!=e.reuse&&!0===e.reuse){var y=a.root.components[b];y.reuse(e);return y}l=new a._classes[b].Class(e)}catch(z){e="Error instantiating "+f+": "+z,logger.error(e),l=a.getAbsoluteUrlFromClassPath(b),s=a.loader._getUrlWithVersion(l),l=g(b,f,{message:e,path:l,url:s,className:f}),c.push(e)}d--;0>=d&&
(c=[],d=0);l._onInitialized&&l._onInitialized();return a.root.components[b]=l};a.getCamelCase=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?a[c]:b+a[c].capitalizeFirstLetter();return b};a.loadScriptAsync=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};a.loadScriptSync=function(b){var c={result:null,errorMessage:""};if(this.loader.loadedJs[b.toLowerCase()])c.result=!0,logger.debug(a.messages.SCRIPT_ALREADY_LOADED,b);
else{var d=this.loader._loadFileSync(this.loader._getUrlWithVersion(b));c.result=d.result;!0!=c.result?c.errorMessage=d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.find("[data-compo]");for(var e=0;e<d.length;e++){var f=$(d[e]),g=f.attr("data-compo"),s="false"!==f.attr("data-autoload"),r=f.attr("id");!0==s?f=f.load():(a._setDOMId(f[0],
r,g),f[0].compo=null,f[0].owner=null);a.root[r]=f}2==arguments.length&&c()};a._getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||a.startsWith("file://")||a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};a.getNSFromClassPath=function(b){var c=null,d;for(d in a.namespaces)if(b.startsWith(d+".")){c=a.namespaces[d];break}return c};a.getAbsoluteUrlFromClassPath=function(b){var c=b.endsWith(".html"),
d="";if(b.startsWith("http://")||b.startsWith("file://")||"/"==b[0])d=c?b:b+".js";else if(b.removeEnd(".html").contains(".")){var e=a.getNSFromClassPath(b);e&&(d=e.path+"/"+b.rightOf(e.name+".").removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js")}else d=a.basePath+"/"+b,c||(d+=".js");""==d&&(d=b.removeEnd(".html").replace(/\./g,"/"),d=c?d+".html":d+".js");return d}})(panjs=panjs||{});
...
p)try{this.addScriptNode(m,q,b,a)}catch(s){return a="Error processing <"+p+"> in "+b+" => "+s,logger.error(c.path+": "+a),c.message=a,c.stack=s.stack,c}else"link"==p?h.push(m):"style"==p&&n.push(m)}if("undefined"==typeof panjs._classes[a])return c.message="Classe "+a+" not loaded",c;b=panjs._classes[a].Class;for(l=0;l<h.length;l++)this.addLinkNode(h[l],q);for(l=0;l<n.length;l++)logger.debug("Load style %1",a),this.addStyleNode(n[l]);g=b.prototype.parentClassName;if(defined(e))try{var r=getXml(e);
defined(window[g].prototype.html)&&window[g].prototype.html.contains("\x3c!--CONTENT--\x3e")&&(r=window[g].prototype.html.replace("\x3c!--CONTENT--\x3e",r));r=r.replace(/<body>/gi,"").replace(/<\/body>/gi,"");b.prototype.html=r;b.prototype.bodyNode=e}catch(u){return c.message=u.message,c}else defined(window[g].prototype.html)&&(r=window[g].prototype.html,b.prototype.html=r,b.prototype.bodyNode=e);panjs.setSourceInComponents&&(b.prototype.source=d.data);b.prototype.classPathDir=this.getClassPathDir(a);
b.prototype.dirPath=q;b.lastId=0;logger.groupEnd();logger.debug("END USESCOMPONENT %1",a);c.result=!0;c.message="ok";c.Class=b}else a="Error loading "+a+": "+d.status,logger.warn(a),c.mess=a}else c.result=!0,c.mess="Already loaded",c.Class=panjs._classes[a].Class;return c},uses:function(a){var b=panjs._getClassNameFromClassPath(a),c={result:!1,message:"",className:b,classPath:a,url:null,path:null,Class:null};if("undefined"==typeof panjs._classes[a]){logger.debug("USES %1",a);logger.groupStart();c.path=
panjs.getAbsoluteUrlFromClassPath(a);var d=c.path.substring(0,c.path.lastIndexOf("/"));c.url=this._getUrlWithVersion(c.path);var e=this._loadFileSync(c.url);if(e.result){e.data=this._processCode(e.data,b,d,a,".js");panjs._exec(e.data);if("undefined"==typeof panjs._classes[a])return c.message="Classe "+a+" not loaded",c;e=panjs._classes[a].Class;e.prototype.classPathDir=this.getClassPathDir(a);e.prototype.dirPath=d;panjs._classes[a].lastId=0;c.result=!0;c.message="ok";c.Class=e}else throw a+" not loaded: "+
e.status;logger.groupEnd();logger.debug("END USES %1",a)}else c.result=!0,c.message="Already loaded",c.Class=e;return c},_transformUrl:function(a,b){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"file://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=b+"/"+a);return a},addLinkNode:function(a,b){var c=this._transformUrl(a.getAttribute("href"),b),d=a.getAttribute("type")||"text/css",e=a.getAttribute("rel")||"stylesheet";this.loadCssFile(c,d,e)},loadCssFile:function(a,b,c){if(0==arguments.length)throw"loadCssFile(url, type , rel): Missing url";
var d=!1;a=this._getUrlWithVersion(a);if(this.loadedCss[a.toLowerCase()])return d;2>arguments.length&&(b="text/css");3>arguments.length&&(c="stylesheet");var e=document.createElement("link");e.rel=c;e.type=b;e.href=a;"stylesheet/less"==c?this.lessIsLoaded()?(less.sheets.push(e),less.refresh(!0),logger.debug(panjs.messages.LESS_INJECTED),d=!0):logger.warn(panjs.messages.LESS_NOT_LOADED):(document.getElementsByTagName("head")[0].appendChild(e),d=!0);!0==d&&logger.debug("Load <link> ASYNC: %1",a);this.loadedCss[a.toLowerCase()]=
!0;return d},addStyle:function(a,b){0<panjs._iever?this.addStyleIE(a,b):""!=a.trim()&&(2>arguments.length&&(b="text/css"),$('<style type="'+b+'">'+a+"</style>").appendTo("head"),"text/less"==b&&(this.lessIsLoaded()?(less.refresh(),logger.debug(panjs.messages.LESS_INJECTED)):logger.warn(panjs.messages.LESS_NOT_LOADED)))},addStyleIE:function(a,b){if(""!=a.trim())if(2>arguments.length&&(b="text/css"),"text/less"==b){var c=$('<style type="'+b+'">'+a+"</style>");c.appendTo("head");this.lessIsLoaded()?
(less.refresh(),logger.debug(panjs.messages.LESS_INJECTED)):logger.warn(panjs.messages.LESS_NOT_LOADED)}else null==this._stylenode?(c=$('<style type="'+b+'">'+a+"</style>"),c.appendTo("head"),this._stylenode=c[0]):(this._addedcss+="\n"+a,this._stylenode.innerHTML=this._addedcss,$(this._stylenode).appendTo("head"))},addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");this.addStyle(a.textContent,b)},_processCode:function(a,b,c,d,e){a=a.replace("defineClass(","var __CLASSPATH__='"+
d+"';defineClass(").replace(/this._super/g,'panjs._classes["'+d+'"].Class._super')+"\n"+panjs._sourceUrl+c+"/"+b+e;return a=a.replace("defineStaticClass(","var __CLASSPATH__='"+d+"';defineStaticClass(")},addScriptNode:function(a,b,c,d){var e=a.getAttribute("data-subtype"),f=a.getAttribute("src");if(null==f)f=a.textContent,null!=c&&"text/x-class-definition"==e&&(f=this._processCode(f,c,b,d,".html")),panjs._exec(f);else if(a=this._transformUrl(f,b),this.loadedJs[a.toLowerCase()])logger.debug(panjs.messages.SCRIPT_ALREADY_LOADED,
a);else{var g=this._loadFileSync(this._getUrlWithVersion(a));g.data=null!=c&&"text/x-class-definition"==e?this._processCode(g.data,c,b,d,".js"):g.data+("\n"+panjs._sourceUrl+f+".js");panjs._exec(g.data);this.loadedJs[a.toLowerCase()]=1}return!0}});panjs.loader=new Tloader;panjs.loader.init();logger.info("READY. Panjs version: "+panjs.version);__CLASSPATH__="panjs.core.events.Tevent";
...
Tevent.VALIDATE="validate";Tevent.BEFORE_DESTROY="BEFORE_DESTROY";Tevent.DESTROY="DESTROY";uses("panjs.core.events.Tevent");__CLASSPATH__="panjs.core.events.TeventDispatcher";
...
this._listeners[a][f]){this._listeners[a][f]=e;return}this._listeners[a].push(e)},once:function(a,b,c,d){if(!(-1<this._getListenerIndex(a,b)))if(3>arguments.length)this.on(a,b);else if(4>arguments.length)this.on(a,b,c);else this.on(a,b,c,d)},offByCtx:function(a){for(var b in this._listeners)for(var c=this._listeners[b],d=0;d<c.length;d++)null!=c[d]&&c[d].bind==a&&(c[d]=null)},off:function(a,b){var c=this._getListenerIndex(a,b);0<=c&&(this._listeners[a][c]=null)},removeAllListeners:function(){for(var a in this._listeners)this._listeners[a].length=
0,this._listeners[a]=null,delete this._listeners[a]},hasEventListener:function(a){return"undefined"!=typeof this._listeners[a]}});__CLASSPATH__="panjs.core.managers.Trouter";
...
a,b)},addItemsAt:function(a,b,c){b>this.length&&(b=this.length);for(var d=b,e=0;e<a.length;e++)if(this._source.push(a[e]),null==this.filterFunction||this.filterFunction(a[e]))b=this.getItemIndex(a[e]),-1==b&&(d++,this._addItemAt(d,a[e],c))},addItems:function(a,b){this.addItemsAt(a,this.length,b)},addItemAt:function(a,b,c){b>this.length?this.addItem(a):(this._source.push(a),(null==this.filterFunction||this.filterFunction(a))&&this._addItemAt(b,a,c))},forEach:function(a){this._items.forEach(a)},removeItems:function(a,
b){if("function"==typeof a)for(var c=[],d=0;d<this._items.length;d++)a(this._items[d])&&c.push(this._items[d]);else c=a;for(d=0;d<c.length;d++)this.removeItem(c[d],b);return c},removeItem:function(a,b){if(null!=a){var c=this.getItemIndex(a);0<=c&&this._removeItemAt(c,a,b)}else c=-1;return c},removeItemAt:function(a,b){var c=this.getItemAt(a);null!=c&&this._removeItemAt(a,c,b)},removeAll:function(a){this._source=[];this._items=[];this._byId={};this.refresh(a)},_removeItemAt:function(a,b,c){this._items.splice(a,
1);a=this._getItemIndex(b,this._source);0<=a&&this._source.splice(a,1);this.length=this._items.length;null!=this.key&&delete this._byId[b[this.key]];c||(this.dispatchEvent(new Tevent(Tevent.DELETE,{item:b})),this.dispatchEvent(new Tevent(Tevent.CHANGE,{action:"DELETE",item:b})))}});__CLASSPATH__="panjs.core.display.TdisplayObject";
defineClass("TdisplayObject","panjs.core.events.TeventDispatcher",{container:null,id:null,owner:null,visible:!0,autoload:!0,baseElement:null,_realVisible:!1,args:null,_resizeFunction:null,load:function(){return this},isLoaded:function(){return!0},onWindowResize:function(a){a!=this._resizeFunction&&(this._resizeFunction&&$(window).off("resize",this._resizeFunction),this._resizeFunction=a,$(window).on("resize",a))},free:function(){TdisplayObject._super.free.call(this);this._resizeFunction&&$(window).off("resize",
this._resizeFunction);this.container.remove()},_onInitialized:function(){},constructor:function(a){TdisplayObject._super.constructor.call(this,a);this.args=a;if(null==this.baseElement)throw'La propri\u00e9t\u00e9 "baseElement" n\'est pas d\u00e9fini sur '+this.className;this.container=$("<"+this.baseElement+"/>");panjs._classes[this.classPath].lastId++;this.id=this.classPath+"_"+panjs._classes[this.classPath].lastId;this.container[0].owner=this;this.container[0].compo=this},addClass:function(a){this.container.addClass(a)},
removeClass:function(a){this.container.removeClass(a)},createComponent:function(a,b,c){return panjs.createComponent(a,b,!1)},_triggerOnAdded:function(){this._onAdded&&($.contains(document.body,this.container[0])?this._onAdded():setTimeout(function(){$.contains(document.body,this.container[0])&&this._onAdded()}.bind(this),50))},append:function(a){var b=a,c=this.container;a.isCompo()&&(b=a.container,null!=this.content&&(c=this.content));c.append(b);a._onAdded&&a._onAdded()},appendTo:function(a){a.append(this.container);
a.isCompo()&&a[0].owner._children.push(this);this._triggerOnAdded()},prependTo:function(a){this.container.prependTo(a);a.isCompo()&&this._children.push(a[0].owner)},hide:function(a){defined(a,"hideFn")?a.hideFn(this.container):this.container.hide(a);this._realVisible=this.visible=!1;"undefined"!=typeof this._onHide&&this._onHide()},show:function(a){this._realVisible||(defined(a,"showFn")?a.showFn(this.container):this.container.show(a),this._realVisible=this.visible=!0,"undefined"!=typeof this._onShow&&
this._onShow())},toggle:function(a){this.container.toggle(a);this.visible=!this._visible}});__CLASSPATH__="panjs.core.display.TdisplayObjectContainer";
...
h.container[0].compo=h,h.container[0].owner=this,this.setStatesAttributes(a,h.container[0]),this.processStates(h.container[0]),h._triggerOnAdded()):a.owner||(panjs._setDOMId(a,e,f),g[0].compo=null,g[0].owner=this,this[e]=g,this.processStates(a)))}else 8==a.nodeType&&(e="",e=a.textContent,e=e.toUpperCase(),"CONTENT"==e&&(e=document.createElement("div"),e.setAttribute("data-class","content"),b.replaceChild(e,a),this.content=$(e)));return h}},_populateElements:function(a,b,c){for(var d=0;d<a.childNodes.length;d++){var e=
a.childNodes[d];3>arguments.length?this._processElement(e,a,b):this._processElement(e,a,b,c)}}});TdisplayObjectContainer._listeIdElements=[];__CLASSPATH__="panjs.core.display.Telement";
defineClass("Telement","panjs.core.display.TdisplayObjectContainer",{html:null,content:null,sourceElement:null,inheritsStyle:!0,enableHashManager:!1,hashKey:null,sourceElementStyle:null,constructor:function(a){Telement._super.constructor.call(this,a);"undefined"!=typeof a.enableHashManager&&(this.enableHashManager=a.enableHashManager);!0==this.enableHashManager&&(uses("panjs.core.managers.Trouter"),"undefined"!=typeof a.hashKey&&(this.hashKey=a.hashKey),null==this.hashKey&&(this.hashKey=1<this.id?
this.className+this.id:this.className),panjs.router.registerComponent(this,this._onHashChange,this.hashKey));var b;b=this.inheritsStyle?this.classHierarchy.rightOf("Telement"):this.className;this.container.addClass(b);this.container.attr("data-compo",this.classPath);this.container.attr("data-class-name",this.className);this.container.attr("data-loaded",!0);"undefined"!=typeof a&&defined(a,"elem")&&(this.sourceElement=a.elem,null!=this.content&&""!=this.sourceElement.innerHTML.trim()&&(this.content[0].innerHTML=
this.sourceElement.innerHTML,"undefined"!=typeof a.owner&&(this.owner=a.owner,a.owner._populateElements(this.content[0],!0))),b=a.elem.getAttribute("class"),null!=b&&this.container.addClass(b));a=a.inlineStyle||null;null!=a&&(this.sourceElementStyle=a,this.setStyle(a))},setStyle:function(a){this.container.attr("style",a)},_onHashChange:function(a,b){var c=!1;this.enableHashManager&&"function"===typeof this.onHashChange&&(logger.debug("Telement."+this.id+"._onHashChange: "+b+" --\x3e "+a),c=this.onHashChange(a,
b));return c},_onShow:function(){},_onHide:function(){},setHash:function(a,b){this.enableHashManager&&(2>arguments.length&&(b=!1),panjs.router.setHash(this,a,b))},getHash:function(){return this.enableHashManager?panjs.router.getHash(this):null}});
