...
addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");a=getText(a);this.addStyle(a,b)},processCode:function(a,b){return a.replace(/this._super/g,b+"._super")},addScriptNode:function(a,b,c){var d=a.getAttribute("type"),e=a.getAttribute("src");null==e?(a=getText(a),null!=c&&"text/x-class-definition"==d&&(a=this.processCode(a,c)),panjs.exec(a)):(a=panjs.transformUrl(e,b),this.loadedJs[a.toLowerCase()]?logger.debug("Le script "+a+" est d\u00e9j\u00e0 charg\u00e9"):(b=this.loadFile(this.getUrlWithVersion(a)),
