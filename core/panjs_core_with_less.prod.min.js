...
"true");e.container.attr("data-original-id",c);f?f._onSubComponentLoaded(e,b,a):logger.debug("owner not set: dataCompo="+d+" originalId="+c);b.trigger(Tevent.LOADED,[e,a]);b.replaceWith(e.container);e._triggerOnAdded();b.remove();c=e}else c=b[0].compo;return c};$.fn.isLoaded=function(){return"true"==$(this).attr("data-loaded")};$.fn.isCompo=function(){return null!=$(this).attr("data-compo")};$.fn.getCompo=function(){var a=null;$(this)[0].compo&&(a=$(this)[0].compo);return a};
...
d.exception:(d.data+="\n"+a._sourceUrl+b+".js",a._exec(d.data),this.loader.loadedJs[b.toLowerCase()]=1)}return c};a.load=function(b,c){0==arguments.length&&(b=$(document.body));var d=[];null!=b.attr("data-compo")?d.push(b):d=b.find("[data-compo]");for(var e=0;e<d.length;e++){var f=$(d[e]),g=f.attr("data-compo"),s="false"!==f.attr("data-autoload"),r=f.attr("id");!0==s?f=f.load():(a._setDOMId(f[0],r,g),f[0].compo=null,f[0].owner=null);a.root[r]=f}logger.info("READY. Panjs version: "+a.version);2==arguments.length&&
...
Tevent.DESTROY="DESTROY";uses("panjs.core.events.Tevent");__CLASSPATH__="panjs.core.events.TeventDispatcher";
...
1==arguments.length&&(b={});c=this._processElement(c,a.parent()[0],!0);b&&!0==b.processStates&&this.setState(this.currentState);return c},_processElement:function(a,b,c,d){if(!a.owner){if(1==a.nodeType){var e=a.getAttribute("id"),f=a.getAttribute("data-compo"),g=$(a),h=null;null==f?a.owner||(a.owner=this,c&&null!=e&&(defined(this[e])&&logger.warn('1-Duplication du id "'+e+'" sur objet '+this.className),this[panjs.getCamelCase(e)]=g,panjs._setDOMId(a,e,f)),this.bindEvents(g),this.processStates(a),
this._populateElements(a,c)):f==this.classPath?logger.error("R\u00e9f\u00e9rence circulaire dans "+this.classPath):(4>arguments.length&&(d="false"!==a.getAttribute("data-autoload")),d?(h=this.createComponent(f,{elem:a,owner:this}),h.owner=this,c&&null!=e&&(defined(this[e])&&logger.warn('2-Duplication du id "'+e+'" sur objet '+this.className),this[e]=h,panjs._setDOMId(h.container[0],e,f)),this.bindEvents(g,h),g.replaceWith(h.container),h.container.attr("data-loaded","true"),a.setAttribute("data-loaded",
"true"),h.container[0].loaded=!0,h.container[0].compo=h,h.container[0].owner=this,this.setStatesAttributes(a,h.container[0]),this.processStates(h.container[0]),h._triggerOnAdded()):a.owner||(panjs._setDOMId(a,e,f),g[0].compo=null,g[0].owner=this,this[e]=g,this.processStates(a)))}else 8==a.nodeType&&(e="",e=a.textContent,e=e.toUpperCase(),"CONTENT"==e&&(e=document.createElement("div"),e.setAttribute("data-class","content"),b.replaceChild(e,a),this.content=$(e)));return h}},_populateElements:function(a,
b,c){for(var d=0;d<a.childNodes.length;d++){var e=a.childNodes[d];3>arguments.length?this._processElement(e,a,b):this._processElement(e,a,b,c)}}});TdisplayObjectContainer._listeIdElements=[];__CLASSPATH__="panjs.core.display.Telement";
