...
(function(){panjs.logger=null;panjs.root={id:"root"};panjs.loader=null;panjs.iever=getIEVersion();panjs.messages={CLASSNAME_MATCHS_FILENAME:"The name of the class (%1) must match the file name %2 (case sensitive)",LESS_IE8:"less.js is not fully compatible with IE%1 : transform less code in css",LESS_NOT_LOADED:"LESS not loaded. Use panjs_core_with_less.min.js or load LESS (before panJs)"};panjs.getMessage=function(a){for(var c=1;c<arguments.length;c++){var d=arguments[c];null==d&&(d="null");a=a.replace("%"+
c,d)}return a};window.less="undefined"!=typeof panjs.less?panjs.less:{env:"production",async:!0,fileAsync:!1,poll:1E3,functions:{},dumpLineNumbers:"comments",relativeUrls:!1,rootpath:":/a.com/"};for(var a=0;a<panjs.namespaces.length;a++)"undefined"!=typeof panjs.namespaces[a]&&(panjs.namespaces[a].path=panjs.namespaces[a].path.replace("{version}",panjs.version));panjs.createComponent=function(a,c){var d=panjs.getClassNameFromClassPath(a);if("undefined"==typeof window[d]){var e=panjs.loader.usesComponent(a);
if(!e.result){uses("core.display.TerrorElement.html");var f=new TerrorElement(e);return f}}try{f=new window[d](c)}catch(g){uses("core.display.TerrorElement.html"),f=new TerrorElement({message:g,path:e.path,url:e.url,className:d})}f._onInitialized&&f._onInitialized();return f};panjs.load=function(a){0==arguments.length&&(a=$(document.body));for(var c=a.getElements("[data-compo]"),d=0;d<c.length;d++){var e=c[d],f=e.attr("data-compo"),g="false"!==e.attr("autoload"),h=e.attr("id");!0==g?(f=panjs.createComponent(f,
{elem:e[0]}),e.replaceWith(f.container),f.container[0].owner=f):(uses("core.display.TproxyDisplayObject"),f=new TproxyDisplayObject({sourceElement:e[0]}),e.hide(),e[0].setAttribute("id",panjs.root.id+"_"+h),e[0].originalId=h,e[0].owner=panjs.root);panjs.root[h]=f}logger.info("READY");"undefined"!=typeof onReady&&onReady()};panjs.getClassNameFromClassPath=function(a){var c=".";if(a.startsWith("http://")||a.startsWith("https://")||"/"==a[0])c="/";var d=a;a.endsWith(".html")&&(d=a.removeEnd(".html"));
a=d.split(c);return d=a[a.length-1]};panjs.getAbsoluteUrlFromClassPath=function(a){var c=a.endsWith(".html"),d="";if(a.startsWith("http://")||"/"==a[0])d=c?a:a+".js";else for(var e=0;e<panjs.namespaces.length;e++){var f=panjs.namespaces[e];if(a.startsWith(f.name)){d=a.removeEnd(".html").replace(/\./g,"/");d=d.replace(f.name,f.path);d=c?d+".html":d+".js";break}}return d};panjs.isAbsoluteUrl=function(a){a=a.toLowerCase();return"/"==a[0]||a.toLowerCase().startsWith("http://")||a.toLowerCase().startsWith("https://")};
...
f,g,a);b={result:!1,jqXHR:c,exception:g};b.status=c&&c.status?c.status:g}})}catch(d){b={result:!1,exception:d,status:d}}return b},onLoadFileSuccess:function(a,b){},onLoadFileError:function(a,b,c,d){logger.error("Echec chargement "+d+": "+c)},usesComponent:function(a){var b=panjs.getClassNameFromClassPath(a),c=null,d=null;if(this._count>this.maxImbrications)return{result:!1,message:"Too much nested components (max: "+this.maxImbrications+")",className:b,classPath:a,url:c,path:d};if("undefined"==typeof window[b]){logger.groupStart();
0==this._count&&logger.info(" ************ "," USESCOMPONENT ",a," ************ ");this._count++;var d=panjs.getAbsoluteUrlFromClassPath(a),c=this.getUrlWithVersion(d),e=this.loadFile(c);if(e.result){try{var f=getXmlDocument(e.data)}catch(g){return logger.error(g),{result:!1,message:g,className:b,classPath:a,url:c,path:d}}for(var e=f.getElementsByTagName("head")[0],f=f.getElementsByTagName("body")[0],h=[],m=[],s=d.substring(0,d.lastIndexOf("/")),n=0;n<e.childNodes.length;n++){var q=e.childNodes[n],
r=q.nodeName.toLowerCase();if("script"==r)try{this.addScriptNode(q,s,b)}catch(t){var l="Error processing <"+r+"> => "+t;logger.error(d,l);return{result:!1,message:l,className:b,classPath:a,url:c,path:d,stack:t.stack}}else"link"==r?h.push(q):"style"==r&&m.push(q)}if("undefined"==typeof window[b])return l=a+" class has not been loaded. ",panjs.lastDefinedClassName!=b&&(l+="\n"+panjs.getMessage(panjs.messages.CLASSNAME_MATCHS_FILENAME,panjs.lastDefinedClassName,d)),logger.error(l),{result:!1,message:l,
className:b,classPath:a,url:c,path:d,stack:null};for(n=0;n<h.length;n++)this.addLinkNode(h[n],s);for(n=0;n<m.length;n++)logger.debug("Load style ",a),this.addStyleNode(m[n]);if(defined(f))try{var l=getXml(f),u=window[b].prototype.parentClassName;defined(window[u].prototype.html)?(l=window[u].prototype.html.replace("\x3c!--CONTENT--\x3e",l),l="<div>"+l.replace(/<body>/gi,"").replace(/<\/body>/gi,"")+"</div>"):l=l.replace(/<body>/gi,"<div>").replace(/<\/body>/gi,"</div>");l=l.replace(/\\r/gi,"").replace(/\\n/gi,
"").trim();window[b].prototype.html=l;8==panjs.iever&&(window[b].prototype.html=$(l)[0].innerHTML);window[b].prototype.bodyNode=f}catch(w){return{result:!1,message:w.message,className:b,classPath:a,url:c,path:d}}window[b].prototype.classPath=a;window[b].prototype.classPathDir=this.getClassPathDir(a);window[b].prototype.className=b;window[b].lastId=0;this._count--;0==this._count&&logger.debug(" ************ "," END USESCOMPONENT ",a," ************ ");logger.groupEnd();return{result:!0,message:"ok",
className:b,classPath:a,url:c,path:d}}l="Error loading "+a+": "+e.status;logger.warn(l);this._count--;logger.groupEnd();return{result:!1,message:l,className:b,classPath:a,url:c,path:d}}return{result:!0,message:"Already loaded",className:b,classPath:a,url:c,path:d}},uses:function(a){var b=panjs.getClassNameFromClassPath(a),c=null,d=null;if("undefined"==typeof window[b]){logger.groupStart();0==this._count&&logger.info(" ------------ "," USES ",a," ------------ ");d=panjs.getAbsoluteUrlFromClassPath(a);
if(!0==this.loadedJs[d.toLowerCase()])return!0;this._count++;logger.groupStart();c=this.getUrlWithVersion(d);c=this.loadFile(c);c.result&&(c.data=this.processCode(c.data,b),exec(c.data),window[b].prototype.classPath=a,window[b].prototype.className=b,window[b].prototype.classPathDir=this.getClassPathDir(a),window[b].lastId=0);logger.debug(b+" = "+typeof window[b]+" path = "+d+", result="+c.result);this._count--;logger.groupEnd();0==this._count&&logger.debug(" ------------ "," END USES ",a," ------------ ");
logger.groupEnd();return!0}},addLinkNode:function(a,b){var c=panjs.transformUrl(a.getAttribute("href"),b);if(!0==this.loadedCss[c.toLowerCase()])return!0;c=this.getUrlWithVersion(c);if(document.createStyleSheet&&8==panjs.iever)document.createStyleSheet(c);else{var d=a.getAttribute("rel");null==d&&(d="stylesheet");var e=a.getAttribute("type");null==e&&(e="text/css");var f=document.createElement("link");f.rel=d;f.type=e;f.href=c;"stylesheet/less"==d?0<panjs.iever&&8>=panjs.iever?logger.warn(panjs.getMessage(panjs.messages.LESS_IE8,
panjs.iever)):this.lessIsLoaded()?(less.sheets.push(f),less.refresh(!0),logger.debug("INJECTION LESS OK")):logger.warn(panjs.getMessage(panjs.messages.LESS_NOT_LOADED)):document.getElementsByTagName("head")[0].appendChild(f)}logger.debug("Load <link> ASYNC: "+c);return this.loadedCss[c.toLowerCase()]=!0},addStyle:function(a,b){"undefined"==typeof b&&(b="text/css");$('<style type="'+b+'">'+a+"</style>").appendTo("head");"text/less"==b&&(0<panjs.iever&&8>=panjs.iever?logger.warn(panjs.getMessage(panjs.messages.LESS_IE8,
panjs.iever)):this.lessIsLoaded()?(less.refresh(),logger.debug("INJECTION LESS OK")):logger.warn(panjs.getMessage(panjs.messages.LESS_NOT_LOADED)))},addStyleNode:function(a){var b=a.getAttribute("type");null==b&&(b="text/css");a=getText(a);this.addStyle(a,b)},processCode:function(a,b){return a.replace(/this._super/g,b+"._super")},addScriptNode:function(a,b,c){null==a.getAttribute("src")?(b=getText(a),null!=c&&"text/x-class-definition"==a.getAttribute("type")?b=this.processCode(b,c):null!=c&&logger.warn('type="text/x-class-definition" doesn\'t exist on <script> ('+
c+")"),exec(b)):(b=panjs.transformUrl(a.getAttribute("src"),b),b=this.getUrlWithVersion(b),!1==this.loadedJs[b.toLowerCase()]&&(b=this.loadFile(b),null!=c&&"text/x-class-definition"==a.getAttribute("type")&&(b.data=this.processCode(b.data,c)),exec(b.data)));return!0}});panjs.loader=new Tloader;
...
if(defined(a,"elem")){b=a.elem;for(var c=0;c<b.attributes.length;c++){var d=b.attributes.item(c),e=d.nodeName.toLowerCase();if("id"!=e&&"data-compo"!=e){e.startsWith("data-")&&(e=e.droite("-"));var f=d.value;"true"==f&&(f=!0);"false"==f&&(f=!1);a[e]=f}"includeinstate"==e&&(this.includeInState=f,this.container.attr("includeInState",this.includeInState))}this.sourceElement=a.elem;null!=this.content&&""!=this.sourceElement.innerHTML.trim()&&(this.content[0].innerHTML=this.sourceElement.innerHTML,"undefined"!=
typeof a.parent&&a.parent._populateElements(this.content[0],!0,[]))}a&&(a.style&&(this.sourceElementStyle=a.style),a.elem&&(a=a.elem.getAttribute("data-inline-style"),null!=a&&(this.sourceElementStyle=a)))},_onHashChange:function(a){var b=!1;this.enableHashManager&&"function"===typeof this.onHashChange&&(logger.debug("Telement._onHashChange => "+a),b=this.onHashChange(a));return b},free:function(){},_onShow:function(){this._onHashChange(panjs.router.getHash(this))},setHash:function(a){this.enableHashManager&&
panjs.router.setHash(this,a)},getHash:function(){return this.enableHashManager?panjs.router.getHash(this):null}});
...
"?";for(p in c)h=h+p+"="+c[p]+"&";"?"==h&&(h="")}else h="?"+c;this.extraUrlParams&&(h+="&"+this.extraUrlParams);var m=this.baseUrl+b+h;logger.debug("Appel ",a,": ",m,", dataType="+this.dataType);return $.ajax({url:m,async:!0,data:d,context:this,type:a,xhrFields:{withCredentials:!0},dataType:this.dataType,success:function(c,d,h){logger.debug("Requ\u00c3\u00aate AJAX termin\u00c3\u00a9e avec succ\u00c3\u00a8s: ",b);if(null!=this.exitCodeFieldName&&(d=c[this.exitCodeFieldName],defined(d)&&200!=d)){c=
this._getErrorEvent(h,a,c[this.errorTextFieldName],m,g);this.dispatchEvent(c);defined(f)&&f(c,g);return}c=this._getSuccessEvent(c,h,g);this.dispatchEvent(c);defined(e)&&e(c,g)},error:function(b,c,d){b=this._getErrorEvent(b,a,d,m,g);this.dispatchEvent(b);defined(f)&&f(b,g)}})}});