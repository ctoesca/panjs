...
a){return b.replace(/this._super/g,a+"._super")},addScriptNode:function(b,a,e){if(null==b.getAttribute("src"))a=getText(b),null!=e&&"text/x-class-definition"==b.getAttribute("type")?a=this.processCode(a,e):null!=e&&logger.warn('type="text/x-class-definition" doesn\'t exist on <script> ('+e+")"),exec(a);else if(a=panjs.transformUrl(b.getAttribute("src"),a),this.loadedJs[a.toLowerCase()])logger.debug("Le script "+a+" est d\u00e9j\u00e0 charg\u00e9");else{var c=this.loadFile(this.getUrlWithVersion(a));
null!=e&&"text/x-class-definition"==b.getAttribute("type")&&(c.data=this.processCode(c.data,e));exec(c.data);this.loadedJs[a.toLowerCase()]=1}return!0}});panjs.loader=new Tloader;
