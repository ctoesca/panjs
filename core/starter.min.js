...
typeof panjs.namespaces[b]&&(panjs.namespaces[b].path=panjs.namespaces[b].path.replace("{version}",panjs.version));panjs.createComponent=function(a,b){panjs.stackLevel++;var c=panjs.getClassNameFromClassPath(a),d=null;if("undefined"==typeof window[c]){var e=panjs.loader.usesComponent(a);if(!e.result)return uses("core.display.TerrorElement.html"),d=new TerrorElement(e),panjs.stack.push(e.message),panjs.stackLevel--,0>=panjs.stackLevel&&(panjs.stack=[],panjs.stackLevel=0),d}try{"undefined"==typeof b&&
(b={});"undefined"!=typeof b.elem&&panjs.setElementArgs(b.elem,b);if("undefined"!=typeof panjs.root.components[a]&&"undefined"!=b.reuse&&!0===b.reuse){var g=panjs.root.components[a];g.reuse(b);return g}d=new window[c](b)}catch(k){e="Error instantiating "+c+": "+k,logger.error(e),uses("core.display.TerrorElement.html"),d=panjs.getAbsoluteUrlFromClassPath(a),g=panjs.loader.getUrlWithVersion(d),d=new TerrorElement({message:k,path:d,url:g,className:c}),panjs.stack.push(e)}panjs.stackLevel--;0>=panjs.stackLevel&&
(panjs.stack=[],panjs.stackLevel=0);d._onInitialized&&d._onInitialized();return panjs.root.components[a]=d};panjs.setElementArgs=function(a,b){if("undefined"!=typeof a)for(var c=0;c<a.attributes.length;c++){var d=a.attributes.item(c),e=d.nodeName.toLowerCase(),d=d.value;e.startsWith("data-")&&(e=panjs.getFormatedArgName(e));"true"==d?d=!0:"false"==d&&(d=!1);b[e]=d}};panjs.getFormatedIdName=function(a){if(-1==a.indexOf("-"))return a;var b="";a=a.split("-");for(var c=0;c<a.length;c++)b=0==c?a[c]:b+
a[c].capitalizeFirstLetter();return b};panjs.getFormatedArgName=function(a){var b="";a=a.split("-");for(var c=1;c<a.length;c++)b=1==c?a[c]:b+a[c].capitalizeFirstLetter();return b};panjs.loadScript=function(a,b){$LAB.script(a).wait(function(){"undefined"!=typeof b&&b(a)})};panjs.load=function(a){panjs._load(a)};panjs._load=function(a){0==arguments.length&&(a=$(document.body));var b=[];null!=a.attr("data-compo")?b.push(a):b=a.getElements("[data-compo]");for(var c=0;c<b.length;c++){var d=b[c],e=d.attr("data-compo"),
g="false"!==d.attr("autoload"),k=d.attr("id");!0==g?(e=panjs.createComponent(e,{elem:d[0]}),d.replaceWith(e.container),e.container[0].owner=e):(uses("core.display.TproxyDisplayObject"),e=new TproxyDisplayObject({sourceElement:d[0]}),e.parent=this,d[0].loaded=!1,d.hide(),d[0].setAttribute("id",panjs.root.id+"_"+k),d[0].originalId=k,d[0].owner=panjs.root);panjs.root[k]=e}logger.info("READY");"undefined"!=typeof onReady&&onReady()};panjs.getClassNameFromClassPath=function(a){var b=".";if(a.startsWith("http://")||
a.startsWith("https://")||"/"==a[0])b="/";var c=a;a.endsWith(".html")&&(c=a.removeEnd(".html"));a=c.split(b);return c=a[a.length-1]};panjs.getNamespace=function(a){for(var b=0;b<panjs.namespaces.length;b++){var c=panjs.namespaces[b];if(c.name==a)return c}return null};panjs.getAbsoluteUrlFromClassPath=function(a){var b=a.endsWith(".html"),c="";if(a.startsWith("http://")||"/"==a[0])c=b?a:a+".js";else if(a.contains("."))for(var d=0;d<panjs.namespaces.length;d++){var e=panjs.namespaces[d];if(a.startsWith(e.name+
".")){c=a.removeEnd(".html").replace(/\./g,"/");c=c.replace(e.name,e.path);c=b?c+".html":c+".js";break}}else c=a,c=b?c+".html":c+".js";if(""==c)throw"Can't resolve "+a+": verify namespaces";return c};panjs.isAbsoluteUrl=function(a){a=a.toLowerCase();return"/"==a[0]||a.toLowerCase().startsWith("http://")||a.toLowerCase().startsWith("https://")};panjs.transformUrl=function(a,b){"/"!=a[0]&&"http://"!=a.substring(0,7)&&"https://"!=a.substring(0,8)&&(a=b+"/"+a);return a}})();
var Tobject={classHierarchy:"Tobject",extend:function(b,a,f){var c=this.prototype||Tobject,d={};d.classHierarchy={value:c.classHierarchy+" "+a};if(8!=panjs.iever){for(var e in b)if(e.startsWith("$")){a=b[e];e=e.droite("$");logger.debug("BINDABLE => "+e+", defaultValue="+a);d["__"+e]={value:a,writable:!0};a=new Function('var key = "__'+e+'", propName="'+e+'",oldValue=this[key];newValue=arguments[0]; if (this[key] != arguments[0]){this[key] = arguments[0]; this.__OnPropChanged(propName, oldValue, newValue);}');
var g=new Function('var key = "__'+e+'"; return this[key]');d[e]={get:g,set:a}}else d[e]={value:b[e],writable:!0,configurable:!0,enumerable:!0};b=Object.create(c,d);e=b.constructor;if(!(e instanceof Function))throw Error("You must define a method 'constructor'");e.prototype=b;e.prototype.parentClassName=f;e._super=c;e.extend=this.extend}else{d=b.constructor;for(e in c)"constructor"!=e&&"_super"!=e&&(d.prototype[e]=c[e]);for(e in b)"constructor"!=e&&"_super"!=e&&(d.prototype[e]=b[e]);d.extend=this.extend;
d._super=c;d.prototype.parentClassName=f;d.prototype.classHierarchy=c.classHierarchy+" "+a;e=d}return e},copyOwnTo:function(b,a){Object.getOwnPropertyNames(b).forEach(function(f){console.log(f);Object.defineProperty(a,f,Object.getOwnPropertyDescriptor(b,f))});return a},injectParam:function(b,a,f,c){if("undefined"==typeof a||null==a){if("undefined"!=typeof c)return this[b]=c,!0;if("undefined"!=typeof f&&!0==f)throw"The "+b+" argument has no default value on "+this.className;return!1}this[b]=a;return!0}};
function defineClass(b,a,f){var c=a.endsWith(".html"),d=panjs.getClassNameFromClassPath(a);if("undefined"==typeof window[d]&&(c?panjs.loader.usesComponent(a):panjs.loader.uses(a),"undefined"==typeof window[d]))return logger&&logger.error("Unable to inherit from "+a+": class is not loaded"),null;try{window[b]=window[d].extend(f,b,d)}catch(e){alert(d+" "+e)}panjs.lastDefinedClassName=b}function uses(b){return b.endsWith(".html")?panjs.loader.usesComponent(b):panjs.loader.uses(b)}
