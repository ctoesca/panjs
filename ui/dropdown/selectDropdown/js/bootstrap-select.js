...
!function($) {
    ...
    Selectpicker.prototype = {
        ...
        {
           //TOTO
           var d = this.$newElement.dropdown(); //=> ça "casse" le composant selectpicker
           d.data().dropdown.toggle(); // on va bien sur l'objet bootstrap
        },
        */
        reloadLi: function() {
            //Remove all children.
        ...
        render: function() {
            ...
            if (that.options.filterOptionsHtml == null)
            this.$newElement.find('.filter-option').html(title);
            else
            this.$newElement.find('.filter-option').html(that.options.filterOptionsHtml );

             //alert(this.$newElement.data());
            // var d = this.$newElement.getElement(".dropdown-toggle");
          //  d.dropdown();
            ...
            this.$menu.on('click', 'li a', function(e) {
                ...
                if (!that.isDisabled() && !$(this).parent().hasClass('disabled')) {
                    ...
                    if (prevValue != that.$element.val()) {
                        //that.$element.change(); //toto
                        that.$element.trigger("change", {clickedIndex:clickedIndex, itemLabel:  $option.text() , selected: !state});
                    }
                }
            });
